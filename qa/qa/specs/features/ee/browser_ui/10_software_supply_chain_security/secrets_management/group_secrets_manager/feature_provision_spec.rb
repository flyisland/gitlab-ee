...
module QA
  RSpec.describe(
    ...
    describe 'Group Secrets Manager Feature Provision' do
      ...
      it 'enables group secrets manager, verifies default owner permissions, and disables secrets manager',
        testcase: 'https://gitlab.com/gitlab-org/gitlab/-/quality/test_cases/595971' do
