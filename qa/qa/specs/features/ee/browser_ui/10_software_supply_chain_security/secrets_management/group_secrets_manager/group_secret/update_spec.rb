    ...
    describe 'Group Secret' do
      ...
      context 'when updating a group secret' do
        it 'successfully updates a secret when Maintainer has update permissions',
          testcase: 'https://gitlab.com/gitlab-org/gitlab/-/quality/test_cases/603562' do
        ...
        it 'returns 404 when Reporter has no update permissions',
          testcase: 'https://gitlab.com/gitlab-org/gitlab/-/quality/test_cases/603563' do
