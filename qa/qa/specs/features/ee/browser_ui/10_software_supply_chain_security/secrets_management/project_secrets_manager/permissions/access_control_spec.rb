  ...
  RSpec.describe(
    ...
    describe 'Access secret permissions' do
      context 'when testing access control for secret permissions management' do
        ...
        it 'maintainer can view permissions',
        ...
        it 'reporter cannot access secret permissions',
          testcase: 'https://gitlab.com/gitlab-org/gitlab/-/quality/test_cases/589264' do
