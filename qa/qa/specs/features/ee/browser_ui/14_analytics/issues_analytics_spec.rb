...
module QA
  RSpec.describe 'Analytics', feature_category: :value_stream_management do
    ...
    describe 'Group level issues analytics',
      testcase: 'https://gitlab.com/gitlab-org/gitlab/-/quality/test_cases/347974' do
    ...
    describe 'Project level issues analytics',
      testcase: 'https://gitlab.com/gitlab-org/gitlab/-/quality/test_cases/347973' do
      it_behaves_like 'issues analytics page' do
