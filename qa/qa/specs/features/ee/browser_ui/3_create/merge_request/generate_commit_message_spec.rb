...
module QA
  RSpec.describe 'Create', feature_category: :code_review_workflow do
    describe 'Generate merge commit message', quarantine: {
      issue: 'https://gitlab.com/gitlab-org/quality/test-failure-issues/-/work_items/14270',
      type: :investigating
    } do
      ...
      context 'as a maintainer' do
        it 'can be generated using Duo', :external_ai_provider, only:
          { pipeline: %i[staging staging-canary canary production] } do
