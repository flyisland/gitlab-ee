...
module QA
  RSpec.describe 'Security Risk Management', :external_api_calls, feature_category: :vulnerability_management do
    describe 'Security Reports' do
      ...
      context 'when the vulnerability_details_enrichment feature flag is disabled',
        feature_flag: { name: :vulnerability_details_enrichment } do
        before do
          Runtime::Feature.disable(:vulnerability_details_enrichment)
        end
        ...
        it 'displays false positives for the vulnerabilities',
          ...
          EE::Page::Project::Secure::VulnerabilityDetails.perform do |vulnerability_details|
            aggregate_failures "testing False positive vulnerability details" do
              ...
              expect(vulnerability_details).to have_vulnerability_description(
                description: sast_scan_fp_example_vuln_desc
              )
