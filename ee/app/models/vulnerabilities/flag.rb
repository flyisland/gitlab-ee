...
module Vulnerabilities
  class Flag < ::SecApplicationRecord
    ...
    def eligible_for_resolution_workflow?
      ...
      return false unless resolution_workflow_enabled?
    ...
    def resolution_workflow_enabled?
      finding.project.duo_sast_vr_workflow_enabled ||
        ::Vulnerabilities::AiTriage::Eligibility.enabled?(finding.project, :sast_vulnerability_resolution)
    end
