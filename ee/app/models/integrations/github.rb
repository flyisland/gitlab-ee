...
module Integrations
  class Github < Integration
    ...
    field :token,
      ...
      description: -> { _('GitHub API token with `repo:status` OAuth scope.') },
    ...
    field :repository_url,
      ...
      description: -> { _('GitHub repository URL.') },
    ...
    field :static_context,
      ...
      description: -> { _('Append the hostname of your GitLab instance to the status check name.') },
