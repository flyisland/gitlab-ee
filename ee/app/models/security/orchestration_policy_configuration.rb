...
module Security
  class OrchestrationPolicyConfiguration < ApplicationRecord
    ...
    def all_policies
      ...
      policies += dependency_firewall_policy if Feature.enabled?(
        :dependency_firewall_phase1, source)
    ...
    def policies_changed?
      ...
      if Feature.enabled?(:dependency_firewall_phase1, source)
    ...
    def available_policy_types
      ...
      policies_to_exclude << :dependency_firewall_policy unless Feature.enabled?(:dependency_firewall_phase1, source)
