...
module Analytics
  module Dashboards
    class Dashboard
      ...
      attr_reader :title, :description, :schema_version, :status, :panels, :views, :container, :grid_height,
      ...
      def initialize(**args)
        ...
        @views = build_views(yaml_definition['views'])
      end
      ...
      def build_views(views_config)
        ...
        views_config.map do |view|
          {
            title: view['title'],
            panels: Panel.from_data(view['panels'], config_project, container) || []
          }
        end
      end
