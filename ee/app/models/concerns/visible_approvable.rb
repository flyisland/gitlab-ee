...
module VisibleApprovable
  ...
  def reset_approval_cache!
    ...
    delete_approval_mergeability_cache
  end

  def delete_approval_mergeability_cache
    return unless ::Feature.enabled?(:short_ttl_approval_cache, target_project)

    MergeRequests::Mergeability::CheckApprovedService
      .new(merge_request: self, params: {})
      .invalidate
  end
end
