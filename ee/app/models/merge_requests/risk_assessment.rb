...
module MergeRequests
  class RiskAssessment < ApplicationRecord
    ...
    # writing the score, the claims and the session that produced them onto
    # this record in one write, then finishing it. Until it exists,
    # duo_workflow_id stays nil, exactly as it does today.
    def enqueue_risk_score_calculation(diff_sha, classification, workflow_id); end
