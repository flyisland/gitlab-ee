...
module Ci
  class FinishedBuildChSyncEvent < Ci::ApplicationRecord
    ...
    scope :order_by_build_finished_at, -> do
      keyset_aware_order = Gitlab::Pagination::Keyset::Order.build([
        Gitlab::Pagination::Keyset::ColumnOrderDefinition.new(
          attribute_name: 'build_finished_at',
          order_expression: arel_table[:build_finished_at].asc,
          nullable: :not_nullable
        ),
        Gitlab::Pagination::Keyset::ColumnOrderDefinition.new(
          attribute_name: 'build_id',
          order_expression: arel_table[:build_id].asc,
          nullable: :not_nullable
        )
      ])
