  ...
  module ApplicationSetting
    ...
    def instance_built_in_project_templates_enabled_available?
      !::Gitlab::Saas.feature_available?(:gitlab_com_subscriptions) &&
        ::Feature.enabled?(:use_built_in_project_templates_enabled, :instance) &&
    ...
    def duo_cli_enabled=(value)
      ::Ai::Setting.instance.update!(duo_cli_enabled: value)
    end

    def ai_audit_events_streaming_enabled
      ::Ai::Setting.instance.ai_audit_events_streaming_enabled
    end

    def ai_audit_events_streaming_enabled=(value)
      ::Ai::Setting.instance.update!(ai_audit_events_streaming_enabled: value)
    end
