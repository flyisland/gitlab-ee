...
module EE
  ...
  module Group
    ...
    prepended do
      ...
      has_many :cd_applications, class_name: 'Cd::Application', inverse_of: :group
      has_many :cd_environments, class_name: 'Cd::Environment', inverse_of: :group
      has_many :iterations
    ...
    def mcp_server_setting_available?
      root? &&
        ...
        ::Feature.enabled?(:mcp_server_availability_setting, :instance)
    end
    ...
    def built_in_project_templates_enabled_available?
      return false unless ::Feature.enabled?(:use_built_in_project_templates_enabled, :instance)
