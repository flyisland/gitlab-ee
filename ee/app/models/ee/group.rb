...
module EE
  ...
  module Group
    ...
    prepended do
      ...
      before_save :sync_template_columns_to_namespace_template_setting,
        if: -> { file_template_project_id_changed? || custom_project_templates_group_id_changed? }
    ...
    def sync_template_columns_to_namespace_template_setting
      setting = namespace_template_setting || build_namespace_template_setting

      setting.file_template_project_id = file_template_project_id if file_template_project_id_changed?
      setting.custom_project_templates_group_id = custom_project_templates_group_id if custom_project_templates_group_id_changed?
    end
