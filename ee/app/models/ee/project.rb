...
module EE
  ...
  module Project
    ...
    def execute_flow_triggers(data, hook_scope)
      ...
      resource = pipeline_from_hook_data(data) if hook_scope == ::Ci::Pipelines::HookService::HOOK_NAME
      flow_triggers.each do |flow_trigger|
        next unless ::Ai::FlowTriggers::FilterEvaluator.new(flow_trigger: flow_trigger, hook_scope: hook_scope, data: data).allowed?
    ...
    def predefined_push_rule
      ...
      return project_push_rule if ::Feature.enabled?(:read_project_push_rules, self) && project_push_rule
    ...
    def pipeline_from_hook_data(data)
