  ...
  module Project
    ...
    def execute_flow_triggers(data, hook_scope)
      ...
      flow_triggers.each do |flow_trigger|
        ...
        next unless fix_pipeline_trigger_enabled?(flow_trigger)
    ...
    def fix_pipeline_trigger_enabled?(flow_trigger)
      ...
      return true unless ::Feature.enabled?(:fix_pipeline_gradual_trigger_group, root_namespace)
