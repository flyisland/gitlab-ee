...
module EE
  module NamespaceSetting
    ...
    prepended do
      ...
      before_save :sync_mcp_server_enabled,
        if: -> { will_save_change_to_duo_features_enabled? || will_save_change_to_experiment_features_enabled? }
      ...
      def sync_mcp_server_enabled
        return unless namespace&.root?

        self.mcp_server_enabled = duo_features_enabled? && experiment_features_enabled?
      end
