...
module GitlabSubscriptions
  class AddOnPurchase < ApplicationRecord
    ...
    scope :for_gitlab_credits, -> { where(subscription_add_on_id: AddOn.gitlab_credits.select(:id)) }
    scope :for_secrets_manager, -> { where(subscription_add_on_id: AddOn.secrets_manager.select(:id)) }
    ...
    def set_subscription_add_on_uid
      return unless will_save_change_to_subscription_add_on_id?
