...
module Ai
  module Conversation
    class Message < ApplicationRecord
      ...
      ignore_column :agent_version_id, remove_with: '19.2', remove_after: '2026-07-22'
      ...
      def extras
        ...
        begin
          extras_hash = ::Gitlab::Json.safe_parse(extras_hash) if extras_hash.is_a?(String)
      ...
      def error_details
        ...
        begin
          errors_array = ::Gitlab::Json.safe_parse(errors_array) if errors_array.is_a?(String)
        rescue JSON::ParserError
          errors_array = []
        end
