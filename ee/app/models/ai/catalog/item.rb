...
module Ai
  module Catalog
    class Item < ApplicationRecord
      ...
      before_validation :sync_visibility_from_public, if: -> { public_changed? && !visibility_changed? }
      before_validation :sync_public_from_visibility, if: -> { visibility_changed? && !public_changed? }
