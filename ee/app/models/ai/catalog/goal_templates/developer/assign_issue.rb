      ...
      class Developer
        class AssignIssue
          TEMPLATE = <<~GOAL.strip
            ...
            When you have completed your work, @mention @%{triggered_by_username} in a comment on the issue to notify them. And assign them to the merge request unless told differently.
          GOAL
