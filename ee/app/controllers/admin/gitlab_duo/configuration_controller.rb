  ...
  module GitlabDuo
    class ConfigurationController < Admin::ApplicationController
      ...
      before_action do
        ...
        push_frontend_feature_flag(:dap_instance_network_access_controls, :instance, type: :beta)
        push_frontend_feature_flag(:admin_duo_availability_namespace_overrides, :instance)
      end
