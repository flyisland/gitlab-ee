...
module Groups
  module Security
    class ConfigurationController < Groups::ApplicationController
      ...
      def show
        push_frontend_feature_flag(:group_security_configuration_scanners_tab, group.root_ancestor)
      ...
      def can_access_scan_profiles?
        can?(current_user, :read_security_scan_profiles, group.root_ancestor) &&
          ...
          ::Feature.enabled?(:group_security_configuration_scanners_tab, group.root_ancestor)
      end
