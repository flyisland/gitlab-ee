...
class Groups::Security::DashboardController < Groups::ApplicationController
  ...
  before_action only: :show do
    ...
    push_frontend_feature_flag(:new_security_dashboard_pdf_export, group)
    push_frontend_feature_flag(:new_security_dashboard_vulnerabilities_by_identifier, group)
  end
