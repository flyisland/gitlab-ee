...
class Groups::BillingsController < Groups::ApplicationController
  ...
  def upgrade_subscription
    ...
    return render_404 unless Feature.enabled?(:saas_upgrade_subscription_page,
      relevant_group)

    return render_404 unless @top_level_group || free_or_trial_root_namespace?(relevant_group)
