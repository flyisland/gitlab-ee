...
class Groups::Analytics::CoverageReportsController < Groups::Analytics::ApplicationController
  ...
  def coverage_report_params
    params.permit(:start_date, :end_date, :ref_path)
  end
  ...
  def finder_params
    {
      group: @group,
      coverage: true,
      start_date: coverage_report_params[:start_date],
      end_date: coverage_report_params[:end_date],
      ref_path: coverage_report_params[:ref_path],
      sort: true
    }
  end
