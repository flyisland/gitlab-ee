  ...
  class SubscriptionsController < ApplicationController
    ...
    def new
      ...
      redirect_to purchase_url(
        plan_id: resolved_plan_id(sanitize(params[:plan_id]), namespace),
        namespace: namespace,
    ...
    def resolved_plan_id(plan_id, namespace)
      return plan_id unless namespace && [::Plan::PREMIUM, ::Plan::ULTIMATE].include?(plan_id)
      ...
      plans_data&.find { |plan| plan.code == plan_id }&.id || plan_id
    end
