...
module EE
  module SearchController
    ...
    def aggregations
      ...
      # Unlike the Elasticsearch client errors above, this one carries the raw transport
      # failure, which includes the node URL, so it must not be echoed back to the client.
      render json: {
