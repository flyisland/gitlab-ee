    ...
    module ApplicationSettingsController
      ...
      prepended do
        ...
        def semantic_search_available
          # TODO: remove once FF `semantic_search_user_model_selection` is removed.
          # https://gitlab.com/gitlab-org/gitlab/-/work_items/597029
          # `gitlab_selects_embedding_model?` and `user_can_select_embedding_model?` are ideally
          # inverses, but `user_can_select_embedding_model?` is FF-gated - both can return false.
          @semantic_search_available = ::Ai::ActiveContext.semantic_search_available? &&
            (::Ai::ActiveContext.gitlab_selects_embedding_model? || ::Ai::ActiveContext.user_can_select_embedding_model?)
        end
        ...
        def semantic_search_settings
          ...
          @user_can_update_semantic_search_model = @active_context_connection.present? &&
            ::Ai::ActiveContext.user_can_select_embedding_model? &&
        ...
        def active_context_collection_embedding_models(collection_class)
...

          {
            ...
            feature_setting_allowed: ::Ai::ActiveContext::Embedding.feature_setting_allowed?(
