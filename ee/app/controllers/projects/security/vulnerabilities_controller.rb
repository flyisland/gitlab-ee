  ...
  module Security
    class VulnerabilitiesController < Projects::ApplicationController
      ...
      before_action do
        ...
        push_frontend_feature_flag(:vulnerability_flag_status_based_gating, project, type: :beta)
        push_frontend_feature_flag(:vulnerability_details_enrichment, project, type: :wip)
      end
