  ...
  module Security
    class DashboardController < Projects::ApplicationController
      ...
      before_action do
        ...
        push_frontend_feature_flag(:new_security_dashboard_pdf_export, project)
        push_frontend_feature_flag(:new_security_dashboard_vulnerabilities_by_identifier, project)
