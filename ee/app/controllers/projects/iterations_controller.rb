...
class Projects::IterationsController < Projects::ApplicationController
  ...
  def show
    redirect_to project_iteration_cadence_iteration_path(project, iteration_cadence_id: cadence_id, id: id_param)
  end
  ...
  def set_iteration!
    @iteration ||= IterationsFinder
      .new(current_user, id: id_param, parent: project.group, include_ancestors: true)
      .execute
      .first
