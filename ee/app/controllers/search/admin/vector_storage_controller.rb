  ...
  module Admin
    class VectorStorageController < ::Admin::ApplicationController
      ...
      def set_vector_storage
        existing_adapter = connection&.advanced_search_adapter_name&.to_s
      ...
      def build_adapter_configs(existing_adapter)
        ::Ai::ActiveContext::Connection::ADVANCED_SEARCH_ADAPTERS.keys.to_h do |adapter|
      ...
      def submitted_adapter_name
        ...
        adapter if ::Ai::ActiveContext::Connection::ADVANCED_SEARCH_ADAPTERS.key?(adapter&.to_sym)
      end
