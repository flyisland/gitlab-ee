...
module Emails
  module UserCap
    def user_cap_reached(user_id)
      ...
      @url_to_pending_users = 'https://docs.gitlab.com/ee/administration/moderate_users.html#view-user-accounts-pending-approval'
      @url_to_manage_pending_users = 'https://docs.gitlab.com/ee/administration/moderate_users.html#approve-or-reject-a-new-user-account'
