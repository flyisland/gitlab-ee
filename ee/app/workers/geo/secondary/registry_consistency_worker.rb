  ...
  module Secondary
    ...
    class RegistryConsistencyWorker
      ...
      REGISTRY_CLASSES = [
        ...
        Geo::DependencyListExportUploadRegistry,
        Geo::IssuableMetricImageUploadRegistry,
        Geo::VulnerabilityExportPartUploadRegistry,
        Geo::AlertManagementMetricImageUploadRegistry,
        Geo::PersonalSnippetUploadRegistry,
        Geo::VulnerabilityArchiveExportUploadRegistry,
        Geo::VulnerabilityExportUploadRegistry,
        Geo::UserPermissionExportUploadUploadRegistry,
        Geo::PackagesDebianProjectComponentFileRegistry,
        Geo::AiVectorizableFileUploadRegistry,
        Geo::BulkImportExportUploadUploadRegistry,
        Geo::ImportExportUploadUploadRegistry,
        Geo::ProjectImportExportRelationExportUploadUploadRegistry,
        Geo::DesignManagementActionUploadRegistry,
        Geo::UserUploadRegistry,
        Geo::AchievementUploadRegistry,
        Geo::GroupUploadRegistry,
        Geo::ProjectUploadRegistry,
        Geo::AbuseReportUploadRegistry
      ].freeze
      ...
      def perform
        ...
        return false unless Gitlab::Geo.secondary_or_org_migration_target?
