  ...
  module Zoekt
    class UpdateIndexUsedStorageBytesEventWorker
      ...
      def handle_event(_event)
        if Feature.enabled?(:zoekt_batch_update_index_storage_bytes) # rubocop:disable Gitlab/FeatureFlagWithoutActor -- Global worker, no meaningful actor
          ...
          Index
            ...
            .limit(BATCH_SIZE)
            .each(&:update_storage_bytes_and_watermark_level!)
        end
