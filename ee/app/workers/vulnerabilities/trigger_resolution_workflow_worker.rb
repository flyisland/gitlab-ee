...
module Vulnerabilities
  class TriggerResolutionWorkflowWorker
    ...
    def perform(vulnerability_flag_id)
      ...
      user = project.first_human_owner || vulnerability.author
      ...
      result = trigger_workflow(vulnerability, project, user, consumer)
      if result.success?
    ...
    def trigger_workflow(vulnerability, project, user, consumer)
