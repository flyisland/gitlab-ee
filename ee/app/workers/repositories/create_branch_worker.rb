...
module Repositories
  class CreateBranchWorker # rubocop:disable Scalability/IdempotentWorker -- orchestrated by JobWaiter
    ...
    def perform(project_id, user_id, branch_name, ref, notify_key)
      ...
      if authentication_error_message.present?
        ...
        result = ::Gitlab::GitalyClient.with_context(Projects::UpdateMirrorService::GITALY_CONTEXT_KEY => true) do
