...
class ElasticDeleteProjectWorker
  ...
  def indices
    ...
    # WorkItem, Vulnerability have a different routing key pattern so handled seperately.
    excluded_classes = [Epic, Wiki, Project, WorkItem, Vulnerability, Vulnerabilities::Read]
