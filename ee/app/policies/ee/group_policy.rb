...
module EE
  module GroupPolicy
    ...
    prepended do
      ...
      rule { ~custom_roles_allowed }.prevent :admin_member_role
      ...
      rule { can?(:admin_compliance_framework) | can?(:manage_deploy_tokens) | can?(:manage_merge_request_settings) }.policy do
      ...
      rule { ~duo_workflow_available }.prevent :admin_duo_workflow
      ...
      rule { ~knowledge_graph_enabled }.prevent :update_knowledge_graph_setting
