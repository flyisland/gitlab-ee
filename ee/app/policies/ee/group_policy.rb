...
module EE
  module GroupPolicy
    ...
    prepended do
      ...
      condition(:model_selection_allowlist_feature_enabled, scope: :subject) do
        ::Feature.enabled?(:model_selection_allowlist, @subject.root_ancestor)
      end

      rule { ~group_model_selection_enabled | ~model_selection_allowlist_feature_enabled }.policy do
