...
module Ai
  module Catalog
    class ItemConsumerPolicy < ::BasePolicy
      ...
      rule { ultimate_only_item & ~premium_or_higher_license_available }.prevent :execute_ai_catalog_item
      rule { ultimate_only_item & ~premium_or_higher_license_available }.prevent :read_ai_catalog_item_consumer
    end
  end
end
