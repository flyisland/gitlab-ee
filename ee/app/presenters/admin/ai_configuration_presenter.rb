  ...
  class AiConfigurationPresenter
    ...
    def settings
      settings_hash = {
        ...
        self_hosted_duo_agent_platform_service_secure: self_hosted_duo_agent_platform_service_secure,
      ...
      if Feature.enabled?(:duo_access_through_namespaces, :instance)
    ...
    def foundational_agents_statuses
      ...
      return statuses if ::License.feature_available?(:ai_catalog)
