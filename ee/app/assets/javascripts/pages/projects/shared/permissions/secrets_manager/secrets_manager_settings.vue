<script>
import { GlAlert, GlBadge, GlLink, GlSprintf, GlSkeletonLoader, GlToggle } from '@gitlab/ui';
...
<template>
  ...
  <div v-else data-testid="secret-manager">
    ...
    <gl-badge v-if="!isNamespaceEnrollable" data-testid="open-beta-badge" variant="neutral">
      {{ __('Beta') }}
    </gl-badge>
    <p
