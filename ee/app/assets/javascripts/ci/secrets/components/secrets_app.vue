...
export default {
  ...
  inject: ['contextConfig', 'fullPath', 'isEligibleForTrial'],
  provide() {
    return {
      isOpenbaoHealthy: computed(() => this.isOpenbaoHealthy),
      isReadOnly: false, // TODO: update value in future MRs. See https://gitlab.com/gitlab-org/gitlab/-/work_items/598493#relevant-links
    };
  },
  data() {
    return {
...
<template>
  <gl-loading-icon
    v-if="!isEligibleForTrial && !secretManagerStatus"
