...
import { newGroupPath as defaultNewGroupPath } from '~/lib/utils/path_helpers/routes';
...
export const initAiSettings = (id, component, options = {}) => {
  ...
  return new Vue({
    ...
    provide: {
      ...
      duoAgentPlatformServiceUrl,
      selfHostedDuoAgentPlatformServiceSecureEnabled: parseBoolean(
        selfHostedDuoAgentPlatformServiceSecure,
      ),
      ...
      parentPath,
      newGroupPath: newGroupPath || defaultNewGroupPath(),
