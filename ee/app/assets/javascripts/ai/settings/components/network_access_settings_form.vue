      ...
      return [
        {
          ...
          help: s__(
            'AiPowered|When enabled, a curated list of commonly needed domains is automatically included in the allowlist.',
          ),
        },
        {
          ...
          help: s__(
            'AiPowered|When enabled, all Unix socket connections are permitted for agent platform operations.',
          ),
        },
        {
          ...
          help: s__(
            'AiPowered|When enabled, project maintainers can add additional domains to the allowlist, allow all unix sockets, and include recommended domain settings.',
          ),
        },
      ];
    },
...
<template>
  <gl-form-group :label="s__('AiPowered|Network access controls')" class="gl-my-4">
    <template #label-description>
      {{ s__('AiPowered|Control which external network resources Duo Agent Platform can access.') }}
    </template>
