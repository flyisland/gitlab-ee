  ...
  i18n: {
    subtitle: {
      [IS_SAAS_ATTRIBUTE]: s__(
        'AiPowered|Control whether GitLab can process your code and project data for AI-native features.',
      ),
    ...
    defaultOnHelpText: {
      [IS_SAAS_ATTRIBUTE]: s__(
        'AiPowered|Allow GitLab to process your code and project data for AI-native features in this group. Your data is sent to GitLab Duo. Groups, subgroups, and projects can opt out individually.',
      ),
      [IS_SELF_MANAGED_ATTRIBUTE]: s__(
    ...
    defaultOffHelpText: {
      [IS_SAAS_ATTRIBUTE]: s__(
        'AiPowered|Block GitLab from processing your code and project data for AI-native features in this group. Your data stays private unless subgroups or projects opt in individually.',
      ),
      [IS_SELF_MANAGED_ATTRIBUTE]: s__(
    ...
    alwaysOffHelpText: {
      [IS_SAAS_ATTRIBUTE]: s__(
        'AiPowered|Never allow GitLab to process your code and project data for AI-native features in this group. Your data is not sent to GitLab Duo.',
      ),
      [IS_SELF_MANAGED_ATTRIBUTE]: s__(
