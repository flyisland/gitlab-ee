...
<template>
  <gl-form-group :label="s__('AiPowered|Custom agents and flows')" class="gl-my-4">
    <gl-form-checkbox
    ...
    >
      ...
      <template #help>{{
        s__(
          'AiPowered|Allow custom agents in projects. Users with the Maintainer or Owner role can create new agents.',
        )
      }}</template>
    </gl-form-checkbox>
    ...
    >
      ...
      <template #help>{{
        s__(
          'AiPowered|Allow external agents in projects. Users with the Maintainer or Owner role can connect external agents.',
        )
      }}</template>
    </gl-form-checkbox>
    ...
    >
      ...
      <template #help>{{
        s__(
          'AiPowered|Allow custom flows in projects. Users with the Maintainer or Owner role can create new flows.',
        )
      }}</template>
    </gl-form-checkbox>
  </gl-form-group>
