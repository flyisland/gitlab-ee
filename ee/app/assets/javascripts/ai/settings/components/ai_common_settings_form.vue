...
export default {
  ...
  computed: {
    ...
    shouldShowDuoAvailabilityNamespaces() {
      return Boolean(this.glFeatures?.adminDuoAvailabilityNamespaceOverrides);
    },
...
<template>
  <gl-form @submit.prevent="submitForm">
    ...
    <duo-availability-namespaces v-if="shouldShowDuoAvailabilityNamespaces" />
