<script>
import { GlKeysetPagination, GlAlert, GlToastMixin } from '@gitlab/ui';
import Api from '~/api';
...
<template>
  <div class="requirements-list-container">
    ...
    <filtered-search-bar
      ...
      @on-filter="handleFilterRequirements"
      @on-sort="handleSortRequirements"
    />
    ...
    >
      <requirement-item
        ...
        @archive-click="handleRequirementStateChange"
        @reopen-click="handleRequirementStateChange"
      />
    </ul>
