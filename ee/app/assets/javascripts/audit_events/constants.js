...
export const AUDIT_STREAMS_FILTERING = {
  ...
  NAMESPACE_SELECTION_COUNT: s__('AuditStreams|%{selected} of %{maximum} selected'),
  EVENT_TYPE_SELECTION_COUNT: s__('AuditStreams|%{count} selected'),
};

export const MAX_HEADERS = 20;

// Mirrors backend's `MAXIMUM_NAMESPACE_FILTER_COUNT` on the ExternallyStreamable concern.
// Backend remains the source of truth; this is a UX guard to avoid sending requests that
// the server will reject.
export const MAXIMUM_NAMESPACE_FILTERS = 5;
