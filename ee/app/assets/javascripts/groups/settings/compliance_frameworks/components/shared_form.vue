...
export default {
  ...
  emits: [
    ...
    'update:description',
    'update:name',
    'update:pipelineConfigurationFullPath',
  ],
  data() {
    return {
      pipelineConfigurationFileExists: true,
      hadPipelineConfiguration: Boolean(this.pipelineConfigurationFullPath),
    };
  },
  computed: {
    isValidColor() {
...
<template>
  <gl-form @submit.prevent="onSubmit">
    ...
    <template v-if="!pipelineConfigurationEnabled && hadPipelineConfiguration">
      <gl-form-group
