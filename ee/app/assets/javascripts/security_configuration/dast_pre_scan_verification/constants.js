...
export const SUMMARY_STATUS_STYLE_MAP = {
  [PRE_SCAN_VERIFICATION_STATUS.IN_PROGRESS]: {
    ...
    borderColor: `border-color: ${GL_COLOR_BLUE_400}`,
  },
  [PRE_SCAN_VERIFICATION_STATUS.COMPLETE]: {
    icon: 'check-circle',
    iconColor: 'gl-text-success',
    borderColor: `border-color: ${GL_COLOR_GREEN_500}`,
  },
  [PRE_SCAN_VERIFICATION_STATUS.COMPLETE_WITH_ERRORS]: {
    icon: 'status_warning',
    iconColor: 'gl-text-warning',
    borderColor: `border-color: ${GL_COLOR_ORANGE_400}`,
  },
  [PRE_SCAN_VERIFICATION_STATUS.FAILED]: {
    icon: 'status_failed',
    iconColor: 'gl-text-danger',
    borderColor: `border-color: ${GL_COLOR_RED_400}`,
  },
  [PRE_SCAN_VERIFICATION_STATUS.INVALIDATED]: {
    icon: 'status_failed',
    iconColor: 'gl-text-danger',
