...
// The new default of 175 minutes is to fit within the GitLab.com SaaS shared runner job timeout of 180 minutes, leaving ~5 minutes of headroom for the post-crawl phases.
const SPIDER_DEFAULT_TIMEOUT = 175;
...
export default {
  ...
  mixins: [dastProfileFormMixin(), glListenersMixin],
  data() {
    const {
      profileName = '',
      spiderTimeout = SPIDER_DEFAULT_TIMEOUT,
      targetTimeout = 60,
