...
<template>
  <div class="explorer-query-panel gl-flex gl-flex-col" data-testid="explorer-query-panel">
    <div
    ...
    <div class="editor-wrapper gl-min-h-0 gl-grow">
      <source-editor
        :value="queryText"
    ...
    >
      <gl-collapsible-listbox
        :items="templateItems"
        :toggle-text="s__('Orbit|Templates')"
        size="small"
