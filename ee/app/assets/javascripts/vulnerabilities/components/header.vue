...
import { hasActiveAiFpDetection, isAiDetectedAsFalsePositive } from '../flag_helpers';
...
export default {
  ...
  computed: {
    ...
    detectedAsFalsePositive() {
      if (this.glFeatures.vulnerabilityFlagStatusBasedGating) {
    ...
    hasActiveFpDetection() {
      ...
      return this.detectedAsFalsePositive;
    },
    dismissalReason() {
