...
export const TRIGGER_TYPES = [
  {
    ...
    fields: [
      ...
      },
      {
        ...
        placeholder: s__('SecurityOrchestration|e.g., main, develop, release/*'),
      },
      {
        key: 'sourceBranch',
        type: 'text',
        label: s__('SecurityOrchestration|Source Branch'),
        placeholder: s__('SecurityOrchestration|e.g., feature/*, hotfix/*'),
      },
    ],
  },
  {
