...
import organizationVulnerabilitiesPerSeverityCount from 'ee/security_dashboard/graphql/queries/organization_vulnerabilities_per_severity.query.graphql';
...
const SCOPE_CONFIG = {
  ...
  organization: {
    query: organizationVulnerabilitiesPerSeverityCount,
