...
import organizationVulnerabilityByAge from 'ee/security_dashboard/graphql/queries/organization_vulnerabilities_by_age.query.graphql';
...
const SCOPE_CONFIG = {
  ...
  organization: {
    query: organizationVulnerabilityByAge,
