...
import { GL_COLOR_ORANGE_400, GL_COLOR_BLUE_400 } from '@gitlab/ui/src/tokens/build/js/tokens';
...
const SEVERITIES = [
  ...
  { key: 'low', name: s__('severity|Low'), color: GL_COLOR_ORANGE_400 },
  { key: 'info', name: s__('severity|Info'), color: GL_COLOR_BLUE_400 },
  { key: 'unknown', name: s__('severity|Unknown'), color: '#868686' },
];

export default {
  name: 'LegacyProjectSecurityDashboard',
  components: {
    GlLoadingIcon,
    GlLineChart,
    GlSprintf,
...
<template>
  <div data-testid="legacy-project-security-dashboard">
    <page-heading :heading="s__('SecurityReports|Security dashboard')">
      ...
      <template #actions>
        <legacy-pdf-export-button :get-report-data="getReportData" />
      </template>
    </page-heading>
