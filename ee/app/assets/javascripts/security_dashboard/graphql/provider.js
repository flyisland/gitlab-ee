...
import { vulnerabilityResolutionFunnelResolvers } from './resolvers/vulnerability_resolution_funnel_resolver';
...
export const defaultClient = createDefaultClient(vulnerabilityResolutionFunnelResolvers, {
  cacheConfig,
});
