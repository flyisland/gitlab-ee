<script>
import { securityProjectPipelinePath } from 'ee/lib/utils/path_helpers/pipelines';
...
export default {
  ...
  computed: {
    ...
    actionButtons() {
        ...
        return [
          {
            ...
            href: joinPaths(this.mr.reportsTabPath, SECURITY_SCAN_ROUTE),
            onClick: (action, e) => {
              e.preventDefault();
      ...
      return [
        {
          href: securityProjectPipelinePath(this.mr.targetProjectFullPath, this.mr.pipeline.id),
...
<template>
  <mr-widget
    ...
    :is-collapsible="glFeatures.mrReportsTab ? false : isCollapsible"
    :expand-button-label="s__('SecurityReports|Expand security scanning details')"
    :collapse-button-label="s__('SecurityReports|Collapse security scanning details')"
