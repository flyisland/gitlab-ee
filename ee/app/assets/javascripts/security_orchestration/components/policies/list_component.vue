...
import { PIPELINE_EXECUTION_SCHEDULE_POLICY_TYPE } from '../constants';
import {
...
import SpepFeedbackPopover from './banners/spep_feedback_popover.vue';
...
export default {
  ...
  methods: {
    ...
    isScheduledPipelineExecutionPolicy(policyType) {
      return policyType === POLICY_TYPE_FILTER_OPTIONS.PIPELINE_EXECUTION_SCHEDULE.text;
    },
  },
  ...
  <div>
    ...
    >
      ...
      <template #cell(policyType)="{ item: { policyType } }">
        ...
        <spep-feedback-popover v-if="isScheduledPipelineExecutionPolicy(policyType)" />
      </template>
