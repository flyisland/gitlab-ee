...
// Keep these as CSS variables rather than hex tokens: the donut chart, its legend and the
// segmented bars all read them, so only a variable keeps the three in step across color modes.
