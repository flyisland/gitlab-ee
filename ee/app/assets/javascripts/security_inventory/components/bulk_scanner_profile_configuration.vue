...
export default {
  ...
  computed: {
    ...
    profilesWithStatusPatches() {
      ...
      return this.availableSecurityScanProfiles.map((profile) => ({
        ...profile,
...
<template>
  <div>
    <crud-component header-class="gl-hidden">
      <gl-table-lite :items="profilesWithStatusPatches" :fields="$options.fields" stacked="md">
