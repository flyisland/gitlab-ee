    ...
    <gl-tabs :value="selectedTab" @input="onTabChange">
      <gl-tab data-testid="devops-overview-tab">
        ...
        <devops-adoption-overview
          ...
          :timestamp="timestamp"
          @enabled-namespaces-removed="deleteEnabledNamespacesFromCache"
      ...
      >
        ...
        <devops-adoption-section
          ...
          @enabled-namespaces-removed="deleteEnabledNamespacesFromCache"
          @fetch-groups="setGroupsSearchTerm"
          @enabled-namespaces-added="addEnabledNamespacesToCache"
          @track-modal-open-state="trackModalOpenState"
        />
      </gl-tab>
