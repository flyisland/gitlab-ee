...
export default {
  ...
  props: {
    ...
    // TODO: `isProject` is used to resolve the url link that the metric links to
    //        we should move this to the data_source and generate a correct link for the metric_label component
    //        metric_label should only need to know if there is a link or not, shouldnt have namespace concerns
    isProject: {
      type: Boolean,
      required: true,
    },
