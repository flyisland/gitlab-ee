...
import DuoFeatureUsageQuery from 'ee/analytics/dashboards/ai_impact/graphql/duo_feature_usage.query.graphql';
...
export default async function fetch({
  namespace,
  query: { dateRange: dateRangeDefault } = {},
  queryOverrides: { dateRange: dateRangeOverride } = {},
  ...
  const {
    ...
    previousRange,
    text: subtitle,
  } = getDateRange(dateRangeOverride ?? dateRangeDefault, DATE_RANGE_OPTION_LAST_30_DAYS);
