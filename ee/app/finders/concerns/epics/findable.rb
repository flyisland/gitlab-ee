...
module Epics
  module Findable
    ...
    override :use_cte_for_label_filter?
    ...
    def by_child(items)
      ...
      hierarchy_order = params[:hierarchy_order]
      epic = Epic.find(params[:child_id])
      ancestors = epic.work_item_ancestors.order_by_hierarchy_order(epic, hierarchy_order: hierarchy_order)
