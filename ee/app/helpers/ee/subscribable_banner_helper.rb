...
module EE
  module SubscribableBannerHelper
    ...
    def license_message(
      signed_in: signed_in?,
      notify_as_admin: current_user&.admin?, # rubocop:disable Cop/UserAdmin -- notify admins regardless of admin mode
    ...
    def subscription_message
      ...
      ::Gitlab::ExpiringSubscriptionMessage.new(
        ...
        signed_in: signed_in?,
        notify_as_admin: can?(current_user, :edit_billing, entity.root_ancestor),
