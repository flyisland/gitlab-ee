...
module EE
  module ProjectsHelper
    ...
    def duo_mcp_data(project)
      ...
      {
        serversCount: duo_mcp_servers_count(project),
        serversPath: project_automate_mcp_servers_path(project)
      }
    end

    def duo_mcp_servers_count(project)
      agent_consumers = ::Ai::Catalog::ItemConsumersFinder
        .new(current_user, params: { project_id: project.id, item_types: [::Ai::Catalog::Item::AGENT_TYPE] })
        .execute
        .with_items
      ...
      ::Ai::Catalog::McpServersBatchLoader
        .batch_mcp_servers_for_item_versions(latest_version_ids, current_user)
