...
module EE
  module ProjectsHelper
    ...
    def bot_access_settings_data(project)
      ...
      {
        botAccessSettingsAvailable: project.project_setting.pipeline_execution_policy_bot_access_experiment_enabled?,
    ...
    def product_analytics_settings_allowed?(project)
      ...
      return false unless can?(current_user, :update_product_analytics_settings, project)
    ...
    def gitlab_duo_visible_settings(project)
      ...
      return ['duoSastVrWorkflowEnabled'] if can?(current_user, :update_sec_ai_workflow_settings, project)
