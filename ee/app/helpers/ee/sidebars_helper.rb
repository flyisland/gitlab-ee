...
module EE
  module SidebarsHelper
    ...
    override :super_sidebar_whats_new_data
    def super_sidebar_whats_new_data
      super.merge(
        whats_new_show_transcend_promo: ::Gitlab::Saas.feature_available?(:gitlab_com_subscriptions) &&
          ::Feature.enabled?(:whats_new_transcend_promo, :instance)
      )
    end
