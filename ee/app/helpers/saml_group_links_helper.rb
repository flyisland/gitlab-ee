...
module SamlGroupLinksHelper
  ...
  def saml_restricted_access_warning
    if gitlab_com?
      ra_link = link_to('', help_page_path('user/group/manage.md', anchor: 'restricted-access'))
      ra_learn_more = link_to('', help_page_path('user/group/manage.md',
      ...
      ra_learn_more = link_to('', help_page_path('administration/settings/sign_up_restrictions.md',
        anchor: 'provisioning-behavior-with-saml-scim-and-ldap'))
    end
