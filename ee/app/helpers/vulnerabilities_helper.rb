...
module VulnerabilitiesHelper
  ...
  def vulnerability_finding_data(vulnerability)
    ...
    if latest_flag_record
      data[:latest_flag] = {
        ...
        status: serialize_flag_status(latest_flag_record, finding.project)
      }
    end
  ...
  def serialize_flag_status(flag, project)
    return unless Feature.enabled?(:vulnerability_flag_status_based_gating, project.root_ancestor)
