...
module Resolvers
  module Boards
    class EpicListResolver < BaseResolver.single
      ...
      argument :id, ::Types::GlobalIDType[::Boards::EpicList], # rubocop:disable Graphql/ForbiddenLoadsArgument -- pre-existing code; removing `loads:` would be a breaking change
        required: true,
