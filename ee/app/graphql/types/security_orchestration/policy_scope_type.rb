...
module Types
  module SecurityOrchestration
    class PolicyScopeType < BaseObject # rubocop:disable Graphql/AuthorizeTypes -- This is a read from policy YAML
      ...
      field :including_business_impact_attributes, ::Types::Security::AttributeType.connection_type, # rubocop:disable GraphQL/ExtractType -- following the convention in the GraphQL type
        null: false,
        description: 'Business Impact security attributes that the policy applies to.',
        experiment: { milestone: '18.11' }

      field :excluding_business_impact_attributes, ::Types::Security::AttributeType.connection_type, # rubocop:disable GraphQL/ExtractType -- following the convention in the GraphQL type
        null: false,
