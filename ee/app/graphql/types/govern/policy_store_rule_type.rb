...
module Types
  module Govern
    ...
    class PolicyStoreRuleType < BaseObject
      graphql_name 'PolicyStoreRule'
      description 'Rule kind available when creating a policy in the policy store.'
      ...
      field :id, # rubocop: disable GraphQL/FieldHashKey -- BaseObject#id calls to_global_id on plain hashes; explicit override required
        ...
        description: 'Identifier of the rule kind.'

      field :name, GraphQL::Types::String,
        null: false,
        experiment: { milestone: '19.4' },
        description: 'Human-readable name of the rule kind.'
