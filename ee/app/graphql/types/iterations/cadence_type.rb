...
module Types
  module Iterations
    class CadenceType < BaseObject
      ...
      authorize_granular_token permissions: :read_iteration_cadence, boundary: :group, boundary_type: :group
      ...
      field :iterations_in_advance, GraphQL::Types::Int,
        null: true, description: 'Number of future iterations to schedule in addition to the current one.'
