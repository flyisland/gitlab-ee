...
module Types
  class EpicType < BaseObject
    ...
    authorize_granular_token permissions: :read_epic, boundary: :group, boundary_type: :group
    ...
    def award_emoji
      BatchLoaders::AwardEmojiVotesBatchLoader.load_award_emoji(object.work_item, awardable_class: 'Issue')
    end

    def downvotes
      return 0 unless object.work_item
