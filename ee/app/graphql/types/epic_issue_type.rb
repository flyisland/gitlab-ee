...
module Types
  ...
  class EpicIssueType < IssueType
    ...
    field :epic_issue_id, GraphQL::Types::ID,
      null: false, description: 'ID of the epic-issue relation.'

    field :relation_path, GraphQL::Types::String,
      null: true, description: 'URI path of the epic-issue relation.'

    field :id, GraphQL::Types::ID,
      null: true, description: 'Global ID of the epic-issue relation.'

    def id
      ::Gitlab::GlobalId.build(object, model_name: 'Issue', id: object.id)
    end
    ...
    def relative_position
      object.parent_link.relative_position
    end
  end
