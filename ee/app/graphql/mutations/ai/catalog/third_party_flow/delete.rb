    ...
    module Catalog
      module ThirdPartyFlow
        class Delete < BaseMutation
          ...
          authorize_granular_token permissions: :delete_ai_catalog_third_party_flow,
          ...
          def resolve(args)
            ...
            if args[:force_hard_delete] && !Ability.allowed?(current_user, :force_hard_delete_ai_catalog_item)
