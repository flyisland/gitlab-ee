    ...
    module DuoWorkflows
      class Create < BaseMutation
        ...
        def resolve(**args)
          ...
          authorize_foundational_flows!(args[:workflow_definition], container)
        ...
        def authorize_foundational_flows!(workflow_definition, container)
          ...
          return if Ability.allowed?(current_user, :execute_ai_catalog_item, item_consumer)
