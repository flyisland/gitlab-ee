  ...
  module Boards
    module EpicLists
      class Update < ::Mutations::Boards::Lists::BaseUpdate
        ...
        argument :list_id, Types::GlobalIDType[::Boards::EpicList], # rubocop:disable Graphql/ForbiddenLoadsArgument -- pre-existing code; removing `loads:` would be a breaking change
          required: true,
