    ...
    module GroupType
      ...
      prepended do
        ...
        field :cd_applications, ::Types::Cd::ApplicationType.connection_type,
          null: true,
          description: 'Continuous deployment applications in the group and its descendant subgroups.',
          resolver: ::Resolvers::Cd::ApplicationsResolver,
          experiment: { milestone: '19.1' }

        field :cd_environments, ::Types::Cd::EnvironmentType.connection_type,
          null: true,
          description: 'Continuous deployment environments in the group and its descendant subgroups.',
          resolver: ::Resolvers::Cd::EnvironmentsResolver,
          experiment: { milestone: '19.1' }
        ...
        def security_posture_counters
          ::Security::InventoryFilter.aggregate_posture_counters_for(object)
        end
