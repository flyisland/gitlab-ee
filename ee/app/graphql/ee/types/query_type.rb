    ...
    module QueryType
      ...
      prepended do
        ...
        field :duo_workflow_branches, [::Types::Ai::DuoWorkflows::BranchType],
          ...
          scopes: [:api, :read_api, :ai_features, :ai_workflows],
          experiment: { milestone: '19.3' },
          description: 'Other attempts at a turn in a Duo Agent Platform session, created when ' \
            'the user retried it. Always empty until branch reconstruction is released.'
      ...
      def ai_catalog_built_in_tools
        ...
        # Tool 58 is get_previous_session_context. It is highly coupled to the
      ...
      def ai_catalog_mcp_tools
        ...
        ::Ai::Catalog::McpTool.all.sort_by(&:name)
      end
