  ...
  module Minutes
    class EmailNotificationService < ::BaseService
      ...
      def notify_minutes_used_up
        return if Ci::Minutes::NamespaceMonthlyUsage.any_total_usage_notified?(namespace.id)
      ...
      def notify_minutes_running_out
        return if Ci::Minutes::NamespaceMonthlyUsage.any_usage_notified?(namespace.id, current_alert_percentage)
