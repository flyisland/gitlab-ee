  ...
  module ApplicationSettings
    module UpdateService
      ...
      def handle_organization_settings
        ...
        application_setting.errors.add(:foundational_agents_statuses,
          default_organization.errors.full_messages.join(', '))
      end
      ...
      def cascade_duo_features_settings
        ...
        cascading_ai_settings = [:duo_features_enabled, :duo_remote_flows_enabled, :auto_duo_code_review_enabled,
          :duo_foundational_flows_enabled, :duo_custom_agents_enabled, :duo_custom_flows_enabled,
