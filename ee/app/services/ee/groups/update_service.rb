  ...
  module Groups
    module UpdateService
      ...
      def remove_unallowed_params
        ...
        unless ::Feature.enabled?(:enforce_ai_audit_events_storage_setting, group)
          params.delete(:ai_audit_events_storage_enabled)
          params.delete(:lock_ai_audit_events_storage_enabled)
        end
      ...
      def reject_admin_locked_duo_availability_params
        return unless group.namespace_settings&.admin_locked_duo_features_enabled?

        %i[duo_features_enabled lock_duo_features_enabled duo_availability].each do |param_key|
      ...
      def handle_code_review_flow_consent_update
        ...
        # If NOT updating foundational flows, skip entirely to avoid accidently revoking the consent.
        return unless updating_foundational_flows

        # Escape hatch in case we identify any issues with the feature.
        return unless ::Feature.enabled?(:duo_code_review_dap_routing_consent_enabled, group)
