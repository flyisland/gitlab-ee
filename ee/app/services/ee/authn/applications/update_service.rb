      ...
      module UpdateService
        ...
        def execute
          super.tap do |application|
            next unless application.persisted? && application.errors.empty?
            ...
            audit_oauth_application_update(application, remote_ip, entity)
          end
        end

        private

        def audit_oauth_application_update(application, ip_address, entity)
