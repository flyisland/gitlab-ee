    ...
    module GitlabProjectsImportService
      ...
      def prepare_import_params
        ...
        if custom_template
          ...
          # Allow to import only for Group/Instance level templates
          # See https://gitlab.com/gitlab-org/gitlab/-/issues/353958
          params[:ci_config_path] = custom_template.ci_config_path if custom_template.ci_config_path.present?
        end
      end
