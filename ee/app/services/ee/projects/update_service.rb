  ...
  module Projects
    module UpdateService
      ...
      def remove_unallowed_params
        ...
        remove_unauthorized_duo_sast_vr_workflow_enabled
      end

      def remove_unauthorized_duo_sast_vr_workflow_enabled
        setting_attrs = params[:project_setting_attributes]
        return unless setting_attrs.respond_to?(:key?) && setting_attrs.key?(:duo_sast_vr_workflow_enabled)

        return if can?(current_user, :update_duo_setting, project)

        return if can?(current_user, :update_sec_ai_workflow_settings, project)

        setting_attrs.delete(:duo_sast_vr_workflow_enabled)
      end
