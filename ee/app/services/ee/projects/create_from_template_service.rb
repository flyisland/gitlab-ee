  ...
  module Projects
    module CreateFromTemplateService
      ...
      def built_in_template_allowed?
        return true unless target_group&.built_in_project_templates_enabled_available?
        return true if target_group.built_in_project_templates_enabled
      ...
      def target_group
        strong_memoize(:target_group) do
