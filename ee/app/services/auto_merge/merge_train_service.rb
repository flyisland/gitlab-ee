...
module AutoMerge
  class MergeTrainService < AutoMerge::BaseService
    ...
    def cancel(merge_request)
      ...
      next_car = if Feature.enabled?(:unstick_stuck_merge_requests, merge_request.target_project)
                   merge_request.merge_train_car&.any_next
                 else
                   merge_request.merge_train_car&.next_active
                 end
