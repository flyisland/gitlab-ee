...
module MergeRequests
  module Mergeability
    class CheckSecurityPolicyPipelineStatusService < CheckBaseService
      ...
      # Uses `all_pipelines` which includes both MR pipelines and branch pipelines.
      # Uses for_sha_or_source_sha to also match merged result pipelines where
      # the pipeline SHA is a merge commit but source_sha is the branch HEAD.
      ...
      def pipelines_for_sha
        merge_request.all_pipelines.for_sha_or_source_sha(diff_head_sha).internal.to_a
      end
