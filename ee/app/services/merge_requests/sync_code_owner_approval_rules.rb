...
module MergeRequests
  class SyncCodeOwnerApprovalRules
    ...
    def initialize(merge_request, params = {})
      ...
      @enqueue_auto_reviewer_assignment = params[:enqueue_auto_reviewer_assignment].presence
    end
    ...
    def execute
      ...
      ::MergeRequests::AutoAssignReviewersWorker.perform_async(merge_request.id) if @enqueue_auto_reviewer_assignment
    end
