  ...
  module ScanProfiles
    class FindOrCreateService
      ...
      def find_or_create_default_profile
        ...
        return if identifier == 'sast' && !Feature.enabled?(:security_scan_profiles_sast, namespace)
        return if identifier == 'dependency_scanning' && !Feature.enabled?(:security_scan_profiles_dependency_scanning,
          namespace)
