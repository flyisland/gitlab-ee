...
module Security
  module DependencyFirewall
    class EnforcementService
      ...
      # TODO: Hardcoded to false, because currently we only support unforwarded Maven packages
      # This is here to remind us in future to track forwarded packages correctly
      def forwarded?
        false
      end
