  ...
  module Elastic
    class ClusterReindexingService
      ...
      def target_classes
        ...
        if current_task.targets.blank? && ::Search::Elastic::Types::MigrationsIndexConfig.ready?
          classes << ::Search::Elastic::Types::MigrationsIndexConfig
        end
      ...
      def target_readiness_valid?
        current_task.target_classes.each do |klass|
          ...
          error_msg = if klass == ::Search::Elastic::Types::MigrationsIndexConfig
      ...
      def load_alias_info(klass:, name_suffix:)
        ...
        elsif klass == ::Search::Elastic::Types::MigrationsIndexConfig
          alias_name = ::Search::Elastic::Types::MigrationsIndexConfig.index_name
          new_index_name = elastic_helper.index_name_with_timestamp(alias_name, suffix: name_suffix)

          settings = ::Search::Elastic::Types::MigrationsIndexConfig.settings.merge(initial_index_options)
          mappings = ::Search::Elastic::Types::MigrationsIndexConfig.mappings
