    ...
    module ScannerProfiles
      class DestroyService < ::BaseService
        ...
        def execute(id:)
          ...
          return ServiceResponse.error(message: format(_('Cannot delete %{profile_name} referenced in security policy'), profile_name: dast_scanner_profile.name)) if referenced_in_security_policy?(dast_scanner_profile)
