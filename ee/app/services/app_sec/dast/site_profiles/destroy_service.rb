    ...
    module SiteProfiles
      class DestroyService < BaseService
        ...
        def execute(id:)
          ...
          return unauthorized unless can?(current_user, :create_on_demand_dast_scan, dast_site_profile)
          return ServiceResponse.error(message: format(_('Cannot delete %{profile_name} referenced in security policy'), profile_name: dast_site_profile.name)) if referenced_in_security_policy?(dast_site_profile)
