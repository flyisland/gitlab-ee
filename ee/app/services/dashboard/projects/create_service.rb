...
module Dashboard
  module Projects
    class CreateService
      ...
      def initialize(user, projects_relation, feature: nil, ability: nil, organization: nil)
        @user = user
      ...
      def projects_finder_params
        ...
        return params if user.can?(:read_all_resources)

        params.merge(min_access_level: ProjectMember::DEVELOPER)
      end
