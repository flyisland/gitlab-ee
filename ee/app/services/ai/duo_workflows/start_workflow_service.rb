...
module Ai
  module DuoWorkflows
    class StartWorkflowService
      ...
      HARDENED_IMAGE_PATH = "gitlab-org/duo-workflow/default-docker-image/workflow-generic-image-hardened:v0.0.7"
      DUO_CLI_VERSION = "8.100.0"
      ...
      def git_environment_variables
        ...
        return vars.merge(GIT_CONFIG_COUNT: '2') unless project.project_setting.dap_session_tracking_enabled?
        ...
        # /tmp is within the sandbox allowWrite list, so this directory is writable.
        vars.merge(
          GIT_CONFIG_COUNT: '3',
          GIT_CONFIG_KEY_2: 'core.hooksPath',
          GIT_CONFIG_VALUE_2: GIT_HOOKS_DIR
        )
      end
      ...
      def commands
        ...
        sandbox.setup_sandbox_commands + git_hooks_setup_commands + setup_script_commands + main_workflow_commands
      end
