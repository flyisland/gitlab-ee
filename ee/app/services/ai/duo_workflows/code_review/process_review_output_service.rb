    ...
    module CodeReview
      class ProcessReviewOutputService
        ...
        def valid?
          if review_output.blank?
            return fail_with(
              ...
              ::Ai::CodeReviewMessages.invalid_review_output
            )
          end
          ...
          if ai_reviewable_diff_files.empty?
            return fail_with(
              ...
              exclusion_message_for_excluded_files + ::Ai::CodeReviewMessages.nothing_to_review
            )
          end
        ...
        def execute
          ...
          return error(::Ai::CodeReviewMessages.progress_note_not_found_error) unless progress_note
