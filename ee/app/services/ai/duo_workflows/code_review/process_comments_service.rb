  ...
  module DuoWorkflows
    module CodeReview
      class ProcessCommentsService
        ...
        # Only the advanced flow posts JSON, and it is only reachable behind the flag. JSON with
        ...
        def build_parser
          ...
          if ::Feature.enabled?(:duo_code_review_advanced_flow, user) && structured
            ::Gitlab::Duo::CodeReview::FindingsParser.new(review_output)
          elsif structured
            raise ::Gitlab::Duo::CodeReview::FindingsParser::Error,
              'structured review output received while duo_code_review_advanced_flow is disabled'
          else
