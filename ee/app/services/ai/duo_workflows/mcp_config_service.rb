...
module Ai
  module DuoWorkflows
    class McpConfigService
      ...
      ORBIT_PREAPPROVED_TOOLS = ::API::Orbit::McpHandlers::ToolCatalog::TRUSTED_TOOL_NAMES
      ...
      def orbit_enabled_for_flow?
        # Map the active workflow to the matching Orbit subsetting and
        # delegate the gate check to the facade. Custom agents are
        # checked first because they can run with any workflow_definition
        # (including 'chat'); the user-built nature of the agent takes
        # precedence over the workflow category.
        if custom_agent?
