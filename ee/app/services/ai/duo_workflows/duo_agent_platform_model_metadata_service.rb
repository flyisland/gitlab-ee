  ...
  module DuoWorkflows
    class DuoAgentPlatformModelMetadataService
      ...
      def do_not_consider_user_selected_model?(setting, model_selection_scope)
        user_model_selection(setting, model_selection_scope)
          .do_not_consider_user_selected_model?(user_selected_model_identifier)
      end

      def user_model_selection(setting, model_selection_scope)
        strong_memoize_with(:user_model_selection, setting, model_selection_scope) do
          ::Ai::ModelSelection::UserModelSelection.new(
            current_user, feature_setting: setting, model_selection_scope: model_selection_scope
          )
        end
      end
