...
module Ai
  module DuoWorkflows
    class CreateAndStartWorkflowService
      ...
      def initialize(container:, current_user:, goal:, source_branch:, workflow_definition:, additional_context: [])
        @container = container
      ...
      attr_reader :container, :current_user, :workflow_definition, :goal, :source_branch, :additional_context
      ...
      def start_workflow_params(workflow)
        {
          ...
          additional_context: additional_context
        }.merge(::Ai::DuoWorkflows::FoundationalFlowStartParamsResolver.call(workflow_definition_reference, container,
          user: current_user))
      end
