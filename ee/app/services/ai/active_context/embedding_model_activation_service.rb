...
module Ai
  module ActiveContext
    class EmbeddingModelActivationService
      ...
      def initialize(collection_class:, model_ref:, dimensions:, model_type: nil, skip_embeddings_request_test: false)
      ...
      attr_reader :collection_class, :model_ref, :dimensions, :model_type, :skip_embeddings_request_test
      ...
      def valid_model_ref?
        ::Ai::ActiveContext::Embedding.valid_model_ref?(model_ref, model_type: model_type)
      end
