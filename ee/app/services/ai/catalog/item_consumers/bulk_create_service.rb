  ...
  module Catalog
    module ItemConsumers
      class BulkCreateService
        ...
        def initialize(current_user:, item:, projects:, trigger_types: nil, trigger_filter: nil)
        ...
        attr_reader :current_user, :item, :projects, :trigger_types, :trigger_filter
        ...
        strong_memoize_attr def create_service_params
          { item:, trigger_types:, trigger_filter: }.compact
        end
      end
    end
  end
