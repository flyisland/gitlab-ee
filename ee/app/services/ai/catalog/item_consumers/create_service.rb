    ...
    module ItemConsumers
      class CreateService < ::BaseContainerService
        ...
        def create_item_consumer(service_account)
          ...
          item_consumer_params = params.except(:authorization_container)
        ...
        def create_service_account
          ...
          response = ::Namespaces::ServiceAccounts::GroupCreateService.new(
            current_user,
            service_account_params,
        ...
        def error_creating(record)
          ...
          error(record.errors.full_messages.presence || 'Failed to enable agent or flow')
        end
        ...
        def auto_resolve_parent_item_consumer
          ...
          return ServiceResponse.success(payload: { item_consumer: existing }) if existing
        ...
        def allowed?
          ...
          Ability.allowed?(current_user, :admin_ai_catalog_item_consumer, auth_container) &&
