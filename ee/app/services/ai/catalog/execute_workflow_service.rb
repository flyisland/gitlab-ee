...
module Ai
  module Catalog
    class ExecuteWorkflowService
      ...
      def execute
        ...
        workflow = if @resume_context
                     ...
                     if workflow_result.error?
                       return error(workflow_result[:message], reason: workflow_result.payload[:reason])
                     end
      ...
      def error(message, payload: {}, reason: nil)
        ServiceResponse.error(message: Array(message), payload: payload, reason: reason)
      end
