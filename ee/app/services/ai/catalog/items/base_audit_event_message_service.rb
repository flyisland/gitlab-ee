    ...
    module Items
      class BaseAuditEventMessageService
        ...
        def visibility_label
          return item.visibility if internal_visibility_enabled?

          legacy_visibility_label
        end

        def legacy_visibility_label
        ...
        def visibility_updated?
          (internal_visibility_enabled? && update_visibility_changed?) || legacy_update_visibility_changed?
        end

        def update_visibility_changed?
        ...
        def legacy_update_visibility_changed?
          legacy_update_visibility_change.present? &&
            legacy_update_visibility_change[0] != legacy_update_visibility_change[1]
        end

        def legacy_update_visibility_change
