...
class AddChecksumMismatchIndexToProjectWikiRepositoryRegistry < Gitlab::Database::Migration[2.3]
  disable_ddl_transaction!

  milestone '19.3'

  TABLE = :project_wiki_repository_registry
  INDEX = 'index_project_wiki_repository_registry_checksum_mismatch'
