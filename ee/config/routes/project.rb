    ...
    scope(
      ...
      scope '-' do
        ...
        scope :automate do
          ...
          get 'agent-sessions/:id', to: 'duo_agents_platform#show', as: :automate_agent_session, format: false
          ...
          post 'onboarding/initialize', to: 'duo_agents_platform#create_onboarding_workflow',
            as: :automate_onboarding_initialize, format: false
          post 'onboarding/improve_ci', to: 'duo_agents_platform#improve_ci',
            as: :automate_onboarding_improve_ci, format: false
          post 'onboarding/initialize_execution_env',
            to: 'duo_agents_platform#create_execution_env_workflow',
            as: :automate_onboarding_initialize_execution_env, format: false
          post 'onboarding/initialize_mr_review_instructions',
            to: 'duo_agents_platform#create_mr_review_instructions_workflow',
            as: :automate_onboarding_initialize_mr_review_instructions, format: false
        end

        resources :duo_otel_workflows, only: [:create], controller: 'duo_otel_workflows'
        ...
        namespace :security do
          ...
          resources :agent_artifacts, only: [:index]
