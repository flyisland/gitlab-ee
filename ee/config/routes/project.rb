    ...
    scope(
      ...
      scope '-' do
        ...
        scope :automate do
          ...
          post 'onboarding/setup', to: 'duo_agents_platform#setup_onboarding',
            as: :automate_onboarding_setup, format: false
        end
        ...
        namespace :security do
          ...
          resources :agent_artifacts, only: [:index], constraints: { id: /\d+/ } do
            member do
              get :download
            end
          end
