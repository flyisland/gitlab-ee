  ...
  module Elastic
    class WorkItemQueryBuilder < QueryBuilder
      ...
      def build
        ...
        if options[:aggregation]
          query_hash = ::Search::Elastic::Aggregations.by_label_ids(query_hash: query_hash)
          return ::Search::Elastic::Aggregations.by_work_item_type_ids(query_hash: query_hash)
        end
