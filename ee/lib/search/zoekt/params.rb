  ...
  module Zoekt
    class Params
      ...
      def max_file_match_results
        ...
        if ::Feature.enabled?(:zoekt_cap_file_match_results, Feature.current_request) && !use_offset_pagination?
          return capped_file_match_results
        end
      ...
      def capped_file_match_results
        [current_page, ::Search::Zoekt::Cache::MAX_PAGES].max * per_page
      end
    end
  end
end
