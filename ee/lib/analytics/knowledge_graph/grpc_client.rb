...
require 'gkg'
require_relative 'agent_command_proto_compat'
require 'resolv'
  ...
  module KnowledgeGraph
    class GrpcClient
      ...
      class << self
        ...
        #   string sourced from `Ai::Setting#enabled_instance_verbose_ai_logs`.
        #
        ...
        def outgoing_headers
          ...
          verbose_ai_logs = ::Ai::Setting.instance&.enabled_instance_verbose_ai_logs.to_s
