...
module API
  class DependencyListExports < ::API::Base
    ...
    resource :projects, requirements: API::NAMESPACE_OR_PROJECT_REQUIREMENTS do
      ...
      desc 'Generate a dependency list export on a project-level' do
        detail 'Generates a dependency list export for a project'
    ...
    resource :groups, requirements: API::NAMESPACE_OR_PROJECT_REQUIREMENTS do
      ...
      desc 'Generate a dependency list export on a group-level' do
        detail 'Generates a dependency list export for a group'
        tags ['dependency_management']
      end
    ...
    resource :pipelines do
      ...
      desc 'Generate a dependency list export on a pipeline-level' do
        detail 'Generates a dependency list export for a pipeline'
        tags ['dependency_management']
      end
      post ':id/dependency_list_exports' do
    ...
    desc 'Get a dependency list export' do
    ...
    desc 'Download a dependency list export' do
      detail 'Downloads a dependency list export file'
      tags ['dependency_management']
    end
