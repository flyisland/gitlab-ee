...
module API
  class GeoNodes < ::API::Base
    ...
    resource :geo_nodes do
      ...
      route_setting :authorization, permissions: :create_geo_node, boundary_type: :instance
      post do
      ...
      route_param :id, type: Integer, desc: 'The ID of the node' do
        ...
        route_setting :authorization, permissions: :repair_geo_node, boundary_type: :instance
        post 'repair' do
          not_found!('GeoNode') unless geo_node
        ...
        route_setting :authorization, permissions: :update_geo_node, boundary_type: :instance
        put do
          not_found!('GeoNode') unless geo_node
        ...
        route_setting :authorization, permissions: :delete_geo_node, boundary_type: :instance
        delete do
          not_found!('GeoNode') unless geo_node
