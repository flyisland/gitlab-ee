    ...
    module DuoWorkflows
      class Workflows < ::API::Base
        ...
        allow_access_with_scope :ai_workflows, if: ->(request) do
          expected_path = Gitlab::Utils.append_path(
            Gitlab.config.gitlab.relative_url_root, '/api/v4/ai/duo_workflows/ws')
          request.get? && request.path == expected_path
        end
        ...
        helpers do
          ...
          def compute_server_capabilities(dws_capabilities:, namespace:)
            ...
            if Feature.enabled?(:duo_workflow_incremental_checkpoints, namespace)
            ...
            namespace :workflows do
              namespace ':workflow_id' do
                ...
                get 'trace.jsonl' do
                  ...
                  channel_values = workflow.checkpoints.latest&.checkpoint&.dig('channel_values') || {}
              ...
              post do
                ...
                if params[:ai_catalog_item_consumer_id]
                  ...
                  authorize_foundational_flows!(workflow_params, container)
