...
module API
  module Entities
    class Epic < Grape::Entity
      ...
      expose :group_id, documentation: { type: 'Integer', example: 17 } do |_epic|
        epic_view.group_id
      end

      expose :parent_id, documentation: { type: 'Integer', example: 12 } do |_epic|
        epic_view.parent_id
      end
      ...
      expose :reference, if: { with_reference: true } do |_epic|
      ...
      expose :labels, documentation: { is_array: true } do |_epic, options|
