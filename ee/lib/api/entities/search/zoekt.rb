    ...
    module Search
      module Zoekt
        class IndexedNamespace < Grape::Entity
          ...
          expose :zoekt_shard_id, documentation: { type: 'Integer', example: 1234 } do |_, options|
            options[:zoekt_node_id]
          end
          expose :zoekt_node_id, documentation: { type: 'Integer', example: 1234 } do |_, options|
            options[:zoekt_node_id]
          end
          expose :root_namespace_id, documentation: { type: 'Integer', example: 1234 }, as: :namespace_id
