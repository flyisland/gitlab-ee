    ...
    class ProductAnalytics < ::API::Base
      ...
      resource :projects, requirements: API::NAMESPACE_OR_PROJECT_REQUIREMENTS do
        desc 'Proxy analytics request to cube installation.
            Requires :product_analytics_features flag to be enabled.' do
          detail 'Proxies analytics requests to the cube installation'
        ...
        desc 'Dry-run analytics request to cube installation.' do
          detail 'Performs a dry-run of an analytics request to the cube installation'
          tags %w[analytics internal_operations]
        end
        params do
          use :cube_query_params
