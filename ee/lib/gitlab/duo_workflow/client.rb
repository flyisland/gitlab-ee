...
module Gitlab
  module DuoWorkflow
    class Client
      ...
      def self.cloud_connector_headers(user:, feature_setting: nil, **kwargs)
        Gitlab::AiGateway
      ...
      def self.metadata(user, namespace: nil)
        {
      ...
      private_class_method def self.tool_approval_for_session_enabled?(namespace: nil)
