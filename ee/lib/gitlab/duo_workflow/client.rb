...
module Gitlab
  module DuoWorkflow
    class Client
      ...
      def self.cloud_connector_headers(user:, feature_setting: nil, tool_access_policies: {}, subject: user, **kwargs)
        Gitlab::AiGateway
          .public_headers(user: user, feature_setting: feature_setting, ai_feature_name: :duo_workflow,
            unit_primitive_name: :duo_workflow_execute_workflow, subject: subject, **kwargs)
