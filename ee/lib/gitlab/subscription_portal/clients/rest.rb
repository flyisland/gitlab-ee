      ...
      module Rest
        ...
        class_methods do
          ...
          def generate_addon_trial_lead(params)
            ...
            trial_user_params = params[:trial_user] ? params : { trial_user: params }
            http_post(addon_trial_lead_endpoint, admin_headers, trial_user_params)
          end
          ...
          def generate_addon_trial(params)
            ...
            trial_user_params = params[:trial_user] ? params : { trial_user: params }
            http_post(addon_trial_endpoint, admin_headers, trial_user_params)
          end
          ...
          def addon_trial_lead_endpoint
            if Feature.enabled?(:new_addon_lead_endpoint, :instance)
              "leads/gitlab_com/addons"
            else
              "trials/create_addon"
            end
          end

          def addon_trial_endpoint
            if Feature.enabled?(:new_addon_trial_endpoint, :instance)
