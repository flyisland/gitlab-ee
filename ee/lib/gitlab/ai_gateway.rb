...
module Gitlab
  module AiGateway
    ...
    def self.self_hosted_url
      ::Ai::Setting.instance&.ai_gateway_url&.chomp('/')
    end
    ...
    def self.headers(
      ...
      bearer_token = cloud_connector_token(unit_primitive_name, user, feature_setting: feature_setting)
    ...
    def self.cloud_connector_token(unit_primitive_name, user, feature_setting: nil)
