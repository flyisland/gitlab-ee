    ...
    module AiGateway
      class CodeSuggestionsClient
        ...
        def test_model_connection(self_hosted_model)
          ...
          response = call_endpoint test_task.endpoint, test_task.body, test_feature_setting: test_task.feature_setting
        ...
        def call_endpoint(endpoint, body, test_feature_setting: nil)
          Gitlab::HTTP.post(
            endpoint,
            headers: ai_gateway_headers(feature_setting: test_feature_setting),
            body: body,
