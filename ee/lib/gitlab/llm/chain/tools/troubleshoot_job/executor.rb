      ...
      module Tools
        module TroubleshootJob
          class Executor < SlashCommandTool
            ...
            def authorize
              # Enforce trace access on both paths; the usage-entitlement branch does not.
              return false unless context.current_user&.can?(:read_build_trace, job)
