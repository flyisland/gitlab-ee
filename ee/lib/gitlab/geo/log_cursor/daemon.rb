  ...
  module Geo
    module LogCursor
      class Daemon
        ...
        def run_once!
          # Prevent the node from processing events unless it's a secondary or org migration target
          unless Geo.secondary_or_org_migration_target?
            logger.debug(
              "#run!: not a secondary or org migration target, sleeping for #{SECONDARY_CHECK_INTERVAL} secs"
            )
        ...
        def handle_error(error)
          ...
          return unless excessive_errors?
