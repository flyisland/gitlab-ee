...
module MergeRequests
  class MergeRequestBeforeDestroyAuditor
    ...
    def audit_event_message
      ...
      committer_ids = if Feature.enabled?(:destroy_mr_audit_use_committer_ids_from_diff, merge_request.project)
                        merge_request.committer_user_ids_from_diff.to_sentence
                      else
                        merge_request.commits.committer_user_ids.to_sentence
                      end
