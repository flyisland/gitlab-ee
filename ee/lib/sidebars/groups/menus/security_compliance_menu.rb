      ...
      class SecurityComplianceMenu < ::Sidebars::Menu
        ...
        def group_level_secrets_manager_available?
          ::Feature.enabled?(:group_secrets_manager, context.group) &&
            ...
            group_secrets_manager_active?
        end

        def group_secrets_manager_active?
          SecretsManagement::GroupSecretsManager.find_by_group_id(context.group.id)&.active?
        end
        strong_memoize_attr :group_secrets_manager_active?
