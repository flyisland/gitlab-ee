    ...
    module Menus
      class SecurityComplianceMenu < ::Sidebars::Menu
        ...
        def group_level_secrets_manager_available?
          secrets_manager_available_and_active_for_group?(context.group) &&
            can?(context.current_user, :read_secret, context.group)
        end
        ...
        def can_access_group_security_scan_profiles?
          can?(context.current_user, :read_security_scan_profiles, context.group.root_ancestor) &&
            ...
            ::Feature.enabled?(:group_security_configuration_scanners_tab, context.group.root_ancestor)
        end
