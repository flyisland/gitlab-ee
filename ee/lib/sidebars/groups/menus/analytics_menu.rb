      ...
      class AnalyticsMenu < ::Sidebars::Menu
        ...
        def contribution_analytics_menu_item
          ...
          ::Sidebars::MenuItem.new(
            ...
            tier: tier_for(:contribution_analytics)
          )
        end
        ...
        def devops_adoption_menu_item
          ...
          ::Sidebars::MenuItem.new(
            ...
            tier: tier_for(:group_level_devops_adoption)
          )
        end
        ...
        def issues_analytics_menu_item
          ...
          ::Sidebars::MenuItem.new(
            ...
            tier: tier_for(:issues_analytics)
          )
        end
        ...
        def productivity_analytics_menu_item
          ...
          ::Sidebars::MenuItem.new(
            ...
            tier: tier_for(:productivity_analytics)
          )
        end
        ...
        def repository_analytics_menu_item
          ...
          ::Sidebars::MenuItem.new(
            ...
            tier: tier_for(:group_coverage_reports)
          )
        end
        ...
        def dashboards_analytics_menu_item
          ...
          ::Sidebars::MenuItem.new(
            ...
            library_icon: 'chart',
            tier: tier_for(:group_level_analytics_dashboard)
          )
        end
