      ...
      class SecurityDashboardMenu < ::Sidebars::Menu
        ...
        def security_dashboard_item
          ::Sidebars::MenuItem.new(
            ...
            link: security_dashboard_path(organization_path: nil),
        ...
        def vulnerability_report_item
          ::Sidebars::MenuItem.new(
            ...
            link: security_vulnerabilities_path(organization_path: nil),
        ...
        def security_settings_item
          ::Sidebars::MenuItem.new(
            title: _('Settings'),
            link: settings_security_dashboard_path(organization_path: nil),
