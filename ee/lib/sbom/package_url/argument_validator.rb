...
module Sbom
  class PackageUrl
    class ArgumentValidator
      ...
      def validate_swift
        # The version is optional per the PURL spec, so we accept versionless Swift packages (e.g. a dependency
        # pinned to a branch). Components without a version are skipped later when a version is required for matching.
