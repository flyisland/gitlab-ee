...
module Security
  module LicenseOverrides
    module Shared
      ...
      # Class-level memoization is intentional: the catalog only changes on redeployment.
      def spdx_catalog_map
        self.class.instance_variable_get(:@spdx_catalog_map) ||
          self.class.instance_variable_set(:@spdx_catalog_map, load_spdx_catalog)
      end

      def load_spdx_catalog
