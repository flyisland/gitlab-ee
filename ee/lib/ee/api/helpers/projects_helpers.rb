    ...
    module Helpers
      module ProjectsHelpers
        ...
        def restrict_attrs_for_sec_ai_workflow_setting!(project, attrs)
          ...
          attrs.slice!(:duo_sast_vr_workflow_enabled)
        end
        ...
        def filter_duo_vulnerability_attributes!(attrs)
          ...
          unless ::Feature.enabled?(:enable_vulnerability_resolution, user_project)
            attrs.delete(:duo_sast_vr_workflow_enabled)
          end

          # rubocop:disable  Style/GuardClause -- no we don't want an early return
