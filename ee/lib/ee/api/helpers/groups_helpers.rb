      ...
      module GroupsHelpers
        ...
        prepended do
          params :optional_params_ee do
            ...
            optional :duo_availability, type: String, values: %w[default_on default_off never_on always_on], desc: 'Duo availability. One of `default_on`, `default_off`, `never_on` or `always_on`'
            ...
            optional :ai_settings_attributes, type: Hash, desc: 'AI-related settings' do
              ...
              optional :ai_catalog_restricted_to_group_hierarchy, type: ::Grape::API::Boolean, desc: 'Restrict the AI Catalog to items within this top-level group hierarchy'
