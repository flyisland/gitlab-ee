  ...
  module API
    module Helpers
      ...
      def send_git_archive(repository, **kwargs)
        ...
        audit_repository_download(repository)

        super
      end

      override :send_git_archive_head
      def send_git_archive_head(repository, **kwargs)
        check_download_permission!(repository)
        # Skip audit event for HEAD requests since no actual download occurs
      ...
      def audit_repository_download(repository)
