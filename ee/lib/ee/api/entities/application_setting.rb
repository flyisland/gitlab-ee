      ...
      module ApplicationSetting
        ...
        prepended do
          ...
          expose :duo_cli_enabled,
            if: ->(_instance, _opts) { ::License.ai_features_available? && ::Feature.enabled?(:duo_cli_enabled_setting, :instance) } do |_instance|
          ...
          expose :built_in_project_templates_enabled,
            ...
            if: ->(_instance, _opts) do
              ::Feature.enabled?(:use_built_in_project_templates_enabled, :instance) && ::License.feature_available?(:built_in_project_templates_enabled)
            end
