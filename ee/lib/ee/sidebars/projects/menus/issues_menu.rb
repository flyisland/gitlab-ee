        ...
        module IssuesMenu
          ...
          def iterations_menu_item
            ...
            ::Sidebars::MenuItem.new(
              ...
              item_id: :iterations,
              description: _('Group issues into time-boxed cycles to plan and track sprints'),
              library_icon: 'iteration',
              tier: tier_for(:iterations)
            )
          end
          ...
          def requirements_menu_item
            ...
            ::Sidebars::MenuItem.new(
              ...
              library_icon: 'requirements',
              description: _('Set criteria to check your products against')
            )
          end
          ...
          def jira_issue_list_menu_item
            ...
            ::Sidebars::MenuItem.new(
              ...
              description: _('Manage Jira issues')
            )
          end
