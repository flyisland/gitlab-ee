        ...
        module Chain
          module PipelineExecutionPolicies
            module ApplyPolicies
              ...
              def merge_policy_jobs
                applicable_policy_pipelines.each do |policy|
                  ...
                  job_injector = ::Gitlab::Ci::Pipeline::JobsInjector.new(
                    ...
                    job_name_mappings: combined_job_name_mappings)
              ...
              def combined_job_name_mappings
                all_mappings = [
                  command.yaml_processor_result.job_name_mappings,
                  *applicable_policy_pipelines.map(&:job_name_mappings)
                ]
              ...
              strong_memoize_attr :combined_job_name_mappings
