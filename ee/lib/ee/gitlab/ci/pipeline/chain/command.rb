      ...
      module Pipeline
        module Chain
          module Command
            ...
            override :scan_profile_eligibility_service
            def scan_profile_eligibility_service
              self[:scan_profile_eligibility_service] ||= ::Security::ScanProfiles::PipelineEligibilityService.new(
                project: project,
                ref: ref,
