          ...
          module Validate
            module Abilities
              ...
              def allowed_to_run_pipeline?
                ...
                #
                # This enforces a private permission directly, which the cop below disallows.
                # Replacing it with a public permission is tracked in
                # https://gitlab.com/gitlab-org/gitlab/-/work_items/599236
                # rubocop:disable Gitlab/Authz/PermissionCheck -- Temporary exception, see issue above
