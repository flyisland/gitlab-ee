      ...
      class_methods do
        ...
        def rate_limits
          super.merge({
            ...
            semantic_search_rate_limit: { threshold: 10, interval: 1.minute },
            ...
            create_duo_otel_workflow: { threshold: 5, interval: 1.minute },
            ...
            geo_proxy: { threshold: 3600, interval: 1.minute },
            orbit_query: { threshold: 60, interval: 1.minute },
            package_metadata: { threshold: 1000, interval: 1.hour },
            semantic_code_search_ad_hoc_indexing: { threshold: 10, interval: 1.hour }
          }).freeze
        end
      end
    end
