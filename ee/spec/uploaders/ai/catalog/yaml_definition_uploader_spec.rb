...
RSpec.describe Ai::Catalog::YamlDefinitionUploader, feature_category: :ai_agents do
  ...
  let_it_be(:item, freeze: false) { create(:ai_catalog_item, :flow, project: project) }
  let_it_be(:item_version, freeze: false) { create(:ai_catalog_flow_version, item: item) }
  ...
  describe '#store_dir' do
    ...
    context 'when organization_id differs' do
      ...
      let_it_be(:other_item, freeze: false) do
        create(:ai_catalog_item, :flow, project: other_project, organization: other_organization)
      end

      let_it_be(:other_item_version, freeze: false) { create(:ai_catalog_flow_version, item: other_item) }
