...
RSpec.describe Onboarding::StatusPresenter, feature_category: :onboarding do
  ...
  describe '.registration_path_params' do
    ...
    context 'when onboarding is enabled' do
      ...
      context 'when from_sign_in is present' do
        let(:params) do
          ActionController::Parameters.new(glm_source: 'source', glm_content: 'content', from_sign_in: true)
        end

        let(:expected_params) do
          { glm_source: 'source', glm_content: 'content', from_sign_in: true }
        end
