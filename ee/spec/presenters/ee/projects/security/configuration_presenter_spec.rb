...
RSpec.describe Projects::Security::ConfigurationPresenter, feature_category: :software_composition_analysis do
  ...
  describe '#to_html_data_attribute' do
    ...
    where(:feature_flag, :container_licensed, :dependency_licensed, :include_cs, :include_ds) do
    ...
    with_them do
      before do
        stub_feature_flags(cvs_per_scanner_type_settings: feature_flag ? project : false)
    ...
    context 'when license_scanning_for_cyclonedx feature flag and license are both enabled' do
      before do
    ...
    describe 'license_scanning_for_cyclonedx availability' do
      where(:feature_flag, :licensed, :included) do
        true  | true  | true
        true  | false | false
        false | true  | false
      end
      ...
      with_them do
        before do
          stub_feature_flags(license_scanning_for_cyclonedx_setting: feature_flag ? project : false)
