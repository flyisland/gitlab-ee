...
RSpec.describe 'User with read_dependency custom role', feature_category: :system_access do
  let_it_be(:project, freeze: false) { create(:project, :repository, :in_group, :security_and_compliance_enabled) }
  ...
  describe Projects::DependenciesController do
    ...
    let_it_be(:role, freeze: false) { create(:member_role, :guest, namespace: project.group, read_dependency: true) }
