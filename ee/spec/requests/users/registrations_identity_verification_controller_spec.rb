...
RSpec.describe Users::RegistrationsIdentityVerificationController, :clean_gitlab_redis_sessions,
  ...
  describe 'GET show' do
    ...
    context 'with experiment tracking', :experiment do
      it 'tracks render event with verification label' do
        expect(experiment(:trial_first_registration, actor: unconfirmed_user, only_assigned: true))
          .to track(:render_verification).on_next_instance
