...
RSpec.describe API::Vulnerabilities, feature_category: :vulnerability_management do
  ...
  describe 'GET /projects/:id/vulnerabilities' do
    ...
    it_behaves_like 'allows read access with ai_workflows scope' do
      subject(:api_request) { get api(project_vulnerabilities_path, oauth_access_token: oauth_token) }
    end
  ...
  describe 'GET /vulnerabilities/:id' do
    ...
    context 'with an authorized user with proper permissions' do
      ...
      it_behaves_like 'authorizing granular token permissions', :read_vulnerability do
        let(:boundary_object) { vulnerability.project }
        let(:request) do
          get api("/vulnerabilities/#{vulnerability_id}", personal_access_token: pat)
        end
      end
    end

    it_behaves_like 'allows read access with ai_workflows scope' do
      subject(:api_request) { get api("/vulnerabilities/#{vulnerability_id}", oauth_access_token: oauth_token) }
    end
  ...
  describe 'POST /projects/:id/vulnerabilities' do
    ...
    it_behaves_like 'denies write access with ai_workflows scope' do
      subject(:api_request) do
        post api(project_vulnerabilities_path, oauth_access_token: oauth_token), params: { finding_id: finding_id }
      end
    end
  ...
  describe 'POST /vulnerabilities:id/dismiss' do
    ...
    context 'with an authorized user with proper permissions' do
      ...
      it_behaves_like 'authorizing granular token permissions', :dismiss_vulnerability do
        let(:boundary_object) { vulnerability.project }
        let(:request) do
          post api("/vulnerabilities/#{vulnerability_id}/dismiss", personal_access_token: pat)
        end
      end
    end
  ...
  describe 'POST /vulnerabilities/:id/resolve' do
    ...
    context 'with an authorized user with proper permissions' do
      ...
      it_behaves_like 'authorizing granular token permissions', :resolve_vulnerability do
        let(:boundary_object) { vulnerability.project }
        let(:request) do
          post api("/vulnerabilities/#{vulnerability_id}/resolve", personal_access_token: pat)
        end
      end
    end
  ...
  describe 'POST /vulnerabilities/:id/confirm' do
    ...
    context 'with an authorized user with proper permissions' do
      ...
      it_behaves_like 'authorizing granular token permissions', :confirm_vulnerability do
        let(:boundary_object) { vulnerability.project }
        let(:request) do
          post api("/vulnerabilities/#{vulnerability_id}/confirm", personal_access_token: pat)
        end
      end
    end
  ...
  describe 'POST /vulnerabilities:id/revert' do
    ...
    context 'with an authorized user with proper permissions' do
      ...
      it_behaves_like 'authorizing granular token permissions', :revert_vulnerability do
        let(:boundary_object) { vulnerability.project }
        let(:request) do
          post api("/vulnerabilities/#{vulnerability_id}/revert", personal_access_token: pat)
        end
      end
    end
