...
RSpec.describe API::Analytics::GroupActivityAnalytics, feature_category: :value_stream_management do
  ...
  context 'GET /group_activity/issues_count' do
    ...
    it_behaves_like 'authorizing granular token permissions', :read_activity_analytics do
      ...
      let(:request) do
        get api('/analytics/group_activity/issues_count', personal_access_token: pat),
          params: { group_path: group.full_path }
      end
    end
  end
  ...
  context 'GET /group_activity/merge_requests_count' do
    ...
    it_behaves_like 'authorizing granular token permissions', :read_activity_analytics do
      ...
      let(:request) do
        get api('/analytics/group_activity/merge_requests_count', personal_access_token: pat),
          params: { group_path: group.full_path }
      end
    end
  end
  ...
  context 'GET /group_activity/new_members_count' do
    ...
    it_behaves_like 'authorizing granular token permissions', :read_activity_analytics do
      ...
      let(:request) do
        get api('/analytics/group_activity/new_members_count', personal_access_token: pat),
          params: { group_path: group.full_path }
      end
    end
  end
