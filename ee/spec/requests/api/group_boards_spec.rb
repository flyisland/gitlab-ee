...
RSpec.describe API::GroupBoards, feature_category: :portfolio_management do
  ...
  let_it_be(:milestone, freeze: false) { create(:milestone, group: board_parent) }
  let_it_be(:board_label, freeze: false) { create(:group_label, group: board_parent) }

  let_it_be(:board, freeze: false) do
