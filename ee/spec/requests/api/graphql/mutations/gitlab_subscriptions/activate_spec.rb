...
RSpec.describe 'Activate a subscription', feature_category: :subscription_management do
  ...
  it_behaves_like 'authorizing granular token permissions for GraphQL', :update_gitlab_subscription do
    let(:user) { current_user }
    let(:boundary_object) { :instance }
    let(:mutation) { graphql_mutation(:gitlab_subscription_activate, { activation_code: activation_code }, 'errors') }
  ...
  def license_params(created_license)
    {
      ...
      'subscriptionName' => created_license.subscription_name
    }
  end
end
