...
RSpec.describe 'Create project subscription', feature_category: :continuous_integration do
  ...
  context 'when the user has the required permissions' do
    ...
    it_behaves_like 'authorizing granular token permissions for GraphQL', :create_pipeline_subscription,
      additional_scope_permissions: :create_pipeline_subscription do
      let(:user) { current_user }
      let(:boundary_object) { project }
      let(:additional_scope_requirements) do
        [{ boundary_object: upstream_project, permissions: :create_pipeline_subscription }]
      end
