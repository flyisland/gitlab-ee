...
RSpec.describe 'Exporting Requirements', feature_category: :requirements_management do
  ...
  context 'when the user has permission' do
    before_all { project.add_reporter(current_user) }
    ...
    context 'when requirements are enabled' do
      ...
      it_behaves_like 'authorizing granular token permissions for GraphQL', :read_requirement do
