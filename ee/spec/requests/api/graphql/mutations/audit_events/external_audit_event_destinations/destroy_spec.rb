...
RSpec.describe 'Destroy an external audit event destination', feature_category: :audit_events do
  ...
  let_it_be_with_reload(:destination) { create(:external_audit_event_destination, group: group) }
  ...
  context 'when feature is licensed' do
    ...
    context 'when current user is a group owner' do
      ...
      it 'audits the destruction' do
        ...
        expect(AuditEventReader.last.details[:custom_message]).to match(/Destroy event streaming destination/)
      end
  ...
  context 'with granular token authorization' do
    ...
    it_behaves_like 'authorizing granular token permissions for GraphQL', :delete_audit_event_streaming_destination do
