...
RSpec.describe 'Creating a new on-call schedule', feature_category: :incident_management do
  ...
  it_behaves_like 'authorizing granular token permissions for GraphQL', :create_oncall_schedule do
