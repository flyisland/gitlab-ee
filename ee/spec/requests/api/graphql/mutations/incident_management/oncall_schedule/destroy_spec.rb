...
RSpec.describe 'Removing an on-call schedule', feature_category: :incident_management do
  ...
  it_behaves_like 'authorizing granular token permissions for GraphQL', :delete_oncall_schedule do
