...
RSpec.describe 'Assigns scan execution policy project to a project/namespace',
  ...
  context 'with granular token authorization' do
    ...
    it_behaves_like 'authorizing granular token permissions for GraphQL', :update_security_policy do
      ...
      let(:mutation) do
        graphql_mutation(:security_policy_project_assign,
          { full_path: project.full_path, security_policy_project_id: policy_project_id.to_s }, 'errors')
      end
    ...
    it_behaves_like 'authorizing granular token permissions for GraphQL', :update_security_policy do
      ...
      let(:mutation) do
        graphql_mutation(:security_policy_project_assign,
          { full_path: namespace.full_path, security_policy_project_id: policy_project_id.to_s }, 'errors')
      end
