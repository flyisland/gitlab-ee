...
RSpec.describe Mutations::Ai::Catalog::ThirdPartyFlow::Delete, feature_category: :ai_catalog_curation do
  ...
  context 'when destroy service succeeds' do
    it_behaves_like 'authorizing granular token permissions for GraphQL', :delete_ai_catalog_third_party_flow do
      let(:user) { current_user }
      let(:boundary_object) { project }
      let(:authz_mutation) { graphql_mutation(:ai_catalog_third_party_flow_delete, params, 'errors') }
