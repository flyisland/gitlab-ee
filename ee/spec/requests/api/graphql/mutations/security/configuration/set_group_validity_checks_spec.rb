...
RSpec.describe 'Setting Group Validity Checks', feature_category: :security_testing_configuration do
  ...
  it 'requires update_secret_detection_validity_check permission' do
    expect(Mutations::Security::CiConfiguration::SetGroupValidityChecks)
      .to require_graphql_authorizations(:update_secret_detection_validity_check)
  end
    ...
    context 'with group' do
      ...
      context 'when user is a member of the group' do
        ...
        context 'when the namespace is not a group' do
          ...
          let_it_be(:current_user, freeze: false) { create(:user, namespace: namespace) }
