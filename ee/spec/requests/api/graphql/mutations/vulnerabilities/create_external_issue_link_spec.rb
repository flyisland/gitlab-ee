...
RSpec.describe 'Creating an External Issue Link', feature_category: :vulnerability_management do
  ...
  let_it_be(:finding, freeze: false) { create(:vulnerabilities_finding, :with_pipeline, project: project, severity: :high) }
  let_it_be(:vulnerability, freeze: false) { create(:vulnerability, title: 'My vulnerability', project: project, findings: [finding]) }
