...
RSpec.describe 'Initialize Product Analytics', feature_category: :product_analytics do
  ...
  it 'requires update_product_analytics_settings permission' do
    expect(Mutations::Projects::InitializeProductAnalytics)
      .to require_graphql_authorizations(:update_product_analytics_settings)
  end
