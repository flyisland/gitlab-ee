...
RSpec.describe 'Custom field filters', feature_category: :team_planning do
  ...
  let_it_be(:work_item_a, freeze: false) { create(:work_item, project: project, labels: [group_label]) }
  ...
  context 'with legacy epics' do
    let_it_be(:work_item_a, freeze: false) { create(:epic, group: group, labels: [group_label]) }
