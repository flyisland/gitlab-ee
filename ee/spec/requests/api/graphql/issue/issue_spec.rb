...
RSpec.describe 'Query.issue(id)', feature_category: :team_planning do
  ...
  let_it_be(:issue, freeze: false) { create(:issue, :confidential, project: project, epic: epic) }
  ...
  context 'when selecting `linked_work_items`' do
    ...
    let_it_be(:blocking_work_item, freeze: false) { create(:work_item, :task, project: project) }
