...
RSpec.describe 'GraphQL aiCatalogItem.versions (AiCatalogAgentVersion.mcpServers)', :with_current_organization, feature_category: :workflow_catalog do
  ...
  let_it_be(:linear_mcp_server, freeze: false) do
  ...
  let_it_be(:catalog_item, freeze: false) { create(:ai_catalog_item, project: project, public: true) }

  let_it_be(:first_agent_version, freeze: false) do
