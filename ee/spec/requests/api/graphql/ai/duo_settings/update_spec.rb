    ...
    context 'when the user has write access' do
      ...
      context 'when there are no errors' do
        ...
        context 'when updating include_recommended_allowed' do
          ...
          it 'does not update the field when the feature flag is disabled' do
            stub_feature_flags(dap_instance_network_access_controls: false)

            request

            expect(duo_settings.reload.include_recommended_allowed).to be(false)
          end
        end
        ...
        context 'when updating allow_all_unix_sockets' do
          ...
          it 'does not update the field when the feature flag is disabled' do
            ...
            expect(duo_settings.reload.allow_all_unix_sockets).to be(false)
          end
        end
        ...
        context 'when updating allow_project_extension' do
          ...
          it 'does not update the field when the feature flag is disabled' do
            ...
            expect(duo_settings.reload.allow_project_extension).to be(true)
          end
        end
