...
RSpec.describe 'Query.[group](fullPath).doraPerformanceScoreCounts', :freeze_time, feature_category: :dora_metrics do
  ...
  let_it_be(:ruby_topic, freeze: false) { create(:topic, name: "ruby", organization_id: group.organization_id) }
  let_it_be(:project_1, freeze: false) { create(:project, group: group, topics: [ruby_topic]) }
