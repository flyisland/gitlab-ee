...
RSpec.describe 'Query.work_item(id)', feature_category: :team_planning do
  ...
  let_it_be(:iteration, freeze: false) do
  ...
  context 'when the user can read the work item' do
    context 'when work item is created at the group level' do
      let_it_be(:group_work_item, freeze: false) { create(:work_item, :group_level, namespace: group) }
    ...
    context 'when querying features' do
      ...
      describe 'progress widget' do
        ...
        let_it_be(:progress, freeze: false) { create(:progress, work_item: objective) }
      ...
      context 'with verification status widget' do
        let_it_be(:work_item, freeze: false) { create(:work_item, :requirement, project: project) }
        ...
        context 'when requirements is licensed' do
          ...
          context 'when latest test report status is satisfied' do
            let_it_be(:test_report, freeze: false) do
      ...
      describe 'status widget' do
        ...
        let_it_be(:custom_status, freeze: false) { create(:work_item_custom_status) }
            ...
            context 'with current status' do
              ...
              context 'with custom status' do
                ...
                context 'when mapping exists' do
                  let_it_be(:custom_status, freeze: false) { create(:work_item_custom_status, namespace: namespace) }
                  let_it_be(:new_custom_status, freeze: false) do
      ...
      describe 'health status widget' do
        let_it_be(:work_item, freeze: false) { create(:work_item, :epic, namespace: group) }
        let_it_be(:sub_issue, freeze: false) do
          create(:work_item, :issue, :closed, project: project, health_status: :on_track)
        end

        let_it_be(:sub_issue_2, freeze: false) { create(:work_item, :issue, project: project, health_status: :at_risk) }
        let_it_be(:sub_task, freeze: false) do
      ...
      describe 'test reports widget' do
        ...
        context 'when requirements is licensed' do
          let_it_be(:test_report1, freeze: false) { create(:test_report, requirement_issue: work_item) }
          let_it_be(:test_report2, freeze: false) { create(:test_report, requirement_issue: work_item) }
      ...
      describe 'notes widget' do
        ...
        context 'when work item is associated with a group' do
          let_it_be(:group_work_item, freeze: false) { create(:work_item, :group_level, namespace: group) }
          let_it_be(:group_work_item_note, freeze: false) do
      ...
      describe 'linked items widget' do
        ...
        let_it_be(:related_item, freeze: false) { create(:work_item, project: project) }
        let_it_be(:blocked_item, freeze: false) { create(:work_item, project: project) }
        let_it_be(:blocking_item, freeze: false) { create(:work_item, project: project) }
        let_it_be(:link1, freeze: false) do
        ...
        let_it_be(:link3, freeze: false) do
      ...
      describe 'hierarchy widget' do
        let_it_be(:other_group, freeze: false) { create(:group, :private) }
        let_it_be(:other_project, freeze: false) { create(:project, group: other_group) }

        let_it_be(:ancestor3, freeze: false) { create(:work_item, :epic, namespace: group) }
        let_it_be(:private_ancestor, freeze: false) do
          create(:work_item, :epic, namespace: other_group, work_item_parent: ancestor3)
        end

        let_it_be(:ancestor2, freeze: false) do
          create(:work_item, :epic, namespace: group, work_item_parent: private_ancestor)
        end

        let_it_be(:ancestor1, freeze: false) do
          create(:work_item, :epic, namespace: group, work_item_parent: ancestor2)
        end

        let_it_be(:parent_epic, freeze: false) do
        ...
        let_it_be(:child_issue, freeze: false) { add_child(work_item, :issue, project) }
        let_it_be(:child_epic, freeze: false) { add_child(work_item, :epic, project) }
        let_it_be(:child_epic2, freeze: false) { add_child(work_item, :epic, group) }
        let_it_be(:private_child, freeze: false) { add_child(work_item, :issue, other_project) }
        ...
        context 'with N+1 queries check' do
          let_it_be(:other_group2, freeze: false) { create(:group, :private) }
          let_it_be(:other_group3, freeze: false) { create(:group, :private) }
          let_it_be(:other_project2, freeze: false) { create(:project, :private) }
        ...
        context 'when work item belongs to a user namespace project' do
          let_it_be(:user_namespace_project, freeze: false) { create(:project, namespace: developer.namespace) }
          let_it_be(:ancestor, freeze: false) { create(:work_item, :epic, project: user_namespace_project) }
          let_it_be(:work_item, freeze: false) do
      ...
      describe 'color widget' do
        ...
        let_it_be(:color, freeze: false) { create(:color, work_item: epic) }
        let_it_be(:global_id, freeze: false) { epic.to_gid.to_s }
      ...
      describe 'dates rolledup widget' do
        ...
        context 'with dates from child' do
          let_it_be(:epic, freeze: false) { create(:work_item, :epic, namespace: group) }
          let_it_be(:child_work_item, freeze: false) { create(:work_item, :issue, namespace: group) }
      ...
      describe 'development widget' do
        context 'when fetching related feature flags' do
          let_it_be(:feature_flags, freeze: false) { create_list(:operations_feature_flag, 4, project: project) }
          let(:work_item_fields) do
            <<~GRAPHQL
              id
              features {
      ...
      describe 'ai session widget' do
        let_it_be(:duo_workflow, freeze: false) do
