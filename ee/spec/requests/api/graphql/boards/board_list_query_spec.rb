...
RSpec.describe 'Querying a Board list', feature_category: :team_planning do
  ...
  let_it_be(:project, freeze: false) { create(:project, group: group, guests: guest) }
  ...
  let_it_be(:current_iteration1, freeze: false) { create(:iteration, start_date: Date.yesterday, due_date: 1.day.from_now, iterations_cadence: iteration_cadence1) }
  ...
  let_it_be(:issue1, freeze: false) { create(:issue, project: project, labels: [label], iteration: current_iteration1, health_status: :at_risk) }
