...
RSpec.describe 'Query.project(fullPath).pipelines.dastProfile',
  ...
  let_it_be(:dast_profile, freeze: false) { create(:dast_profile, project: project) }
  let_it_be(:pipeline, freeze: false) { create(:ci_pipeline, :success, project: project, dast_profile: dast_profile) }
