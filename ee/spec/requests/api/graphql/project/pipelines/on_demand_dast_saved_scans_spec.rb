...
RSpec.describe 'SavedScans GraphQL Query', feature_category: :dynamic_application_security_testing do
  ...
  let_it_be(:master_branch, freeze: false) { repository.add_branch(developer, 'master', repository.commit.sha) }
  let_it_be(:feature_branch, freeze: false) do
    repository.add_branch(developer, 'feature-branch', repository.commit.sha)
  end

  let_it_be(:dast_profile1, freeze: false) do
    create(:dast_profile,
      project: project,
      branch_name: 'master',
      name: 'Profile 1'
  ...
  let_it_be(:dast_profile2, freeze: false) do
    create(:dast_profile,
      project: project,
