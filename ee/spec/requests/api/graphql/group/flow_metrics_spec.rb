...
RSpec.describe 'getting group flow metrics', feature_category: :value_stream_management do
  ...
  let_it_be(:project2, freeze: false) { create(:project, :repository, namespace: group) }
  ...
  let_it_be(:production_environment2, freeze: false) { create(:environment, :production, project: project2) }
