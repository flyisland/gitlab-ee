...
RSpec.describe 'getting a work item list for a group', feature_category: :team_planning do
  ...
  describe 'N + 1 queries' do
    ...
    let_it_be(:sub_group_work_item, freeze: false) do
      create(
        :work_item,
        namespace: sub_group,
        author: reporter,
  ...
  context 'when querying WorkItemWidgetLinkedItems' do
    ...
    let_it_be(:work_items, freeze: false) { create_list(:work_item, 2, :issue, namespace: group) }
    let_it_be(:related_items, freeze: false) { create_list(:work_item, 3, namespace: private_group) }
    let_it_be(:blocked_items, freeze: false) { create_list(:work_item, 3, namespace: private_group) }
    let_it_be(:blocking_items, freeze: false) { create_list(:work_item, 3, namespace: private_group) }
