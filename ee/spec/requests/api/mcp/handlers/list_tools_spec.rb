    ...
    it 'returns tools' do
      ...
      expect(json_response['result']['tools']).to contain_exactly(
        ...
        },
        {
          ...
          "description" => "List the work item types available in a namespace (group or project), " \
        ...
        },
        {
          ...
          "inputSchema" => {
            ...
            "properties" => {
              ...
              "knn" => { "type" => "integer", "description" => "Number of nearest neighbours to retrieve internally (default: 64). Higher values improve recall at the cost of latency." },
