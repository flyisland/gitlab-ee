...
RSpec.describe API::Mcp::Base, feature_category: :mcp_server do
  ...
  describe 'POST /mcp' do
    ...
    context 'when gitlab.com and mcp_server_availability_setting flag is on', :saas do
      let_it_be(:group) { create(:group_with_plan, plan: :ultimate_plan, developers: user) }
    ...
    context 'when not gitlab.com and mcp_server_availability_setting flag is on' do
