...
RSpec.describe API::MergeTrains, feature_category: :continuous_integration do
  ...
  let_it_be_with_reload(:project) do
    create(:project, :repository, developers: developer, guests: guest, maintainers: maintainer, reporters: reporter)
  end

  let_it_be(:other_project) { create(:project, :repository, developers: developer) }
  ...
  describe 'GET /projects/:id/merge_trains/:target_branch' do
    let_it_be(:train_car_1) { create(:merge_train_car, :idle, target_project: project, target_branch: 'master') }
    let_it_be(:train_car_2) { create(:merge_train_car, :merged, target_project: project, target_branch: 'master') }
    let_it_be(:train_car_3) { create(:merge_train_car, target_project: project, target_branch: 'feature') }
    let_it_be(:train_car_4) { create(:merge_train_car, target_project: other_project, target_branch: 'master') }
  ...
  describe 'GET /projects/:id/merge_trains/merge_requests/:merge_request_iid' do
    ...
    let_it_be(:train_car_1) { create(:merge_train_car, merge_request: merge_request_1) }
