...
RSpec.describe API::Wikis, feature_category: :wiki do
  ...
  describe 'GET /groups/:id/wikis' do
    ...
    it_behaves_like 'authorizing granular token permissions', :read_wiki do
      let_it_be(:user) { create(:user) }
      let_it_be_with_reload(:group) { create(:group, :internal, :wiki_repo, developers: [user]) }
  ...
  describe 'PUT /group/:id/wikis/:slug' do
    ...
    context 'when user is owner of parent group' do
      ...
      let_it_be(:group, freeze: false) { create(:group, :wiki_repo, parent: namespace) }
  ...
  describe 'DELETE /groups/:id/wikis/:slug' do
    ...
    it_behaves_like 'authorizing granular token permissions', :delete_wiki do
      let_it_be(:user) { create(:user) }
      let_it_be_with_reload(:group) { create(:group, :internal, :wiki_repo, maintainers: [user]) }
      let(:boundary_object) { group }
