...
RSpec.describe API::Ldap, feature_category: :system_access do
  include ApiHelpers
  include LdapHelpers
  ...
  describe "GET /ldap/groups" do
    it_behaves_like 'authorizing granular token permissions', :read_ldap_group do
      let(:boundary_object) { :instance }
      let(:user) { admin }
      let(:request) { get api('/ldap/groups', personal_access_token: pat) }
    end
  ...
  describe "GET /ldap/ldapmain/groups" do
    it_behaves_like 'authorizing granular token permissions', :read_ldap_group do
      let(:boundary_object) { :instance }
      let(:user) { admin }
      let(:request) { get api('/ldap/ldapmain/groups', personal_access_token: pat) }
    end
