...
RSpec.describe API::Ai::DuoWorkflows::AgentWorkflows, feature_category: :duo_agent_platform do
  ...
  let_it_be(:auth_response, freeze: false) { Ai::UserAuthorizable::Response.new(allowed?: true, namespace_ids: [group.id]) }
  let_it_be(:service_account, freeze: false) { create(:user, :service_account, composite_identity_enforced: true) }
  ...
  describe 'POST /ai/duo_workflows/agent_workflows' do
    ...
    context 'with a catalog workflow' do
      ...
      let_it_be(:consumer, freeze: false) do
    ...
    context 'when service account is resolved' do
      ...
      let_it_be(:foundational_flow_service_account, freeze: false) do
