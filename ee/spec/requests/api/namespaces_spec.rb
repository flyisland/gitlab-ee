...
RSpec.describe API::Namespaces, :aggregate_failures, feature_category: :groups_and_projects do
  ...
  let_it_be(:group2, freeze: false) { create(:group, :nested) }
  let_it_be(:ultimate_plan, freeze: false) { create(:ultimate_plan) }
  let_it_be(:project, freeze: false) { create(:project, namespace: group2) }
  let_it_be(:project, freeze: false) { create(:project, namespace: group2, name: group2.name, path: group2.path) }
  ...
  describe 'GET :id/gitlab_subscription', :saas do
    ...
    let_it_be(:premium_plan, freeze: false) { create(:premium_plan) }
    ...
    let_it_be(:auditor, freeze: false) { create(:auditor) }
    let_it_be(:namespace, freeze: false) { create(:group) }
    let_it_be(:gitlab_subscription, freeze: false) { create(:gitlab_subscription, hosted_plan: premium_plan, namespace: namespace) }
    ...
    context 'for groups inherits exclude_guests' do
      let_it_be(:ultimate_namespace, freeze: false) { create(:group) }
      let_it_be(:gitlab_subscription, freeze: false) { create(:gitlab_subscription, hosted_plan: ultimate_plan, namespace: ultimate_namespace) }
    ...
    context 'when namespaces_storage_limit saas feature is available' do
      ...
      context 'when authenticated as an admin' do
        context 'when an exclusion exists' do
          let_it_be(:exclusion, freeze: false) { create(:namespace_storage_limit_exclusion, namespace: namespace) }
