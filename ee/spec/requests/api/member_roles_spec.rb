...
RSpec.describe API::MemberRoles, :api, feature_category: :system_access do
  ...
  let_it_be(:group_with_member_roles, freeze: false) { create(:group, owners: owner) }
  let_it_be(:group_with_no_member_roles, freeze: false) { create(:group, owners: owner) }

  let_it_be(:member_role_1, freeze: false) do
    create(:member_role, :read_dependency, namespace: group_with_member_roles)
  end

  let_it_be(:member_role_2, freeze: false) { create(:member_role, :read_code, namespace: group_with_member_roles) }

  let_it_be(:instance_member_role, freeze: false) { create(:member_role, :read_code, :instance) }
