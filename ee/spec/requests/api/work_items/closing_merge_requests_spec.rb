...
RSpec.describe API::WorkItems::ClosingMergeRequests, feature_category: :portfolio_management do
  ...
  describe 'GET /groups/:id/-/work_items/:work_item_iid/closing_merge_requests' do
    let(:api_request_path) { "/groups/#{group.id}/-/work_items/#{work_item.iid}/closing_merge_requests" }
