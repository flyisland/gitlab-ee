...
RSpec.describe API::LdapGroupLinks, :api, feature_category: :system_access do
  ...
  let_it_be(:group_with_ldap_links, freeze: false) { create(:group) }
  let_it_be(:group_with_no_ldap_links, freeze: false) { create(:group) }

  let_it_be(:member_role, freeze: false) { create(:member_role, :guest, namespace: group_with_ldap_links) }
