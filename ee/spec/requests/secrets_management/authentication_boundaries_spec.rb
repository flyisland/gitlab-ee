  ...
  describe 'JWT Authentication Scenarios' do
    context 'with project-level authentication' do
      ...
      where(:jwt_type, :jwt_scope, :auth_mount, :expected_result, :errror_message) do
        ...
        # ---------+----------------------------------+------------+-----------------|-----------------------------------------------------------------------------------------------
        # CEL Pipeline Authentication (project_secrets_cel_pipeline_auth enabled)
        :pipeline  | :same_project                    | :cel_pipeline | :success     | nil
        :pipeline  | :same_project                    | :user         | :rejected    | 'blocked authorization with message: invalid subject for user authentication'
        :pipeline  | :project_in_same_namespace       | :cel_pipeline | :rejected    | 'blocked authorization with message: token project_id does not match project'
        :pipeline  | :project_in_different_namespace  | :cel_pipeline | :rejected    | 'blocked authorization with message: token project_id does not match project'
        :pipeline  | :forked_project                  | :cel_pipeline | :rejected    | 'blocked authorization with message: token project_id does not match project'
        :pipeline  | :forked_project_with_pipeline_running_in_parent_project | :cel_pipeline | :rejected | 'blocked authorization with message: token project_id does not match project'
    ...
    context 'with cross-type authentication (project vs group isolation)' do
      ...
      where(:jwt_type, :jwt_scope, :auth_mount, :expected_result, :errror_message) do
        ...
        :group_pipeline   | :project_in_own_group | :cel_pipeline   | :rejected       | 'blocked authorization with message: token project_id does not match project'
