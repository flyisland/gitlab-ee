...
RSpec.describe Admin::DataManagementController, :enable_admin_mode, feature_category: :geo_replication do
  ...
  describe 'before_actions' do
    ...
    let_it_be(:model, freeze: false) { create(:project) }
    let_it_be(:model_name, freeze: false) { Gitlab::Geo::ModelMapper.convert_to_name(model.class).pluralize }
    let_it_be(:id, freeze: false) { model.id }
  ...
  context 'when model is valid' do
    let_it_be(:default_model, freeze: false) { Project }
