...
RSpec.describe JwtController, feature_category: :system_access do
  ...
  context 'with IP restriction' do
    ...
    let_it_be(:group_deploy_token, freeze: false) { create(:deploy_token, :group, groups: [group], read_registry: true, write_registry: true) }
    let_it_be(:project_deploy_token, freeze: false) { create(:deploy_token, projects: [project], read_registry: true, write_registry: true) }
