...
RSpec.describe Search::Admin::VectorStorageController, :enable_admin_mode, feature_category: :global_search do
  ...
  describe 'POST #use_advanced_search_cluster_for_semantic_search' do
    ...
    it 'connects to advanced search cluster and redirects with a notice' do
    ...
    context 'when a ConnectionError is raised' do
      ...
      it 'sets an alert flash and redirects to the vector storage page' do
        send_request
  ...
  describe 'POST #connect_custom_vector_storage' do
    ...
    subject(:send_request) do
      post admin_search_vector_storage_connect_custom_vector_storage_path,
    ...
    context 'when a ConnectionError is raised' do
      ...
      it 'sets an alert flash and re-renders the show page' do
        send_request
    ...
    context 'when an ActiveRecord::RecordInvalid error is raised' do
      ...
      it 'sets an alert flash with the full error message and re-renders the show page' do
        post admin_search_vector_storage_connect_custom_vector_storage_path, params: { url: '' }
  ...
  describe 'POST #disable_semantic_search' do
    ...
    it 'disables semantic search and redirects with a notice' do
