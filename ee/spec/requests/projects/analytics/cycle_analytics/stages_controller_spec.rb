...
RSpec.describe Projects::Analytics::CycleAnalytics::StagesController, feature_category: :value_stream_management do
  ...
  let_it_be(:project) { create(:project, namespace: group, reporters: user) }
  let_it_be_with_reload(:namespace) { project.project_namespace }
  ...
  let_it_be_with_reload(:value_stream) do
    create(
