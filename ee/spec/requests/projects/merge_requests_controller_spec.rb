...
RSpec.describe Projects::MergeRequestsController, feature_category: :code_review_workflow do
  ...
  describe 'GET #license_scanning_reports_collapsed', feature_category: :code_review_workflow do
    ...
    let_it_be(:merge_request, freeze: false) { create(:ee_merge_request, :with_cyclonedx_reports, source_project: project) }
  ...
  describe 'GET #reports' do
    subject(:send_request) { get reports_project_merge_request_path(project, merge_request) }
