...
RSpec.describe SessionsController, :with_organization_url_helpers, feature_category: :system_access do
  ...
  describe '#new' do
    it 'pushes redirectSignInWhenLoginNotFound SaaS feature to the frontend', :saas do
      get new_user_session_path

      expect(response.body).to have_pushed_saas_features(redirectSignInWhenLoginNotFound: true)
    end
  end
