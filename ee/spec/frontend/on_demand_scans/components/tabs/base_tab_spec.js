...
describe('BaseTab', () => {
  ...
  const findPagination = () => wrapper.findComponentByTestId('pagination');
  ...
  describe('when the app loads', () => {
    ...
    it('controls the pipelines query with a visibility check', async () => {
      jest.spyOn(sharedGraphQLUtils, 'setupQueryPollingByVisibility');
      await createComponent();

      expect(sharedGraphQLUtils.setupQueryPollingByVisibility).toHaveBeenCalledWith(
