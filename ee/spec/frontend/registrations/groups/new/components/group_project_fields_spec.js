...
// eslint-disable-next-line no-restricted-syntax -- test mocks viewport breakpoints; component is not rendered within a panel
...
describe('GroupProjectFields', () => {
  ...
  const findInputByTestId = (testId) => wrapper.findComponentByTestId(testId);
