...
import { openbaoHealthResponse, secretManagerStatusResponse } from '../mock_data';
...
describe('SecretsApp', () => {
  ...
  describe('Paid experience', () => {
    describe('when isEligibleForTrial is true', () => {
      it('skips the secretManagerStatus query', async () => {
        await createComponent({
          stubs: { RouterView: true },
          provide: { isEligibleForTrial: true },
        });
