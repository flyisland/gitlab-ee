...
describe('NewReleasePanel', () => {
  ...
  const findNameField = () => wrapper.findByTestId('name-field');
  const findNameInput = () => wrapper.findAllComponents(GlFormInput).at(0);
  const findDescriptionField = () => wrapper.findByTestId('description-field');
  const findDescriptionInput = () => wrapper.findAllComponents(GlFormInput).at(1);
  const findServicesSelector = () => wrapper.findComponent(ServicesSelector);
  const findServicesField = () => wrapper.findByTestId('services-field');
  ...
  describe('when rendered', () => {
    ...
    it('clears the form fields when closed', async () => {
    ...
    describe('create release', () => {
      ...
      describe('when a valid name is submitted', () => {
        ...
        it('creates the version set with the name and selected version ids', () => {
