...
describe('NamespaceLimitsApp', () => {
  ...
  const findNotificationsLimitSection = () =>
    wrapper.findComponentByTestId('notifications-limit-section');
  const findEnforcementLimitSection = () =>
    wrapper.findComponentByTestId('enforcement-limit-section');
  const findDashboardLimitSection = () => wrapper.findComponentByTestId('dashboard-limit-section');
