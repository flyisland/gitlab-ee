...
describe('DateRangeButtons component', () => {
  ...
  const findOneWeekAgoButton = () => wrapper.findComponentByTestId('date_range_button_last_7_days');
  const findTwoWeeksAgoButton = () =>
    wrapper.findComponentByTestId('date_range_button_last_14_days');
  const findThisMonthButton = () => wrapper.findComponentByTestId('date_range_button_last_30_days');
