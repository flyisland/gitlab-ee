...
describe('DevopsAdoptionDeleteModal', () => {
  ...
  `('$state the modal', ({ action, expected }) => {
    ...
    it(`emits track-modal-open-state as ${expected}`, () => {
      expect(wrapper.emitted('track-modal-open-state')).toStrictEqual([[expected]]);
    });
  });
  ...
  describe('submitting the form', () => {
    ...
    describe('successful submission', () => {
      ...
      it('emits enabled-namespaces-removed with the correct variables', () => {
