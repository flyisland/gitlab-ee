            ...
            describe('when an item on the chart is clicked', () => {
              beforeEach(() => {
                ...
                findMainMetricChart()
                  ...
                  .vm.$emit('chart-item-clicked', data);
              });
              ...
              describe('when chart finished loading', () => {
                describe('and the chart has data', () => {
                  ...
                  describe('when the user changes the metric', () => {
                    beforeEach(() => {
                      jest.spyOn(mockStore, 'dispatch');
                      findTimeBasedMetricChart().vm.$emit('metric-type-change', 'time_to_merge');
                    });

                    it('should call setMetricType  when `metric-type-change` is emitted on the metric chart', () => {
              ...
              describe('when chart finished loading', () => {
                describe('and the chart has data', () => {
                  ...
                  describe('when the user changes the metric', () => {
                    beforeEach(async () => {
                      jest.spyOn(mockStore, 'dispatch');
                      findCommitBasedMetricChart().vm.$emit('metric-type-change', 'loc_per_commit');
                      await nextTick();
                    });
              ...
              describe('when chart finished loading', () => {
                describe('and the chart has data', () => {
                  ...
                  describe('when the user changes the metric', () => {
                    beforeEach(async () => {
                      jest.spyOn(mockStore, 'dispatch');
                      findScatterplotMetricChart().vm.$emit('metric-type-change', 'loc_per_commit');
                      await nextTick();
                    });
              ...
              describe('when table finished loading', () => {
                describe('and the table has data', () => {
                  ...
                  it('should change the column metric', () => {
                    findMrTable().vm.$emit('column-metric-change', 'time_to_first_comment');
                  ...
                  it('should change the page', () => {
                    const page = 2;
                    findMrTable().vm.$emit('page-change', page);
