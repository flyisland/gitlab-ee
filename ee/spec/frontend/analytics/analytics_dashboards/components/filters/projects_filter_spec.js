...
import Vue from 'vue';
import GetDefaultProjectsQuery from 'ee/analytics/analytics_dashboards/components/filters/get_default_projects.query.graphql';
...
describe('ProjectsFilter', () => {
  ...
  describe('onProjectsSelected', () => {
    ...
    it('emits projectSelected event with empty list when no project is selected (e.g. selection cleared)', () => {
