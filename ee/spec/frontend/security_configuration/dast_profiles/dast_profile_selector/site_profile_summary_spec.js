...
describe('DastSiteProfileSummary', () => {
  ...
  const findAdditionalVariables = () =>
    wrapper
      .findAllComponentsByTestId('additional-variable-summary-cell')
      .wrappers.map((variableCell) => ({
  ...
  const findValidateButton = () => wrapper.findComponentByTestId('validation-button');
