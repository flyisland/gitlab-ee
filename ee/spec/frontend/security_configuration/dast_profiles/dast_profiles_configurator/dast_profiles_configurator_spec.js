...
describe('DastProfilesConfigurator', () => {
  ...
  const findEditBtn = () => wrapper.findComponentByTestId('profile-edit-btn');
  const findNewScanButton = () => wrapper.findComponentByTestId('new-profile-button');
  const findOpenDrawerButton = () => wrapper.findComponentByTestId('select-profile-action-btn');
