...
describe('DastProfilesDrawer', () => {
  ...
  const findModal = () => wrapper.findComponentByTestId('dast-profile-form-cancel-modal');
  const findEditButton = () => wrapper.findComponentByTestId('profile-edit-btn');
  ...
  const findEmptyNewScanButton = () => wrapper.findComponentByTestId('new-empty-profile-button');
  const findNewDastScannerProfileForm = () => wrapper.findByTestId('dast-scanner-parent-group');
  const findCancelButton = () => wrapper.findComponentByTestId('dast-profile-form-cancel-button');
