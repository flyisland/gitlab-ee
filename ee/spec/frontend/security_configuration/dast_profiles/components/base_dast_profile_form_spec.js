...
describe('BaseDastProfileForm', () => {
  ...
  const findCancelModal = () => wrapper.findComponentByTestId('dast-profile-form-cancel-modal');
  const findCancelButton = () => wrapper.findComponentByTestId('dast-profile-form-cancel-button');
  const findSubmitButton = () => wrapper.findComponentByTestId('dast-profile-form-submit-button');
