...
describe('GroupScannersOverview', () => {
  ...
  describe('managing profiles', () => {
    describe('when the customSecretDetectionProfilesUi feature flag is disabled', () => {
      beforeEach(async () => {
        createComponent();
    ...
    describe('when the customSecretDetectionProfilesUi feature flag is enabled', () => {
      beforeEach(async () => {
        createComponent({ glFeatures: { customSecretDetectionProfilesUi: true } });
      ...
      describe('with a scanner other than secret detection', () => {
        beforeEach(async () => {
          createComponent({
            ...
            glFeatures: { customSecretDetectionProfilesUi: true },
          });
