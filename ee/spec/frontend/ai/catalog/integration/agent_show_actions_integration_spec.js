...
const agentRefetchHandler = () =>
  jest.fn().mockResolvedValue({
    data: { aiCatalogItem: { ...mockAgent, isEnabledInManagedByProject: false } },
  });
...
describe('Agent — show page actions integration', () => {
  ...
  describe('Enable', () => {
    ...
    it('with the filter feature flag on, does not let the user select a project where the agent is already enabled', async () => {
