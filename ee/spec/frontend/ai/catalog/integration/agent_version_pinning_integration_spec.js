...
describe('Agent — version pinning integration', () => {
  ...
  describe('Edit page', () => {
    const mountEdit = ({ versionProp, agent } = {}) => {
      ...
      return createIntegrationWrapper(AiCatalogAgentsEdit, {
  ...
  describe('Duplicate page', () => {
    const mountDuplicate = ({ provide, agent } = {}) => {
      ...
      return createIntegrationWrapper(AiCatalogAgentsDuplicate, {
        provide,
        props: { aiCatalogAgent: defaultAgent },
        apolloHandlers: [],
  ...
  describe('Version alert + mutation', () => {
    ...
    it('successful update resets to pinned view and shows toast', async () => {
      ...
      apolloProvider.clients.defaultClient.watchQuery({ query: aiCatalogAgentQuery }).subscribe();
