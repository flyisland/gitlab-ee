...
describe('Flow — version pinning integration', () => {
  ...
  describe('Edit page', () => {
    const mountEdit = ({ versionProp, flow } = {}) => {
      ...
      return createIntegrationWrapper(AiCatalogFlowsEdit, {
  ...
  describe('Duplicate page', () => {
    const mountDuplicate = ({ provide, flow } = {}) => {
      ...
      return createIntegrationWrapper(AiCatalogFlowsDuplicate, {
        provide,
        props: { aiCatalogFlow: defaultFlow },
        apolloHandlers: [],
  ...
  describe('Version alert + mutation', () => {
    ...
    it('successful update resets to pinned view and shows toast', async () => {
      ...
      apolloProvider.clients.defaultClient.watchQuery({ query: aiCatalogFlowQuery }).subscribe();
