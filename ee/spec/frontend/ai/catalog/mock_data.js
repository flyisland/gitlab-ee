...
export const mockGroupProjectsResponse = {
  data: {
    group: {
      id: 'gid://gitlab/Group/1',
      projects: {
...
export const mockEmptyGroupProjectsResponse = {
  data: {
    group: {
...
export const mockAgentsWithConfig = [
  mockAgentFactory({
    ...
    configurationForGroup: {
      ...
      enabled: true,
      pinnedItemVersion: mockAgentVersionFactory({
        id: 'gid://gitlab/Ai::Catalog::ItemVersion/7',
      }),
      __typename: TYPENAME_AI_CATALOG_ITEM_CONSUMER,
    },
  }),
  mockAgentFactory({
    ...
    configurationForGroup: {
      ...
      enabled: true,
      pinnedItemVersion: mockAgentVersionFactory({
        id: 'gid://gitlab/Ai::Catalog::ItemVersion/8',
      }),
      __typename: TYPENAME_AI_CATALOG_ITEM_CONSUMER,
    },
  }),
  mockAgentFactory({
    ...
    configurationForGroup: {
      ...
      enabled: true,
      pinnedItemVersion: mockAgentVersionFactory({
        id: 'gid://gitlab/Ai::Catalog::ItemVersion/9',
      }),
      __typename: TYPENAME_AI_CATALOG_ITEM_CONSUMER,
    },
  }),
...
export const mockBaseConfigs = {
  ...
  configurationForGroup: {
    ...
    enabled: true,
    pinnedItemVersion: mockFlowVersionFactory({
      id: 'gid://gitlab/Ai::Catalog::ItemVersion/31',
    }),
    __typename: TYPENAME_AI_CATALOG_ITEM_CONSUMER,
  },
};
...
export const mockGroupUserPermissionsNotAdminResponse = {
  data: {
    group: {
      id: 'gid://gitlab/Group/2000',
      userPermissions: {
