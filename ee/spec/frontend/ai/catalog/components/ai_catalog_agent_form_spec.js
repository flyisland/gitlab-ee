      ...
      describe('MCP tools', () => {
        ...
        describe('deduplication, icons, and tint', () => {
          ...
          it('drops the DAP duplicate in favor of MCP when duoAgenticChatPreferMcpTools is on', async () => {
            ...
            createWrapper({
              provide: {
                glFeatures: { mcpCatalogAgentTools: true, duoAgenticChatPreferMcpTools: true },
              },
            });
            await waitForPromises();
          ...
          it('tints selected enabled MCP tokens with the amber style', async () => {
            createWrapper({
            ...
            expect(mcpToken.style).toMatchObject({
              borderColor: 'var(--gl-color-orange-300)',
              backgroundColor: 'var(--gl-color-orange-50)',
            });
          });
        });
      });
