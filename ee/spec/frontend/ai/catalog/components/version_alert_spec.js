...
describe('VersionAlert', () => {
  ...
  describe.each([
    ...
    'when in the $namespace namespace',
    ({ namespace, isProjectNamespace, isGroupNamespace, versionKey }) => {
      describe.each([
            ...
            describe('when the user updates to the latest version', () => {
              ...
              describe('when the request succeeds', () => {
                ...
                it(`resets the active version key to ${namespace === 'project' ? 'VERSION_PINNED' : 'VERSION_PINNED_GROUP'} for the next update`, () => {
                  expect(mockVersionWithUpdate.setActiveVersionKey).toHaveBeenCalledWith(
                    versionKey,
                  );
                });
              });
