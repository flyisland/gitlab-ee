...
describe('AiCatalogFlowsShow', () => {
  ...
  describe('when the flow is configured and has a new version available', () => {
    ...
    it('shows error alert when version-alert emits an error', async () => {
      findVersionAlert().vm.$emit('error', {
        title: 'Could not update flow.',
        errors: ['You do not have permission.'],
      });
      await Vue.nextTick();

      expect(findErrorsAlert().props('title')).toBe('Could not update flow.');
  ...
  describe('Page Heading', () => {
    ...
    describe('experiment badge', () => {
      it('renders experiment badge for non-foundational flows', () => {
        createComponent({
          props: {
            aiCatalogFlow: {
              ...mockFlow,
      ...
      it('does not render experiment badge for foundational flows', () => {
        createComponent({
          props: {
            aiCatalogFlow: {
              ...mockFlow,
  ...
  describe('on adding flow to project', () => {
    ...
    it('calls create consumer mutation without parentItemConsumerId', () => {
      addFlowToProject();
  ...
  describe('on adding flow to group', () => {
    ...
    beforeEach(() => {
      ...
      createComponent({ props: { aiCatalogFlow: mockFlow }, provide: { isGlobalNamespace: true } });
    });
