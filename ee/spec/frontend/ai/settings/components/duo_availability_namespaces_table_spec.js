...
describe('DuoAvailabilityNamespacesTable', () => {
  ...
  const findListbox = (id) =>
    wrapper.findByTestId(`duo-availability-namespaces-table-row-listbox-${id}`);
  ...
  const findResetButton = () =>
    wrapper.findByTestId('duo-availability-namespaces-table-row-remove-override');
  const findPagination = () => wrapper.findComponent(GlKeysetPagination);
  const findResetModal = () => wrapper.findByTestId('duo-availability-namespaces-reset-modal');
  const findCascadeModal = () => wrapper.findByTestId('duo-availability-namespaces-cascade-modal');
