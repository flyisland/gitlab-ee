...
describe('AiCommonSettingsForm', () => {
    ...
    wrapper = shallowMountExtended(AiCommonSettingsForm, {
      ...
      provide: {
        ...
        glFeatures: {
          ...
          adminDuoAvailabilityNamespaceOverrides: false,
          ...(provide.glFeatures || {}),
        },
      },
    });
  ...
  describe('Duo Availability Namespaces visibility', () => {
    describe('when admin_duo_availability_namespace_overrides feature flag is disabled', () => {
      beforeEach(() => {
        createComponent({
          provide: { glFeatures: { adminDuoAvailabilityNamespaceOverrides: false } },
        });
      });

      it('does not render the DuoAvailabilityNamespaces component', () => {
        expect(findDuoAvailabilityNamespaces().exists()).toBe(false);
      });
    });

    describe('when admin_duo_availability_namespace_overrides feature flag is enabled', () => {
      beforeEach(() => {
        createComponent({
          provide: { glFeatures: { adminDuoAvailabilityNamespaceOverrides: true } },
        });
      });
