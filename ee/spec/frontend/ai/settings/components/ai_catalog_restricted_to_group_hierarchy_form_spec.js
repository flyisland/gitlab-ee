...
describe('AiCatalogRestrictedToGroupHierarchyForm', () => {
  ...
  it('renders the help text', () => {
    expect(findCheckbox().text()).toContain(
      'In the AI Catalog, only show agents and flows created or owned by projects in this group hierarchy, or foundational agents and flows. Agents and flows from outside this group hierarchy are hidden, and cannot be enabled or used.',
    );
  });
