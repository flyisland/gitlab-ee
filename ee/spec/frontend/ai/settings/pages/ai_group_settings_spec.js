...
describe('AiGroupSettings', () => {
  describe('UI', () => {
    ...
    it('renders the AiCatalogRestrictedToGroupHierarchyForm', () => {
      createComponent();

      expect(findAiCatalogRestrictedToGroupHierarchyForm().exists()).toBe(true);
    });
  ...
  describe('NetworkAccessSettings', () => {
    describe('when dapGroupNetworkAccessControls feature flag is disabled', () => {
      it('does not render NetworkAccessSettings', () => {
        createComponent({
          provide: { glFeatures: { dapGroupNetworkAccessControls: false } },
        });
    ...
    describe('when dapGroupNetworkAccessControls feature flag is enabled', () => {
      beforeEach(() => {
        createComponent({
          provide: { glFeatures: { dapGroupNetworkAccessControls: true } },
        });
      });
