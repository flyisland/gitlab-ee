...
describe('AiGroupSettings', () => {
  ...
  describe('updateSettings', () => {
    ...
    describe('when agentArtifactsPage feature flag is disabled', () => {
      it('does not include namespace_settings_attributes in the API call', async () => {
        createComponent({
        ...
        expect(updateGroupSettings).toHaveBeenCalledWith(
          ...
          expect.not.objectContaining({
            namespace_settings_attributes: expect.anything(),
          }),
        );
      });
    });
    ...
    describe('when agentArtifactsPage feature flag is enabled', () => {
      it('includes namespace_settings_attributes with ai_audit_events_storage_enabled in the API call', async () => {
        createComponent({
          provide: { glFeatures: { agentArtifactsPage: true } },
        });
