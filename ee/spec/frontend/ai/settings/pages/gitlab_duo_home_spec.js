...
describe('GitLab Duo Home', () => {
  ...
  const findDuoAgentSettings = () => wrapper.findComponent(DuoAgentSettings);
  ...
  describe('when SaaS', () => {
    ...
    describe('when its the group settings Duo page', () => {
      ...
      it('does not render DuoAgentSettings', () => {
        expect(findDuoAgentSettings().exists()).toBe(false);
      });
  ...
  describe('when self-managed', () => {
    describe('when admin instance Duo page', () => {
      ...
      it('renders DuoAgentSettings', () => {
        expect(findDuoAgentSettings().exists()).toBe(true);
      });
