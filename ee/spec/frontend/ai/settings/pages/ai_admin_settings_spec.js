...
describe('AiAdminSettings', () => {
  ...
  describe('canManageSelfHostedModels', () => {
    ...
    describe('NetworkAccessSettings', () => {
      describe('when dapInstanceNetworkAccessControls feature flag is disabled', () => {
        it('does not render NetworkAccessSettings', () => {
          createComponent({
            provide: { glFeatures: { dapInstanceNetworkAccessControls: false } },
          });

          expect(findNetworkAccessSettings().exists()).toBe(false);
        });
      });

      describe('when dapInstanceNetworkAccessControls feature flag is enabled', () => {
        it('renders NetworkAccessSettings', () => {
          createComponent({
            provide: { glFeatures: { dapInstanceNetworkAccessControls: true } },
          });
