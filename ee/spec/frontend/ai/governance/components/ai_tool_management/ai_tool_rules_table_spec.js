...
describe('AiToolRulesTable', () => {
  ...
  describe('project-scoped mode', () => {
    ...
    const mockFloorRules = {
      nodes: [
        { ...mockToolRules.nodes[0], webAccess: 'ALLOW', localAccess: null },
        { ...mockToolRules.nodes[1], webAccess: 'ASK', localAccess: 'ASK' },
      ],
      pageInfo: mockPageInfo,
      __typename: 'AiToolRuleConnection',
    };
    ...
    const findWebControls = () => wrapper.findAllByTestId('tool-web-access-control');
