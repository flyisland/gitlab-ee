...
describe('TanukiBot Store Actions', () => {
  ...
  describe('setMessages', () => {
    it('should commit messages directly without emitting tool events', () => {
      return testAction({
        ...
        expectedMutations: [
          ...
          {
            type: types.ADD_MESSAGE,
            payload: expect.objectContaining({ content: MOCK_USER_MESSAGE.content }),
          },
          {
            type: types.ADD_MESSAGE,
            payload: expect.objectContaining({ content: MOCK_TANUKI_MESSAGE.content }),
          },
        ],
      });
    });
