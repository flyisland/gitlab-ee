  ...
  describe('when component is mounted', () => {
    ...
    describe('with latestCheckpoint messages', () => {
      ...
      describe('item title display', () => {
        it('displays the custom title when item has a title', () => {
          formatAgentFlowTitle.mockReturnValue('My custom title');
          createWrapper({ item: { ...mockItem, title: 'My custom title' } });
          expect(findItemTitle().text()).toContain('My custom title');
        });

        it('falls back to workflow definition when item has no title', () => {
        ...
        it('does not include project name by default', () => {
          expect(findItemTitle().text()).not.toContain('Test Project');
        });

        it('includes project name when showProjectInfo is true', () => {
          createWrapper({ showProjectInfo: true });
          expect(findItemTitle().text()).toContain('Test Project / Custom generated title');
        });
      });
