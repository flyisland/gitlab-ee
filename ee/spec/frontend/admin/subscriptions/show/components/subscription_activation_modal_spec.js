...
describe('SubscriptionActivationModal', () => {
  ...
  const findInfoAlert = () => wrapper.findComponent(GlAlert);
  ...
  describe('idle state', () => {
    ...
    it('shows the replacement info alert', () => {
      expect(findInfoAlert().exists()).toBe(true);
      expect(findInfoAlert().props('variant')).toBe('info');
      expect(findInfoAlert().props('dismissible')).toBe(false);
      expect(findInfoAlert().text()).toContain(
        'If your new subscription is not future-dated, it immediately replaces your current one.',
      );
    });
  ...
  describe('subscription activation', () => {
    ...
    describe('failing activation', () => {
      ...
      it('hides the replacement info alert', () => {
