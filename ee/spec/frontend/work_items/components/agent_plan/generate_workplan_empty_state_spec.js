...
import GenerateWorkplanEmptyState from 'ee/work_items/components/agent_plan/generate_workplan_empty_state.vue';
import DuoChatQuickAction from 'ee/ai/shared/widgets/duo_chat_quick_action.vue';
import { buildWorkPlanChatCommand } from 'ee/work_items/components/agent_plan/constants';
...
describe('GenerateWorkplanEmptyState', () => {
  ...
  const findGenerateAction = () => wrapper.findByTestId('generate-workplan-button');
