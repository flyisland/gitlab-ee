...
describe('CreateEditWorkItemTypeForm', () => {
  ...
  const findEnabledCheckbox = () => wrapper.findByTestId('work-item-type-enabled-checkbox');
  ...
  describe('enabled checkbox', () => {
    ...
    it('is checked when workItemType.enabled is true', () => {
    ...
    it('is unchecked when workItemType.enabled is false', () => {
