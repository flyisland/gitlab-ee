...
describe('WorkItemTypesList', () => {
  ...
  const findLimitBadge = () => wrapper.findByTestId('active-types-limit-badge');
  ...
  const findEnableForAllProjectsAction = (id) =>
    wrapper.findByTestId(`enable-for-all-projects-action-${id}`);
  const findDisableForAllProjectsAction = (id) =>
    wrapper.findByTestId(`disable-for-all-projects-action-${id}`);
