...
RSpec.describe 'DAST profiles (GraphQL fixtures)', feature_category: :dynamic_application_security_testing do
  describe GraphQL::Query, type: :request do
    ...
    describe 'dast_site_profiles' do
      ...
      let_it_be(:dast_site_validation_pending, freeze: false) do
        create(
      ...
      let_it_be(:dast_site_validation_inprogress, freeze: false) do
        create(
          :dast_site_validation,
          state: :inprogress,
          dast_site_token: create(
      ...
      let_it_be(:dast_site_validation_passed, freeze: false) do
        create(
          :dast_site_validation,
          state: :passed,
          dast_site_token: create(
      ...
      let_it_be(:dast_site_validation_failed, freeze: false) do
        create(
          :dast_site_validation,
          state: :failed,
          dast_site_token: create(
      ...
      # DAST sites
      let_it_be(:dast_site_pending, freeze: false) do
        create(
          :dast_site,
          project: project,
      ...
      let_it_be(:dast_site_inprogress, freeze: false) do
        create(
          :dast_site,
          project: project,
      ...
      let_it_be(:dast_site_passed, freeze: false) do
        create(
          :dast_site,
          project: project,
      ...
      let_it_be(:dast_site_failed, freeze: false) do
        create(
          :dast_site,
          project: project,
      ...
      let_it_be(:dast_site_none, freeze: false) do
        create(
          :dast_site,
          project: project,
          url: 'http://none.test',
      ...
      context 'basic site profiles' do
        # DAST site profiles
        let_it_be(:dast_site_profiles, freeze: false) do
          [
            create(
              :dast_site_profile,
              name: "Non-validated",
      ...
      context 'dast site profile with secret variables' do
        ...
        let_it_be(:dast_site_profile, freeze: false) { create(:dast_site_profile, project: project) }
        let_it_be(:request_headers_variable, freeze: false) { create(:dast_site_profile_secret_variable, :request_headers, dast_site_profile: dast_site_profile) }
        let_it_be(:password_variable, freeze: false) { create(:dast_site_profile_secret_variable, :password, dast_site_profile: dast_site_profile) }
    ...
    describe 'dast_scanner_profiles' do
      ...
      let_it_be(:dast_scanner_profiles, freeze: false) do
        [
          create(
    ...
    describe 'from policies' do
      let_it_be(:policies_project, freeze: false) { create(:project, :repository) }
    ...
    describe 'scheduled_dast_profiles' do
      ...
      let_it_be(:dast_profile, freeze: false) { create(:dast_profile, project: project, branch_name: project.default_branch) }

      let_it_be(:dast_profile_schedule, freeze: false) do
    ...
    describe 'dast_site_validations' do
      context 'failed site validations' do
        ...
        let_it_be(:dast_site_validation_https, freeze: false) do
          create(
            :dast_site_validation,
            state: :failed,
            dast_site_token: create(
        ...
        let_it_be(:dast_site_validation_http, freeze: false) do
          create(
            :dast_site_validation,
            state: :failed,
            dast_site_token: create(
    ...
    describe 'dast_profiles' do
      ...
      let_it_be(:dast_profiles, freeze: false) do
