...
RSpec.describe 'Work Items Integration (GraphQL fixtures)', type: :request, feature_category: :team_planning do
  ...
  let_it_be(:label1) { create(:label, project: project, title: 'To Do', color: '#F0AD4E') }
  let_it_be(:label2) { create(:label, project: project, title: 'Doing', color: '#5CB85C') }
  let_it_be(:assignable_user) { create(:user, username: 'assignable_user', name: 'Assignable User') }
  let_it_be(:milestone) { create(:milestone, project: project, title: 'v1.0') }
  let_it_be(:work_item) do
    create(:work_item, :issue, project: project, title: 'Dependent test issue', author: user)
  end

  let_it_be(:second_work_item) do
  ...
  describe GraphQL::Query do
    ...
    it "#{base_output_path}get_work_item_state_counts.query.graphql.json" do
      query = get_graphql_query_as_string(
        'work_items/list/graphql/get_work_item_state_counts.query.graphql', ee: true
      )
    ...
    it "#{base_output_path}work_item_ancestors.query.graphql.json" do
      query = get_graphql_query_as_string(
    ...
    it "#{base_output_path}work_item_allowed_children.query.graphql.json" do
      query = get_graphql_query_as_string(
    ...
    it "#{base_output_path}work_item_allowed_parent_types.query.graphql.json" do
      query = get_graphql_query_as_string(
    ...
    it "#{base_output_path}work_item_tree.query.graphql.json" do
      query = get_graphql_query_as_string(
    ...
    it "#{base_output_path}ai_permissions_for_project.query.graphql.json" do
      query = get_graphql_query_as_string(
    ...
    it "#{base_output_path}award_emoji.query.graphql.json" do
      query = get_graphql_query_as_string(
    ...
    it "#{base_output_path}design_collection.query.graphql.json" do
      query = get_graphql_query_as_string(
    ...
    it "#{base_output_path}workspace_autocomplete_users.query.graphql.json" do
      query = get_graphql_query_as_string(
    ...
    it "#{base_output_path}get_user_preferences.query.graphql.json" do
      query = get_graphql_query_as_string(
    ...
    it "#{base_output_path}custom_field_names.query.graphql.json" do
      query = get_graphql_query_as_string(
