...
RSpec.describe 'DevOps Adoption (GraphQL fixtures)', feature_category: :devops_reports do
  describe GraphQL::Query, type: :request do
    ...
    let_it_be(:sub_group, freeze: false) { create(:group, parent: group, name: 'my-sub-group') }

    let_it_be(:enabled_namespace, freeze: false) do
      create(:devops_adoption_enabled_namespace, namespace: group, display_namespace: group)
    end

    let_it_be(:second_enabled_namespace, freeze: false) do
      create(:devops_adoption_enabled_namespace, namespace: sub_group, display_namespace: group)
    end

    let_it_be(:expected_metrics, freeze: false) do
      result = {}
    ...
    let_it_be(:snapshot, freeze: false) do
