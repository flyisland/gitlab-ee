...
RSpec.describe 'Contribution Analytics (GraphQL fixtures)', feature_category: :value_stream_management do
  describe GraphQL::Query, type: :request do
    ...
    let_it_be(:user_1, freeze: false) { create(:user, name: 'Aaron') }
    let_it_be(:user_2, freeze: false) { create(:user,  name: 'Bob') }
    let_it_be(:user_3, freeze: false) { create(:user,  name: 'Carl') }
