...
import {
  ...
  milestonesResponse,
  baseUpdateResponse,
} from 'jest/msw_integration/handlers/work_items';
import { waitForElement, getText } from 'jest/msw_integration/test_helpers';
...
describe('WorkItem integration test', () => {
  ...
  const router = createRouter({
    ...
    routerPath: '/gitlab-org/gitlab/-/work_items',
  });
