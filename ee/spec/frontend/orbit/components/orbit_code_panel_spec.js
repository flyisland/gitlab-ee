...
describe('OrbitCodePanel', () => {
  ...
  describe('blobUrl', () => {
    it('builds a URL with a 1-indexed line anchor from a 0-indexed start_line', async () => {
      setupFetchData();
      createWrapper();
      await waitForPromises();
      ...
      // get_user has start_line: '5', so the anchor should be L6
      ...
      expect(jumpBtn.attributes('href')).toContain('#L6');
