...
describe('DetailsDrawer component', () => {
  ...
  describe('per-scanner details with securityPoliciesKevFilter', () => {
...
`;
    ...
    it('renders per-scanner details when feature flag is enabled', () => {
...
`;
    ...
    it('does not render per-scanner details when feature flag is disabled', () => {
