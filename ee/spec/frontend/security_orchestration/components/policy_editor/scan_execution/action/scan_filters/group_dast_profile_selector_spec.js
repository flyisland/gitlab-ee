...
describe('GroupDastProfileSelector', () => {
  ...
  const findScannerProfileInput = () => wrapper.findComponentByTestId('scan-profile-selection');
  const findSiteProfileInput = () => wrapper.findComponentByTestId('site-profile-selection');
