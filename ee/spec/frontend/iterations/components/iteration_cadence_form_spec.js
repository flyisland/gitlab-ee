...
describe('Iteration cadence form', () => {
  ...
  const findTitle = () => wrapper.findComponent('#cadence-title');
  const findStartDate = () => wrapper.findComponentByTestId('iteration-cadence-start-date-field');
  const findStartDateInput = () => wrapper.findComponent('#cadence-start-date');
  const findUpcomingIterations = () =>
    wrapper.findComponent('#cadence-schedule-upcoming-iterations');
  const findDuration = () => wrapper.findComponent('#cadence-duration');
  ...
  const findSaveButton = () => wrapper.findComponentByTestId('save-cadence');
  const findCancelButton = () => wrapper.findComponentByTestId('cancel-create-cadence');
  ...
  describe('Create cadence', () => {
    ...
    it('displays the label description for upcoming iterations', () => {
      expect(findUpcomingIterationsGroup().text()).toContain(
