...
import getOncallSchedulesQuery from 'ee/escalation_policies/graphql/queries/get_oncall_schedules.query.graphql';
  ...
  const createComponent = ({ props = {} } = {}) => {
    wrapper = shallowMountExtended(AddEscalationPolicyForm, {
      ...
      apolloProvider: createMockApollo([
        [getOncallSchedulesQuery, jest.fn().mockResolvedValue(oncallSchedulesResponse)],
      ]),
    });
  };
