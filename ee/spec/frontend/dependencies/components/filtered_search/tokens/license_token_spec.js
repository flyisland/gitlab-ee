...
describe('ee/dependencies/components/filtered_search/tokens/license_token.vue', () => {
  ...
  const createComponent = ({
    propsData = {},
    glFeatures = { groupDependenciesGraphql: true },
  } = {}) => {
  ...
  describe('when groupDependenciesGraphql feature flag is disabled', () => {
    it('fetches the list of licenses from the REST endpoint', () => {
      createComponent({ glFeatures: { groupDependenciesGraphql: false } });
