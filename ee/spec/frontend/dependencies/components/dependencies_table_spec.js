...
describe('DependenciesTable component', () => {
  ...
  describe('malware badge', () => {
    ...
    it.each(dependencies)('displays the malware badge for dependency: "$malware"', (dependency) => {
    ...
    it('does not display the malware badge when feature flag is disabled', () => {
      createComponent({
        propsData: {
          dependencies: createMalwareDependencies(),
          isLoading: false,
  ...
  describe('given some dependencies with policy dismissals (group context)', () => {
    let dependencies;
