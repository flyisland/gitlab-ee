...
describe('UsageBillingApp', () => {
  ...
  describe('tracking', () => {
    ...
    const findUsageTrendsTab = () => wrapper.findByTestId('usage-trends-tab');
    const findUsageOverviewTab = () => wrapper.findByTestId('usage-overview-tab');
    const findUsageByUserGlTab = () => wrapper.findByTestId('usage-by-user-tab');
