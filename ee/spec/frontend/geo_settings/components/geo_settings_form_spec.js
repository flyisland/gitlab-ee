...
describe('GeoSettingsForm', () => {
  ...
  const findGeoSettingsSaveButton = () =>
    wrapper.findComponent('[data-testid="settingsSaveButton"]');
  const findGeoSettingsCancelButton = () =>
    wrapper.findComponent('[data-testid="settingsCancelButton"]');
  ...
  describe('template', () => {
    ...
    describe('Save Button', () => {
      describe('with errors on form', () => {
        ...
        it('disables button', () => {
          expect(findGeoSettingsSaveButton().attributes('aria-disabled')).toBe('true');
        });
      });

      describe('with no errors on form', () => {
        it('does not disable button', () => {
          expect(findGeoSettingsSaveButton().attributes('aria-disabled')).toBeUndefined();
        });
      });
    });
  });
