...
describe('Group Security Dashboard (new version) - Component', () => {
  ...
  const createComponent = ({
    ...
    wrapper = shallowMountExtended(GroupSecurityDashboardNew, {
      ...
      provide: {
        ...
        glFeatures: {
          newSecurityDashboardPdfExport,
          newSecurityDashboardVulnerabilitiesByIdentifier,
        },
      },
    });
  };
  ...
  describe('PDF export button', () => {
    ...
    it('does not render the PDF export button when feature flag is disabled', () => {
      createComponent({ newSecurityDashboardPdfExport: false });
  ...
  describe('when the newSecurityDashboardVulnerabilitiesByIdentifier feature flag is disabled', () => {
    it('does not render the panel when feature flag is disabled', () => {
      createComponent({ newSecurityDashboardVulnerabilitiesByIdentifier: false });

      expect(getVulnerabilitiesByIdentifierPanel()).toBeUndefined();
    });
  });
});
