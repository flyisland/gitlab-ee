...
describe('Security reports summary component', () => {
  ...
  describe('collapsible behavior', () => {
    ...
    describe('legacy local storage migration', () => {
      it('migrates a hidden legacy value to the crud-collapse key', () => {
      ...
      it('does not migrate an absent legacy value', () => {
        createWrapper();

        expect(localStorage.setItem).not.toHaveBeenCalledWith(LOCAL_STORAGE_KEY, false);
      });
    });
