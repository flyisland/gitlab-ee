...
import { getSubGroups, getUsers } from 'ee/groups/settings/api/access_dropdown_api';
import AccessDropdown from 'ee/groups/settings/components/access_dropdown.vue';

jest.mock('ee/groups/settings/api/access_dropdown_api', () => ({
