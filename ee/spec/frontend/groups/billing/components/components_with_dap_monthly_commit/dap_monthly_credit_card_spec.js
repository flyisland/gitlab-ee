...
describe('DapMonthlyCreditCard', () => {
  ...
  const findCtaButton = () => wrapper.findByTestId('dap-monthly-credit-card-cta-button');
  ...
  describe('when upgradeSubscriptionPath is provided', () => {
    it('applies subtle background even with monthly commitment', () => {
      createComponent({
    ...
    it('applies subtle background without monthly commitment', () => {
      createComponent({
        upgradeSubscriptionPath: '/groups/upgrade-subscription',
      });
    ...
    it('sets CTA button variant to default even with monthly commitment', () => {
      createComponent({
        upgradeSubscriptionPath: '/groups/upgrade-subscription',
        monthlyCommitmentPurchased: 100,
      });
    ...
    it('sets CTA button variant to default without monthly commitment', () => {
      createComponent({
        upgradeSubscriptionPath: '/groups/upgrade-subscription',
      });
