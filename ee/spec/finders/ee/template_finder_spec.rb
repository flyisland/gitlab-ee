...
RSpec.describe TemplateFinder, feature_category: :source_code_management do
  ...
  describe '#template_names' do
    ...
    let_it_be_with_reload(:group_template_project) { create(:project, :custom_repo, group: group, files: template_files) }
