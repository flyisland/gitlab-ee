...
RSpec.describe GroupMembersFinder, feature_category: :groups_and_projects do
  ...
  describe '#execute' do
    context 'with custom roles' do
      ...
      let_it_be(:public_shared_group, freeze: false)  { create(:group, :public) }
      let_it_be(:private_shared_group, freeze: false) { create(:group, :private) }
      ...
      let_it_be(:public_shared_group_custom_maintainer_role, freeze: false) { create(:member_role, :maintainer, namespace: public_shared_group) }
      let_it_be(:public_shared_group_custom_developer_role, freeze: false) { create(:member_role, :developer, namespace: public_shared_group) }
      let_it_be(:public_shared_group_custom_reporter_role, freeze: false) { create(:member_role, :reporter, namespace: public_shared_group) }
