...
RSpec.describe EpicsFinder, feature_category: :team_planning do
  ...
  let_it_be_with_reload(:epic3) { create(:epic, :closed, group: group, description: 'not so awesome', start_date: 5.days.before(reference_time), end_date: 3.days.before(reference_time)) }
  let_it_be_with_reload(:epic2) { create(:epic, :opened, group: group, created_at: 4.days.before(reference_time), author: user, start_date: 2.days.before(reference_time), end_date: 3.days.since(reference_time)) }
      ...
      context 'with correct params' do
        ...
        context 'by author' do
          ...
          context 'when filtering by author username' do
            ...
            let_it_be(:search_params, freeze: false) { { group_id: issuable_parent.id } }
        ...
        context 'by milestone' do
          ...
          context "with hierarchy" do
            ...
            let_it_be(:subgroup_project, freeze: false) { create(:project, :public, group: subgroup) }
            ...
            let(:params) { { group_id: base_group.id } }
        ...
        context 'when using group cte for search' do
          ...
          context 'when epic labels are split across epic and epic work item' do
            ...
            before_all do
              labeled_epic1.work_item.labels << label3
              labeled_epic2.work_item.labels << label5
              labeled_epic3.work_item.labels << label5
            end
        ...
        context 'with negated author' do
          ...
          let(:params) { { not: { author_id: author.id } } }
        ...
        context 'with negated reaction emoji' do
          ...
          let(:params) { { not: { my_reaction_emoji: awarded_emoji.name } } }
