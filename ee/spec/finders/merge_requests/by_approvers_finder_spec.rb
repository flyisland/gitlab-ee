...
RSpec.describe MergeRequests::ByApproversFinder, feature_category: :code_review_workflow do
  ...
  let_it_be(:second_group_user, freeze: false) { create(:user) }
  ...
  let_it_be(:second_project_user, freeze: false) { create(:user) }

  let_it_be(:merge_request_with_project_approver, freeze: false) do
  ...
  let_it_be(:merge_request_with_approver, freeze: false) do
    mr = create(:merge_request)
    create(:approval_merge_request_rule, merge_request: mr, users: [first_user])
    mr
  end

  let_it_be(:merge_request_with_two_approvers, freeze: false) do
    mr = create(:merge_request)
    create(:approval_merge_request_rule, merge_request: mr, users: [first_user, second_user])
    mr
  end

  let_it_be(:merge_request_with_group_approver, freeze: false) do
  ...
  let_it_be(:merge_request_with_project_group_approver, freeze: false) do
