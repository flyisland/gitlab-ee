...
RSpec.describe Analytics::DevopsAdoption::EnabledNamespacesFinder, feature_category: :devops_reports do
  ...
  describe '#execute' do
    ...
    let_it_be(:enabled_namespace_1) do
      create(:devops_adoption_enabled_namespace, namespace: root_group_1, display_namespace: nil)
    end

    let_it_be(:enabled_namespace_2) do
      create(:devops_adoption_enabled_namespace, namespace: root_group_1, display_namespace: root_group_1)
    end
