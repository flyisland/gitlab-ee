...
RSpec.describe DastSiteProfilesFinder, feature_category: :dynamic_application_security_testing do
  ...
  let_it_be(:dast_site_profile1) { create(:dast_site_profile) }
  let_it_be(:project1) { dast_site_profile1.project }
  let_it_be(:dast_site_profile2) { create(:dast_site_profile) }
  let_it_be(:project2) { dast_site_profile2.project }
  let_it_be(:dast_site_profile3) { create(:dast_site_profile, project: project1) }
