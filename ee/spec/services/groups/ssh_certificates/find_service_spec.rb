...
RSpec.describe Groups::SshCertificates::FindService, feature_category: :source_code_management do
  ...
  let_it_be(:group, freeze: false) { ssh_certificate.group }
  let_it_be(:user, freeze: false) { create(:enterprise_user, enterprise_group: group, developer_of: group) }
  ...
  describe '#execute' do
    ...
    context 'when user has minimal group access and developer project access' do
      ...
      let_it_be(:group_member, freeze: false) { create(:group_member, :minimal_access, group: group, user: user) }
