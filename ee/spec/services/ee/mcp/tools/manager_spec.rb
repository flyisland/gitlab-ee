...
RSpec.describe Mcp::Tools::Manager, feature_category: :ai_agents do
  ...
  before do
    ...
    # Stub the EE_CUSTOM_TOOLS as empty (semantic_code_search is now an ApiTool via route_setting :mcp)
  ...
  describe '#get_tool' do
    ...
    context 'with semantic_code_search served by the REST ApiTool' do
