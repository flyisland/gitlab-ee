...
RSpec.describe Search::GlobalService, feature_category: :global_search do
  ...
  describe '#elastic_projects', :elastic_helpers do
    ...
    context 'when the traversal_ids backfill migrations have finished' do
      ...
      context 'when the user is an admin', :enable_admin_mode do
        ...
        it 'returns nil and does not load authorized projects', :aggregate_failures do
          expect(user).not_to receive(:authorized_projects)
      ...
      context 'when the user is not an admin' do
        ...
        it 'returns nil and does not load authorized projects' do
          expect(user).not_to receive(:authorized_projects)
          expect(elastic_projects).to be_nil
        end
      end
  ...
  describe '#zoekt_nodes' do
    ...
    it 'calls Node.for_search.searchable' do
      allow(Search::Zoekt::Node).to receive_message_chain(:for_search, :searchable).and_return(:searchable_nodes)

      expect(zoekt_nodes).to eq(:searchable_nodes)
    end
