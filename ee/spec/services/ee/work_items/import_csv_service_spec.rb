...
RSpec.describe WorkItems::ImportCsvService, feature_category: :team_planning do
  ...
  let_it_be(:author, freeze: false) { create(:user, username: 'csv_author') }
  ...
  let_it_be(:requirement_type, freeze: false) { build(:work_item_system_defined_type, :requirement) }
  ...
  describe '#execute', :aggregate_failures do
    ...
    context 'when csv contains custom work item types' do
      ...
      let_it_be(:custom_type, freeze: false) { create(:work_item_custom_type, name: 'Story', namespace: group) }
