...
RSpec.describe WorkItems::RelatedWorkItemLinks::DestroyService, feature_category: :portfolio_management do
  describe '#execute' do
    ...
    let_it_be(:source, freeze: false) { create(:work_item, project: project) }
    ...
    context 'when there is an epic for the work item' do
      ...
      let_it_be(:source, freeze: false) { epic_a.work_item }
    ...
    context 'with tracking work item events' do
      let_it_be(:blocking_target, freeze: false) { create(:work_item, project: project) }
