...
RSpec.describe TimeboxReportService, :aggregate_failures do
  ...
  context 'milestone charts' do
    let_it_be_with_reload(:timebox) { create(:milestone, project: project, start_date: timebox_start_date, due_date: timebox_end_date) }
  ...
  context 'iteration charts' do
    ...
    let_it_be_with_reload(:timebox) { create(:iteration, iterations_cadence: cadence, start_date: timebox_start_date, due_date: timebox_end_date) }
