...
RSpec.describe AuditEvents::EventFilterSyncHelper, feature_category: :audit_events do
  ...
  describe '#sync_stream_event_type_filter' do
    ...
    let_it_be(:legacy_destination, freeze: false) { create(:external_audit_event_destination, group: group) }
    let_it_be(:stream_destination, freeze: false) do
    ...
    context 'with instance level destination' do
      let_it_be(:instance_legacy_destination, freeze: false) { create(:instance_external_audit_event_destination) }
      let_it_be(:instance_stream_destination, freeze: false) do
