...
RSpec.describe HistoricalUserData::CsvService, feature_category: :user_management do
  ...
  let(:csv_service) { described_class.new(HistoricalData.all) }
  ...
  context 'User Count Table' do
    let_it_be(:historical_datum) { create(:historical_data, recorded_at: license_start_date, active_user_count: 1) }
