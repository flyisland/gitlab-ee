...
RSpec.describe WorkItems::LegacyEpics::EpicIssues::UpdateService, feature_category: :portfolio_management do
  describe '#execute' do
    ...
    let_it_be(:group, freeze: false) { create(:group, :public, guests: guest) }
    let_it_be(:project, freeze: false) { create(:project, :public, group: create(:group, :public), guests: guest) }
    ...
    let_it_be(:epic_issue1, freeze: false) { create(:epic_issue, epic: epic, issue: issue1) }
