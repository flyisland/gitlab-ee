...
RSpec.describe VirtualRegistries::Upstreams::Remote::CheckService, :aggregate_failures, feature_category: :virtual_registry do
  ...
  describe '#execute' do
    ...
    context 'for maven virtual registries' do
      ...
      let_it_be(:upstream1, freeze: false) do
        create(:virtual_registries_packages_maven_upstream, registries: [registry])
      end

      let_it_be(:upstream2, freeze: false) do
        create(:virtual_registries_packages_maven_upstream, registries: [registry])
      end

      let_it_be(:upstream3, freeze: false) do
        create(:virtual_registries_packages_maven_upstream, registries: [registry])
      end
    ...
    context 'for container virtual registries' do
      ...
      let_it_be(:upstream1, freeze: false) { create(:virtual_registries_container_upstream, registries: [registry]) }
      let_it_be(:upstream2, freeze: false) { create(:virtual_registries_container_upstream, registries: [registry]) }
      let_it_be(:upstream3, freeze: false) { create(:virtual_registries_container_upstream, registries: [registry]) }
