  ...
  describe '#execute' do
    ...
    context 'when workflow fails to start' do
      ...
      context 'when user does not have permission to create Duo workflow pipeline' do
        ...
        include_examples 'adds an error note' do
          let(:expected_error_message) { ::Ai::CodeReviewMessages.insufficient_workload_permissions_error(user) }
        end
      ...
      context 'when CI workload fails to be created' do
        ...
        include_examples 'adds an error note' do
          let(:expected_error_message) { ::Ai::CodeReviewMessages.workload_creation_error }
        end
      ...
      context 'when the feature is unavailable for the user' do
        ...
        include_examples 'adds an error note' do
          let(:expected_error_message) { ::Ai::CodeReviewMessages.feature_unavailable_error }
        end
      ...
      context 'when duo workflow token cannot be obtained' do
        ...
        include_examples 'adds an error note' do
          let(:expected_error_message) { ::Ai::CodeReviewMessages.invalid_token_error }
        end
      ...
      context 'when source ref cannot be found' do
        ...
        include_examples 'adds an error note' do
          let(:expected_error_message) { ::Ai::CodeReviewMessages.source_ref_not_found_error }
        end
