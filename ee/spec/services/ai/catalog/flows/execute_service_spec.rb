...
RSpec.describe Ai::Catalog::Flows::ExecuteService, :aggregate_failures, feature_category: :workflow_catalog do
  ...
  let_it_be(:flow_owner_project) { create(:project, group: group, developers: developer) }
  ...
  let_it_be(:item_enabled_project) { create(:project, :repository, group: group, developers: developer) }
