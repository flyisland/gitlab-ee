  ...
  it_behaves_like 'Ai::Catalog::AuditEventMessageService' do
    ...
    describe '#messages' do
      ...
      context 'when event_type is update_ai_catalog_agent' do
        ...
        let_it_be_with_reload(:update_agent) { create(:ai_catalog_agent, project: project) }
        ...
        context 'when visibility changes from private to public' do
          let_it_be(:private_agent, freeze: false) { create(:ai_catalog_agent, project: project, public: false) }
        ...
        context 'when visibility changes from public to private' do
          let_it_be(:public_agent, freeze: false) { create(:ai_catalog_agent, project: project, public: true) }
