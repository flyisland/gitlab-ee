  ...
  describe '#execute' do
    ...
    describe 'triggered by issue' do
      ...
      context 'when reopening an issue' do
        include_examples 'trigger status page publish' do
          let_it_be_with_reload(:triggered_by) { create(:issue, :closed, :published, project: project) }
    ...
    describe 'triggered by award emoji' do
      ...
      context 'for notes on issues' do
        let_it_be_with_reload(:awardable) { create(:note_on_issue, project: project) }
      ...
      context 'for issues' do
        let_it_be_with_reload(:awardable) { create(:issue, project: project) }

        include_examples 'no trigger status page publish'
      end

      context 'for notes on merge requests' do
        let_it_be_with_reload(:awardable) { create(:note_on_merge_request, project: project) }
