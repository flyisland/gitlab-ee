...
/unassign_reviewer me
    ...
    context 'iteration command' do
      ...
      let_it_be(:group, freeze: false) { create(:group, :private, parent: root_group) }
      ...
      context 'when iterations are enabled' do
        ...
        context 'when iteration exists' do
          let_it_be(:iteration, freeze: false) { create(:iteration, iterations_cadence: create(:iterations_cadence, group: group)) }
        ...
        context 'with --current and --next options' do
          ...
          context "with iterations cadence reference" do
            let_it_be(:cadence, freeze: false) { create(:iterations_cadence, title: "one cadence", group: root_group) }
            let_it_be(:past_iteration, freeze: false) { create(:iteration, :with_due_date, iterations_cadence: cadence, start_date: 10.days.ago) }
            let_it_be(:current_iteration, freeze: false) { create(:iteration, :with_due_date, iterations_cadence: cadence, start_date: 2.days.ago) }
            let_it_be(:next_iteration, freeze: false) { create(:iteration, :with_due_date, iterations_cadence: cadence, start_date: 10.days.from_now) }

            let_it_be(:another_cadence, freeze: false) { create(:iterations_cadence, title: "another cadence", group: root_group) }
            let_it_be(:another_current_iteration, freeze: false) { create(:iteration, :with_due_date, iterations_cadence: another_cadence, start_date: 2.days.ago) }

            let_it_be(:empty_cadence, freeze: false) { create(:iterations_cadence, title: "empty cadence", group: root_group) }

            let_it_be(:inaccessible_cadence, freeze: false) { create(:iterations_cadence, title: "another cadence") }
          ...
          context "without iterations cadence reference" do
            let_it_be(:cadence, freeze: false) { create(:iterations_cadence, title: "cadence", group: group) }
            let_it_be(:current_iteration, freeze: false) { create(:iteration, :with_due_date, iterations_cadence: cadence, start_date: 2.days.ago) }
            let_it_be(:next_iteration, freeze: false) { create(:iteration, :with_due_date, iterations_cadence: cadence, start_date: 10.days.from_now) }
    ...
    context 'remove_iteration command' do
      ...
      context 'when iterations are enabled' do
        ...
        context 'when the user does not have enough permissions' do
          ...
          let_it_be(:work_item_issue, freeze: false) { create(:work_item, :issue, project: project, iteration: iteration) }
    ...
    context 'epic command' do
        ...
        context 'when epics are enabled' do
          ...
          context 'when epic exists' do
            ...
            context 'when an issue belongs to a project without group' do
              let_it_be(:user_project, freeze: false) { create(:project) }
      ...
      context 'on a work item' do
        let_it_be(:work_item_issue, freeze: false) { create(:work_item, :issue, project: project) }
        let_it_be(:epic, freeze: false) { create(:epic, :with_synced_work_item, group: group) }
    ...
    context '/label command' do
      context 'when target is a group level work item' do
        ...
        let_it_be(:new_group, freeze: false) { create(:group, developers: developer) }
        let_it_be(:group_level_work_item, freeze: false) { create(:work_item, :group_level, namespace: new_group) }
      ...
      context 'for epics' do
        ...
        context 'when epic has non-confidential issues' do
          ...
          it_behaves_like 'command not applied' do
            let_it_be(:execution_message, freeze: false) do
    ...
    context 'unlink command' do
      let_it_be(:unlink_target, freeze: false) { create(:issue, project: project) }
      ...
      context 'when target is not an issue' do
        let_it_be(:unlink_target, freeze: false) { create(:work_item, :epic, namespace: group) }
        let_it_be(:unlink_source, freeze: false) { create(:work_item, :epic, namespace: group) }
        let_it_be(:issue, freeze: false) { unlink_source }
      ...
      context 'when target is a legacy epic reference' do
        let_it_be(:unlink_target, freeze: false) { create(:epic, group: group) }
        let_it_be(:unlink_source, freeze: false) { create(:work_item, project: project) }
        let_it_be(:issue, freeze: false) { unlink_source }
    ...
    context 'blocking merge request commands' do
      ...
      let_it_be(:other_mr, freeze: false) { create(:merge_request, source_project: project, source_branch: 'other-branch') }
    ...
    describe 'status command' do
      ...
      context 'with custom statuses' do
        let_it_be(:custom_status_to_do, freeze: false) { create(:work_item_custom_status, :to_do, name: 'To do', namespace: group) }
        let_it_be(:custom_status_in_progress, freeze: false) do
  ...
  describe '#explain' do
    ...
    describe 'milestone command' do
      context 'on group-level work items' do
        ...
        let_it_be(:group_work_item, freeze: false) { create(:work_item, :epic, :group_level, namespace: group) }
    ...
    describe 'weight command' do
      ...
      context 'for a work item type that does not support weight' do
        let_it_be(:target, freeze: false) { create(:work_item, :epic, :group_level, namespace: group) }
    ...
    describe 'linked items commands' do
      ...
      let_it_be(:restricted_project, freeze: false) { create(:project) }
      let_it_be(:ref1, freeze: false) { create(:issue, project: project).to_reference }
      let_it_be(:ref2, freeze: false) { create(:issue, project: project).to_reference }
      let_it_be(:ref3, freeze: false) { create(:work_item, project: project).to_reference }
      let_it_be(:ref4, freeze: false) { create(:work_item, :epic, namespace: group).to_reference }
      let_it_be(:ref5, freeze: false) { create(:work_item, :epic_with_legacy_epic, namespace: group).to_reference(full: true) }
      ...
      context 'with /blocks' do
        ...
        context 'with insufficient permissions' do
          let_it_be(:target, freeze: false) { create(:issue, project: restricted_project) }
    ...
    describe 'promote_to command' do
      ...
      context 'when work item supports promotion' do
        context 'with key result' do
          let_it_be(:key_result, freeze: false) { build(:work_item, :key_result, project: project) }
        ...
        context 'with issue' do
          let_it_be(:issue, freeze: false) { build(:work_item, :issue, project: project) }
      ...
      context 'when work item does not support promotion' do
        let_it_be(:requirement, freeze: false) { build(:work_item, :requirement, project: project) }
  ...
  describe 'clone issue command' do
    ...
    let_it_be(:work_item, freeze: false) { create(:work_item, :epic_with_legacy_epic, :group_level, namespace: group) }
