...
RSpec.describe Boards::UserPreferences::UpdateService, :services, feature_category: :planning_views do
  describe '#execute' do
    ...
    context 'when user is present' do
      context 'when there is no user preference' do
        it 'creates user preference' do
          ...
          expect(preferences.hide_labels).to be(true)
      ...
      context 'when there is an user preference' do
        ...
        it 'does not duplicate user preference' do
          ...
          expect(preferences.first.hide_labels).to be(false)
          expect(result).to be(true)
        end
