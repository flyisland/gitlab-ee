...
RSpec.describe Boards::Epics::PositionCreateService, feature_category: :planning_views do
    ...
    context 'with correct params' do
      ...
      context 'without additional params' do
        context 'when there are no positions' do
          it 'creates positions for all epics and sets relative_position based on id', :aggregate_failures do
        ...
        context 'when some positions exist' do
          context 'when there is still space for new positions' do
            ...
            it 'creates positions for non-existing epics and sets relative_position after the last existing position', :aggregate_failures do
      ...
      context 'with additional params' do
        context 'for backlog list' do
          ...
          it 'creates positions for all epics until the last param and sets relative_position based on id', :aggregate_failures do
        ...
        context 'for labeled list' do
          ...
          it 'creates positions for all epics until the last param and sets relative_position only for epics with list label', :aggregate_failures do
            expect { subject }.to change { Boards::EpicBoardPosition.count }.by(2)
