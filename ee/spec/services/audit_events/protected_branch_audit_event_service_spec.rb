...
RSpec.describe AuditEvents::ProtectedBranchAuditEventService, :request_store, feature_category: :audit_events do
  ...
  let_it_be(:protected_branch, freeze: false) { create(:protected_branch, :no_one_can_push, allow_force_push: true, code_owner_approval_required: true, project: entity) }
