...
RSpec.describe AppSec::Dast::ScannerProfiles::UpdateService, :dynamic_analysis,
  ...
  let_it_be_with_reload(:dast_profile) { create(:dast_scanner_profile, target_timeout: 200, spider_timeout: 5000) }
  let_it_be_with_reload(:dast_profile_2) { create(:dast_scanner_profile) }
  ...
  describe '#execute' do
    ...
    context 'when the user can run a dast scan' do
      ...
      context 'when setting properties to false' do
        let_it_be_with_reload(:dast_scanner_profile) { create(:dast_scanner_profile, target_timeout: 200, spider_timeout: 5000, use_ajax_spider: true, show_debug_messages: true) }
