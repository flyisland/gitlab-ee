...
RSpec.describe AppSec::Dast::SiteProfiles::DestroyService, feature_category: :dynamic_application_security_testing do
  ...
  let_it_be_with_reload(:dast_profile) { create(:dast_site_profile) }
  ...
  describe '#execute' do
    ...
    context 'when the site profile has secret variables and the user is a developer' do
      before do
        project.add_developer(user)
        create(:dast_site_profile_secret_variable, :password, dast_site_profile: dast_profile)
      end
