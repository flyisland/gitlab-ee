...
RSpec.describe Iterations::Cadences::DestroyService, feature_category: :team_planning do
  ...
  let_it_be_with_refind(:iteration_cadence) { create(:iterations_cadence, group: group, start_date: Date.today, duration_in_weeks: 1, iterations_in_advance: 2) }
  ...
  let_it_be_with_refind(:iteration_event) { create(:resource_iteration_event, iteration: iteration) }
  let_it_be_with_refind(:board) { create(:board, iteration: iteration, iteration_cadence: iteration_cadence, group: group) }
  let_it_be_with_refind(:board2) { create(:board, iteration: iteration, group: group) }
  let_it_be_with_refind(:iteration_list) { create(:iteration_list, board: board, iteration: iteration) }
