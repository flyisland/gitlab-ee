...
RSpec.describe Iterations::DeleteService, feature_category: :team_planning do
  ...
  let_it_be_with_refind(:past_iteration) { create(:closed_iteration, iterations_cadence: iteration_cadence1, group: group, start_date: start_date, due_date: start_date + 13.days) }
  let_it_be_with_refind(:past_board) { create(:board, iteration: past_iteration, group: group) }
  let_it_be_with_refind(:past_issue) { create(:issue, project: project, iteration: past_iteration) }

  let_it_be_with_refind(:current_iteration) { create(:current_iteration, iterations_cadence: iteration_cadence1, group: group, start_date: start_date + 14.days, due_date: start_date + 27.days) }

  let_it_be_with_refind(:future_iteration) { create(:upcoming_iteration, iterations_cadence: iteration_cadence1, group: group, start_date: start_date + 28.days, due_date: start_date + 41.days) }

  let_it_be_with_refind(:last_future_iteration) { create(:upcoming_iteration, iterations_cadence: iteration_cadence1, group: group, start_date: start_date + 42.days, due_date: start_date + 55.days) }
  let_it_be_with_refind(:last_future_board) { create(:board, iteration: last_future_iteration, group: group) }
  let_it_be_with_refind(:last_future_issue) { create(:issue, project: project, iteration: last_future_iteration) }

  let_it_be_with_refind(:other_cadence_iteration) { create(:current_iteration, iterations_cadence: iteration_cadence2, group: group, start_date: start_date + 14.days, due_date: start_date + 27.days) }
  let_it_be_with_refind(:other_cadence_board) { create(:board, iteration: other_cadence_iteration, group: group) }
  let_it_be_with_refind(:other_cadence_issue) { create(:issue, project: project, iteration: other_cadence_iteration) }
