...
RSpec.describe Users::ServiceAccounts::CreateService, feature_category: :user_management do
  ...
  describe '#creation_allowed?' do
    ...
    it 'delegates to Authn::ServiceAccounts.creation_allowed_for_sm?', :enable_admin_mode do
      expect(::Authn::ServiceAccounts)
        .to receive(:creation_allowed_for_sm?).with(no_args).and_call_original
  ...
  context 'when current user is an admin', :enable_admin_mode do
    ...
    context 'when free-tier feature flag is enabled but not licensed' do
