      ...
      shared_examples_for 'ingesting sbom reports in a single pipeline' do
        ...
        context 'when the project has SBOM ingestion available' do
          ...
          context 'on a non-default branch' do
            ...
            context 'when sbom_ingestion_on_non_default_branches FF is disabled' do
              before do
                stub_feature_flags(sbom_ingestion_on_non_default_branches: false)
              end
            ...
            context 'when sbom_ingestion_on_non_default_branches FF is enabled' do
              before do
                stub_feature_flags(sbom_ingestion_on_non_default_branches: true)
              end
