...
RSpec.describe MergeRequests::SyncCodeOwnerApprovalRules, feature_category: :code_review_workflow do
  ...
  describe 'auto reviewer assignment' do
    context 'when enqueue_auto_reviewer_assignment param is not set' do
    ...
    context 'when enqueue_auto_reviewer_assignment param is true' do
      let(:params) { { enqueue_auto_reviewer_assignment: true } }
