...
RSpec.describe Projects::CleanupService do
  ...
  let_it_be(:project, freeze: false) { create(:project, :repository, bfg_object_map: fixture_file_upload('spec/fixtures/bfg_object_map.txt')) }
  let_it_be(:object_map, freeze: false) { project.bfg_object_map }
