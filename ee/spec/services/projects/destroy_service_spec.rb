...
RSpec.describe Projects::DestroyService, feature_category: :groups_and_projects do
  ...
  context 'when project is a mirror' do
    ...
    let_it_be(:project_mirror, freeze: false) { create(:project, :mirror, :repository, :import_scheduled) }
  ...
  context 'when project has a secret manager' do
    ...
    it 'calls the deprovision service with snapshot ids captured before destroy' do
      ...
      expected_root_namespace_id = project.root_ancestor.id
      ...
      expect(SecretsManagement::ProjectSecretsManagers::InitiateDeprovisionService).to receive(:new).with(
        ...
        root_namespace_id: expected_root_namespace_id
