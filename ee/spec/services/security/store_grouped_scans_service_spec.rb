    ...
    context 'when there is no error' do
      ...
      context 'when processing SEP and project SAST artifacts with ScanArtifactComparator' do
        ...
        it 'processes SEP artifact before project artifact' do
          ...
          expect(Security::StoreScanService).to have_received(:execute).with(sep_artifact, empty_set, false).ordered
          expect(Security::StoreScanService).to have_received(:execute).with(project_artifact, empty_set, true).ordered
        end
      end
    end
  end
