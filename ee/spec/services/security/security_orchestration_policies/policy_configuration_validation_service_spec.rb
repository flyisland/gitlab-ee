...
RSpec.describe Security::SecurityOrchestrationPolicies::PolicyConfigurationValidationService,
  ...
  describe '#execute' do
    ...
    %i[approval_policy scan_execution_policy pipeline_execution_policy pipeline_execution_schedule_policy vulnerability_management_policy dependency_firewall_policy].each do |type|
