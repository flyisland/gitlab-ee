  ...
  describe '#config' do
    ...
    context 'when action is valid' do
      context 'when scan type is secret_detection' do
        let_it_be(:action, freeze: false) { { scan: 'secret_detection', tags: ['runner-tag'] } }
      ...
      context 'when scan type is container_scanning' do
        let_it_be(:action, freeze: false) { { scan: 'container_scanning', tags: ['runner-tag'] } }
      ...
      context 'when scan type is sast', :aggregate_failures do
        let_it_be(:action, freeze: false) { { scan: 'sast', tags: ['runner-tag'] } }
    ...
    context 'when scan type is dependency_scanning', :aggregate_failures do
      let_it_be(:action, freeze: false) { { scan: 'dependency_scanning', tags: ['runner-tag'] } }
    ...
    context 'when scan type is sast_iac', :aggregate_failures do
      let_it_be(:action, freeze: false) { { scan: 'sast_iac', tags: ['runner-tag'] } }
