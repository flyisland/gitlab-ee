...
RSpec.describe Security::SecurityOrchestrationPolicies::AnnotatePolicyYamlService, feature_category: :security_policy_management do
  ...
  let_it_be(:org_group, freeze: false) { create(:group, :public, path: 'test_gitlab_org') }
  let_it_be(:test_project, freeze: false) { create(:project, :public, group: org_group, path: 'test_project') }
