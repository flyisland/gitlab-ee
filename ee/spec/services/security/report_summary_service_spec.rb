...
RSpec.describe Security::ReportSummaryService, '#execute', feature_category: :vulnerability_management do
  ...
  let_it_be(:build_ds, freeze: false) { create(:ci_build, :success, name: 'dependency_scanning', pipeline: pipeline) }
  let_it_be(:artifact_ds, freeze: false) { create(:ee_ci_job_artifact, :dependency_scanning, job: build_ds) }
  let_it_be(:report_ds, freeze: false) { create(:ci_reports_security_report, type: :dependency_scanning) }
  let_it_be(:scan_ds, freeze: false) { create(:security_scan, scan_type: :dependency_scanning, build: build_ds) }

  let_it_be(:build_sast, freeze: false) { create(:ci_build, :success, name: 'sast', pipeline: pipeline) }
  let_it_be(:artifact_sast, freeze: false) { create(:ee_ci_job_artifact, :sast, job: build_sast) }
  let_it_be(:report_sast, freeze: false) { create(:ci_reports_security_report, type: :sast) }
  let_it_be(:scan_sast, freeze: false) { create(:security_scan, scan_type: :sast, build: build_sast) }

  let_it_be(:build_dast, freeze: false) { create(:ci_build, :success, name: 'dast', pipeline: pipeline) }
  let_it_be(:artifact_dast, freeze: false) { create(:ee_ci_job_artifact, :dast_large_scanned_resources_field, job: build_dast) }
  let_it_be(:report_dast, freeze: false) { create(:ci_reports_security_report, type: :dast) }
  let_it_be(:scan_dast, freeze: false) { create(:security_scan, scan_type: :dast, build: build_dast) }

  let_it_be(:build_cs, freeze: false) { create(:ci_build, :success, name: 'container_scanning', pipeline: pipeline) }
  let_it_be(:artifact_cs, freeze: false) { create(:ee_ci_job_artifact, :container_scanning, job: build_cs) }
  let_it_be(:report_cs, freeze: false) { create(:ci_reports_security_report, type: :container_scanning) }
  let_it_be(:scan_cs, freeze: false) { create(:security_scan, scan_type: :container_scanning, build: build_cs) }
