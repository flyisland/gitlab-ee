  ...
  describe '.execute' do
    ...
    context 'when namespace is a root namespace' do
      ...
      context 'with sast scan_type identifier' do
        ...
        context 'when security_scan_profiles_sast feature flag is disabled' do
          before do
        ...
        context 'when security_scan_profiles_sast feature flag is enabled' do
      ...
      context 'with dependency_scanning scan_type identifier' do
        ...
        context 'when security_scan_profiles_dependency_scanning feature flag is disabled' do
          before do
        ...
        context 'when security_scan_profiles_dependency_scanning feature flag is enabled' do
