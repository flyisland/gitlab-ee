    ...
    context 'when authorized' do
      ...
      context 'when not the last owner' do
        ...
        context 'when there are multiple member records in the hierarchy' do
          let_it_be(:root_member, freeze: false) do
            create(:group_member, :active, :developer, group: root_group, user: user)
          end
        ...
        context 'when there are no active memberships' do
          let_it_be(:root_member, freeze: false) do
            create(:group_member, :awaiting, :developer, group: root_group, user: user)
          end
        ...
        context 'when user is not member of the group' do
          let_it_be(:member, freeze: false) { create(:group_member, :active, group: create(:group), user: user) }
        ...
        context 'when user has multiple memberships with invalid access levels' do
          let_it_be(:sub_membership, freeze: false) do
            create(:group_member, :active, :developer, group: sub_group, user: user)
          end
