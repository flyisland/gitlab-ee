...
RSpec.describe Dora::AggregateScoresService, feature_category: :value_stream_management do
  ...
  let_it_be_with_reload(:topic1) { create(:topic, name: "topic1", organization_id: group.organization_id) }
  let_it_be_with_reload(:topic2) { create(:topic, name: "topic2", organization_id: group.organization_id) }
  let_it_be(:topic3) { create(:topic, name: "topic3", organization_id: group.organization_id) }
  let_it_be_with_reload(:project_1) { create(:project, group: group, topics: [topic1]) }
  let_it_be_with_reload(:project_2) { create(:project, group: group, topics: [topic2]) }
