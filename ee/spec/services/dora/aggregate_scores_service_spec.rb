...
RSpec.describe Dora::AggregateScoresService, feature_category: :value_stream_management do
  ...
  let_it_be(:topic1, freeze: false) { create(:topic, name: "topic1", organization_id: group.organization_id) }
  let_it_be(:topic2, freeze: false) { create(:topic, name: "topic2", organization_id: group.organization_id) }
  let_it_be(:topic3, freeze: false) { create(:topic, name: "topic3", organization_id: group.organization_id) }
  let_it_be(:project_1, freeze: false) { create(:project, group: group, topics: [topic1]) }
  let_it_be(:project_2, freeze: false) { create(:project, group: group, topics: [topic2]) }
  let_it_be(:project_3, freeze: false) { create(:project, group: group, topics: [topic1, topic2]) }
  let_it_be(:project_4, freeze: false) { create(:project, group: group) }
  let_it_be(:project_5, freeze: false) { create(:project, group: group, name: "Project with no data ever") }
  let_it_be(:project_6, freeze: false) { create(:project, group: group, name: "Project with data in other month") }
