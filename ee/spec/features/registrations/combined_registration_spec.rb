...
RSpec.describe 'Registration group and project creation flow', :with_current_organization, :js, feature_category: :onboarding do
  ...
  let_it_be(:user) do
    create(:user, :with_namespace, onboarding_in_progress: true, organizations: [current_organization])
  end
  ...
  context 'when remove_onboarding_tutorial_pages is enabled' do
    it 'A user can create a group and project reaching the new project page' do
