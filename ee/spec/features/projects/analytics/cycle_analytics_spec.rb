    ...
    context 'as user' do
      ...
      context 'with no value stream' do
        ...
        it 'allows to create a custom value stream' do
          ...
          expect(page).to have_content('Value Stream has been successfully created.')
