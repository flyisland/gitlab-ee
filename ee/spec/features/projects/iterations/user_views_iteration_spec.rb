...
RSpec.describe 'User views iteration', feature_category: :team_planning do
  ...
  let_it_be(:iteration, freeze: false) { create(:iteration, :skip_future_date_validation, iid: 1, id: 2, group: group, title: 'Correct Iteration', start_date: now - 1.day, due_date: now) }
