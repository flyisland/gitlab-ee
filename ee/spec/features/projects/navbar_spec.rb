      ...
      context 'when project is namespaced to a group' do
        ...
        before do
          ...
          insert_before_sub_nav_item(
            _('Error Tracking'),
            within: _('Monitor'),
            new_sub_nav_item_name: s_('Observability|Traces')
          )
          insert_after_sub_nav_item(
            s_('Observability|Traces'),
            within: _('Monitor'),
            new_sub_nav_item_name: s_('Observability|Metrics')
          )
          insert_after_sub_nav_item(
            s_('Observability|Metrics'),
            within: _('Monitor'),
            new_sub_nav_item_name: s_('Observability|Logs')
          )
    ...
    context 'when AI flow triggers are available' do
      before do
        ...
        insert_before_sub_nav_item(
          ...
          new_sub_nav_item_name: s_('DuoAgentsPlatform|Onboarding')
        )
