...
RSpec.describe 'Project settings > Issues', :js, feature_category: :team_planning do
  ...
  context 'when Issues are initially enabled' do
    context 'when Pipelines are initially enabled' do
      ...
      it 'shows the Issues settings' do
        expect(page).to have_content('Set a default description to be used for new work items.')
        ...
        expect(page).not_to have_content('Set a default description to be used for new work items.')
      end
    end
  end
