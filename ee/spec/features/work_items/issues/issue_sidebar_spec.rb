...
RSpec.describe 'Issue Sidebar', :js, :saas, feature_category: :team_planning do
  ...
  context 'with quarantine id 21-2026-05-20',
    quarantine: {
      issue: 'https://gitlab.com/gitlab-org/quality/test-failure-issues/-/work_items/42790',
      type: 'flaky'
    } do
    ...
    it_behaves_like 'user can use agentic chat'
  end
  ...
  describe 'weight' do
    context 'when updating weight' do
      ...
      it 'updates weight in sidebar to no weight by setting an empty value',
        quarantine: {
          issue: 'https://gitlab.com/gitlab-org/quality/test-failure-issues/-/work_items/42790',
          type: 'flaky'
        } do
