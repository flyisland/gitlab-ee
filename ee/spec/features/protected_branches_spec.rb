  ...
  describe 'code owner approval' do
    describe 'when project requires code owner approval' do
      ...
      describe 'protect a branch form' do
        ...
        it 'can create new protected branch with code owner disabled', quarantine: {
          issue: 'https://gitlab.com/gitlab-org/quality/test-failure-issues/-/issues/44329',
          type: :flaky
        } do
        ...
        it 'can create new protected branch with code owner enabled', quarantine: {
          issue: 'https://gitlab.com/gitlab-org/quality/test-failure-issues/-/issues/44329',
          type: :flaky
        } do
          fill_in_form "with-codeowners"
