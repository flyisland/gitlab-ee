...
RSpec.describe 'epics swimlanes', :js, feature_category: :planning_views do
  ...
  let_it_be(:epic1) { create(:epic, group: group, title: 'Beta') }
  let_it_be(:epic2) { create(:epic, group: group, title: 'Alpha') }
