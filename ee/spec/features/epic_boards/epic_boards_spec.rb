...
RSpec.describe 'epic boards', :sidekiq_inline, :js, :saas, feature_category: :portfolio_management do
  ...
  context 'display epics in board' do
    ...
    context 'default' do
      ...
      it 'displays default lists and a label list', quarantine: 'https://gitlab.com/gitlab-org/quality/test-failure-issues/-/work_items/35704' do
      ...
      it 'displays two epics in Open list', quarantine: 'https://gitlab.com/gitlab-org/quality/test-failure-issues/-/work_items/35704' do
      ...
      it 'displays one epic in Label list', quarantine: 'https://gitlab.com/gitlab-org/quality/test-failure-issues/-/work_items/35704' do
      ...
      it 'creates new column for label containing labeled epic', quarantine: 'https://gitlab.com/gitlab-org/quality/test-failure-issues/-/work_items/35704' do
      ...
      it 'moves to the bottom of another list', quarantine: 'https://gitlab.com/gitlab-org/quality/test-failure-issues/-/work_items/35704' do
      ...
      it 'moves to the top of another list', quarantine: 'https://gitlab.com/gitlab-org/quality/test-failure-issues/-/work_items/35704' do
        expect(find_board_list(1)).to have_content(epic3.title)
    ...
    context 'ordering in list using move to position', quarantine: 'https://gitlab.com/gitlab-org/quality/test-failure-issues/-/work_items/35704' do
    ...
    context 'lists' do
      ...
      it 'changes position of list', quarantine: 'https://gitlab.com/gitlab-org/quality/test-failure-issues/-/work_items/35704' do
      ...
      it 'dragging does not duplicate list', quarantine: 'https://gitlab.com/gitlab-org/quality/test-failure-issues/-/work_items/35704' do
      ...
      it 'allows user to delete list from list settings sidebar', quarantine: 'https://gitlab.com/gitlab-org/quality/test-failure-issues/-/work_items/35704' do
  ...
  context 'when user can admin epic boards', quarantine: 'https://gitlab.com/gitlab-org/quality/test-failure-issues/-/work_items/35704' do
    before do
  ...
  context 'when user cannot admin epic boards' do
    ...
    it "does not show 'Create list'", quarantine: 'https://gitlab.com/gitlab-org/quality/test-failure-issues/-/work_items/35704' do
      expect(page).not_to have_selector('[data-testid="boards-create-list"]')
    end

    it 'can view board scope', quarantine: 'https://gitlab.com/gitlab-org/quality/test-failure-issues/-/work_items/35704' do
      view_scope.click
    ...
    it 'does not show Remove list in list settings sidebar', quarantine: 'https://gitlab.com/gitlab-org/quality/test-failure-issues/-/work_items/35704' do
      page.within(find('[data-testid="board-list"]:nth-child(2)')) do
        click_button 'Edit list settings'
      end
  ...
  context 'filtered search' do
    ...
    it 'can select a Label in order to filter the board by not equals', quarantine: 'https://gitlab.com/gitlab-org/quality/test-failure-issues/-/work_items/35704' do
    ...
    it 'can select a Label in order to filter the board by equals', quarantine: 'https://gitlab.com/gitlab-org/quality/test-failure-issues/-/work_items/35704' do
      within_testid('epic-filtered-search') do
        click_button 'Label'
        click_token_equals
        click_button label.title
    ...
    it 'can select an Author in order to filter the board by equals', quarantine: 'https://gitlab.com/gitlab-org/quality/test-failure-issues/-/work_items/35704' do
      within_testid('epic-filtered-search') do
        click_button 'Author'
        click_token_equals
    ...
    it 'can select an Author in order to filter the board by not equals', quarantine: 'https://gitlab.com/gitlab-org/quality/test-failure-issues/-/work_items/35704' do
      within_testid('epic-filtered-search') do
        click_button 'Author'
        click_button '!='
        click_button user.name
    ...
    it 'can search for an epic in the search bar', quarantine: 'https://gitlab.com/gitlab-org/quality/test-failure-issues/-/work_items/35704' do
  ...
  context "when user is navigating via keyboard" do
    ...
    it 'allows user to traverse cards forward and backward across board columns', quarantine: 'https://gitlab.com/gitlab-org/quality/test-failure-issues/-/work_items/35704' do
