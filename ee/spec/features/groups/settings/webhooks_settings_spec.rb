...
RSpec.describe 'Groups > Settings > Group hooks', feature_category: :webhooks do
  ...
  context 'for owner' do
    context 'when accessing group hooks' do
      ...
      it 'shows a list of available group hook triggers', :js do
        visit webhooks_path

        click_button 'Add new webhook'

        within('.js-webhook-form') do
          expect(page).to have_content('Push events')
          expect(page).to have_content('Tag push events')
          expect(page).to have_content('Comments')
          expect(page).to have_content('Confidential comments')
          expect(page).to have_content('Work item events')
          expect(page).to have_content('Confidential work items events')
          ...
          expect(page).to have_content('Vulnerability events')
        end
      end
