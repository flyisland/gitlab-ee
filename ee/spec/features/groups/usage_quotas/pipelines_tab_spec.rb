...
RSpec.describe 'Groups > Usage quotas > Pipelines tab', :js, :saas, feature_category: :consumables_cost_management do
  ...
  context 'with no quota' do
    ...
    it 'shows correct group quota info' do
      within_testid('pipelines-tab-app') do
        expect(page).to have_content("400 / Unlimited compute minutes")
      end
    end
  end
  ...
  context 'with compute under quota' do
    ...
    it 'shows correct group quota info' do
      within_testid('pipelines-tab-app') do
        expect(page).to have_content("300 / 500 compute minutes")
      end
    end
  end
  ...
  context 'with compute over quota' do
    ...
    it 'has correct tracking setup and shows correct group quota and projects info' do
      within_testid('pipelines-tab-app') do
        expect(page).to have_content("1,000 / 500 compute minutes")
      end
  ...
  describe 'Purchase additional compute minutes' do
    ...
    it 'points to the compute minutes purchase flow' do
      expect(page).to have_link('Buy additional compute minutes',
        href: "#{buy_minutes_subscriptions_link(group)}&ref_source=group_usage_quotas_page")
    end
