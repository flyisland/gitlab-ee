...
FactoryBot.modify do
  factory :project do
    ...
    trait :with_product_analytics_dashboard_with_views do
      repository

      after(:create) do |project|
        dashboard = 'dashboard_example_with_views'
        project.repository.create_file(
          project.creator,
          ".gitlab/analytics/dashboards/#{dashboard}/#{dashboard}.yaml",
          File.open(Rails.root.join("ee/spec/fixtures/analytics/#{dashboard}.yaml")).read,
        ...
        project.repository.create_file(
          project.creator,
          '.gitlab/analytics/dashboards/visualizations/dora_line_chart.yaml',
          File.open(Rails.root.join('ee/spec/fixtures/analytics/dora_line_chart.yaml')).read,
          message: 'test',
          branch_name: 'master'
        )
        ...
        project.repository.create_file(
          project.creator,
          '.gitlab/analytics/dashboards/visualizations/dora_bar_chart.yaml',
          File.open(Rails.root.join('ee/spec/fixtures/analytics/dora_bar_chart.yaml')).read,
          message: 'test',
          branch_name: 'master'
        )
      end
