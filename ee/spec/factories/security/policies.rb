...
FactoryBot.define do
  ...
  factory :dependency_firewall_policy,
    class: Struct.new(:name, :description, :enforcement_type, :enabled, :rules, :bypass_settings) do
    skip_create
    ...
    initialize_with do
      ...
      new(name, description, enforcement_type, enabled, rules, bypass_settings).to_h
    end
