...
RSpec.describe Boards::EpicBoardPosition, feature_category: :planning_views do
  ...
  describe 'validations' do
    subject(:board_position) { build(:epic_board_position) }

    specify { expect(board_position).to be_valid }

    it 'is valid with nil relative position' do
      board_position.relative_position = nil

      expect(board_position).to be_valid
    end
