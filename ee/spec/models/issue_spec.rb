...
RSpec.describe Issue, feature_category: :team_planning do
  ...
  context 'scopes' do
    describe 'health status' do
      let_it_be(:on_track, freeze: false) { create(:issue, health_status: :on_track) }
      let_it_be(:needs_attention, freeze: false) { create(:issue, health_status: :needs_attention) }
      let_it_be(:at_risk, freeze: false) { create(:issue, health_status: :at_risk) }
      let_it_be(:without_health_status, freeze: false) { create(:issue, health_status: nil) }
    ...
    describe '.for_requirement_iids' do
      ...
      let_it_be(:requirement1, freeze: false) { create(:work_item, :requirement, project: project).requirement }
      let_it_be(:requirement2, freeze: false) { create(:work_item, :requirement, project: project).requirement }
      let_it_be(:requirement3, freeze: false) { create(:work_item, :requirement, project: project).requirement }
      let_it_be(:requirement4, freeze: false) { create(:work_item, :requirement, project: project).requirement }
    ...
    describe '.on_status_page' do
      let_it_be(:status_page_setting, freeze: false) { create(:status_page_setting, :enabled) }
      let_it_be(:project, freeze: false) { status_page_setting.project }
      let_it_be(:published_issue, freeze: false) { create(:issue, :published, project: project) }
      let_it_be(:confidential_issue, freeze: false) { create(:issue, :published, :confidential, project: project) }
      let_it_be(:nonpublished_issue, freeze: false) { create(:issue, project: project) }
    ...
    describe '.with_feature' do
      ...
      let_it_be(:test_case, freeze: false) { create(:quality_test_case, project: project) }
    ...
    context 'epics' do
      ...
      let_it_be(:issue1, freeze: false) { create(:issue) }
      let_it_be(:issue2, freeze: false) { create(:issue) }
      let_it_be(:epic_issue1, freeze: false) { create(:epic_issue, epic: epic1, issue: issue1, relative_position: 2) }
      let_it_be(:epic_issue2, freeze: false) { create(:epic_issue, epic: epic2, issue: issue2, relative_position: 1) }
      let_it_be(:issue_no_epic, freeze: false) { create(:issue) }
      ...
      describe '.distinct_epic_ids' do
        ...
        context 'when issues are grouped by labels' do
          let_it_be(:label_link1, freeze: false) { create(:label_link, target: epic_issue1.issue) }
          let_it_be(:label_link2, freeze: false) { create(:label_link, target: epic_issue1.issue) }
    ...
    context 'iterations' do
      let_it_be(:iteration1, freeze: false) { create(:iteration, :with_title) }
      let_it_be(:iteration2, freeze: false) { create(:iteration) }
      let_it_be(:iteration1_issue, freeze: false) { create(:issue, iteration: iteration1) }
      let_it_be(:iteration2_issue, freeze: false) { create(:issue, iteration: iteration2) }
      let_it_be(:issue_no_iteration, freeze: false) { create(:issue) }
    ...
    context 'status page published' do
      let_it_be(:not_published, freeze: false) { create(:issue) }
      let_it_be(:published, freeze: false)     { create(:issue, :published) }
    ...
    context 'sla due at' do
      let_it_be(:project, freeze: false) { create(:project) }
      let_it_be(:sla_due_first, freeze: false) { create(:issue, project: project) }
      let_it_be(:sla_due_last, freeze: false)  { create(:issue, project: project) }
      let_it_be(:no_sla, freeze: false) { create(:issue, project: project) }
    ...
    describe '.with_status' do
      let_it_be(:to_do_issue, freeze: false) { create(:issue) }
      let_it_be(:to_do_current_status, freeze: false) { create(:work_item_current_status, work_item_id: to_do_issue.id) }

      let_it_be(:in_progress_issue, freeze: false) { create(:issue) }
      let_it_be(:in_progress_current_status, freeze: false) do
  ...
  describe 'validations' do
    ...
    describe 'confidential' do
      let_it_be(:epic, freeze: false) { create(:epic, :confidential) }
  ...
  describe '#sort' do
    ...
    context 'by blocking issues' do
      let_it_be(:issue_1, freeze: false) { create(:issue, blocking_issues_count: 3) }
      let_it_be(:issue_2, freeze: false) { create(:issue, blocking_issues_count: 1) }
  ...
  context 'ES related specs', :elastic do
    ...
    context 'when updating an Issue' do
      ...
      let_it_be(:system_note, freeze: false) { create(:note, :system, noteable: issue, project: project) }
  ...
  describe "#blocked_by_issues" do
    ...
    let_it_be(:project, freeze: false) { create(:project) }
    let_it_be(:issue, freeze: false) { create(:issue, project: project) }
    let_it_be(:blocking_issue, freeze: false) { create(:issue, project: project) }
    let_it_be(:other_project_blocking_issue, freeze: false) { create(:issue) }
    let_it_be(:blocked_by_issue, freeze: false) { create(:issue, project: project) }
    let_it_be(:confidential_blocked_by_issue, freeze: false) { create(:issue, :confidential, project: project) }
    let_it_be(:related_issue, freeze: false) { create(:issue, project: project) }
    let_it_be(:closed_blocking_issue, freeze: false) { create(:issue, project: project, state: :closed) }
  ...
  context 'when changing state of blocking issues' do
    let_it_be(:project, freeze: false) { create(:project) }
    let_it_be(:blocking_issue1, freeze: false) { create(:issue, project: project) }
    let_it_be(:blocking_issue2, freeze: false) { create(:issue, project: project) }
    let_it_be(:blocked_issue, freeze: false) { create(:issue, project: project) }
    let_it_be(:blocked_by_blocked_issue, freeze: false) { create(:issue, project: project) }
  ...
  describe '#issue_type_supports?' do
    ...
    let_it_be(:test_case, freeze: false) { create(:quality_test_case) }
    let_it_be(:incident, freeze: false) { create(:incident) }
    let_it_be(:ticket, freeze: false) { create(:work_item, :ticket) }
  ...
  describe '#related_feature_flags' do
    ...
    let_it_be(:authorized_project, freeze: false) { create(:project) }
    let_it_be(:authorized_project2, freeze: false) { create(:project) }
    let_it_be(:unauthorized_project, freeze: false) { create(:project) }

    let_it_be(:issue, freeze: false) { create(:issue, project: authorized_project) }

    let_it_be(:authorized_feature_flag, freeze: false) { create(:operations_feature_flag, project: authorized_project) }
    let_it_be(:authorized_feature_flag_b, freeze: false) { create(:operations_feature_flag, project: authorized_project2) }

    let_it_be(:unauthorized_feature_flag, freeze: false) { create(:operations_feature_flag, project: unauthorized_project) }

    let_it_be(:issue_link_a, freeze: false) { create(:feature_flag_issue, issue: issue, feature_flag: authorized_feature_flag) }
    let_it_be(:issue_link_b, freeze: false) { create(:feature_flag_issue, issue: issue, feature_flag: unauthorized_feature_flag) }
    let_it_be(:issue_link_c, freeze: false) { create(:feature_flag_issue, issue: issue, feature_flag: authorized_feature_flag_b) }
  ...
  describe "#has_parent_link?" do
    let_it_be(:project, freeze: false) { create(:project) }
    let_it_be(:work_item_epic, freeze: false) { create(:work_item, :epic, project: project) }
    let_it_be(:work_item_issue, freeze: false) { create(:work_item, :issue, project: project) }
    let_it_be(:issue, freeze: false) { described_class.find(work_item_issue.id) }
    ...
    context 'when issue has an epic synced to a work item' do
      let_it_be(:legacy_epic, freeze: false) { create(:epic, :with_synced_work_item) }
  ...
  describe '#elastic_reference' do
    ...
    let_it_be(:issue, freeze: false) { create(:issue, namespace: namespace) }
