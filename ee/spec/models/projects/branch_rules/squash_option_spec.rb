...
RSpec.describe Projects::BranchRules::SquashOption, feature_category: :source_code_management do
  ...
  describe 'Validations' do
    ...
    describe 'for base' do
      ...
      context 'when protected_branch is a wildcard' do
        let(:protected_branch) { build(:protected_branch, name: 'feature-*', project: project) }

        it 'adds a wildcard error to base' do
