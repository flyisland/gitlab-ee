...
RSpec.describe IncidentManagement::PendingEscalations::Issue, feature_category: :incident_management do
  let_it_be(:pending_escalation, freeze: false) { create(:incident_management_pending_issue_escalation) }
  ...
  describe '#escalatable' do
    let_it_be(:escalatable, freeze: false) do
      create(:incident_management_issuable_escalation_status, issue: pending_escalation.issue)
    end
