...
RSpec.describe MergeRequests::ExternalStatusCheck, type: :model do
  ...
  describe 'applicable_to_branch' do
    ...
    let_it_be(:check_belonging_to_different_project, freeze: false) { create(:external_status_check) }
    let_it_be(:check_with_no_protected_branches, freeze: false) { create(:external_status_check, project: merge_request.project, protected_branches: []) }
    let_it_be(:check_with_applicable_protected_branches, freeze: false) { create(:external_status_check, project: merge_request.project, protected_branches: [create(:protected_branch, name: merge_request.target_branch, project: merge_request.project)]) }
    let_it_be(:check_with_non_applicable_protected_branches, freeze: false) { create(:external_status_check, project: merge_request.project, protected_branches: [create(:protected_branch, name: 'testbranch', project: merge_request.project)]) }
