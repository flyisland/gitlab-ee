...
RSpec.describe Dast::Branch, :dynamic_analysis,
  ...
  context 'when repository does not exist' do
    let_it_be(:dast_profile, freeze: false) { create(:dast_profile) }
  ...
  context 'when repository exists' do
    let_it_be(:dast_profile, freeze: false) { create(:dast_profile, branch_name: 'orphaned-branch', project: create(:project, :repository)) }
