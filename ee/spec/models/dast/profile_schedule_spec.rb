  ...
  describe 'validate' do
    describe 'validate_plan_limit_not_exceeded_while_activating' do
      ...
      context 'when the plan limit has been exceeded' do
        let_it_be(:inactive_schedule, freeze: false) { create(:dast_profile_schedule, project: project, dast_profile: create(:dast_profile), active: false) }
