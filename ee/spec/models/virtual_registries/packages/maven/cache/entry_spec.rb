...
RSpec.describe VirtualRegistries::Packages::Maven::Cache::Entry, type: :model, feature_category: :virtual_registry do
  ...
  describe 'scopes' do
    let_it_be(:cache_entry1, freeze: false) { create(:virtual_registries_packages_maven_cache_entry) }
    let_it_be(:cache_entry2, freeze: false) { create(:virtual_registries_packages_maven_cache_entry) }
    let_it_be(:cache_entry3, freeze: false) { create(:virtual_registries_packages_maven_cache_entry) }
  ...
  describe '.next_pending_destruction' do
    ...
    let_it_be(:cache_entry, freeze: false) { create(:virtual_registries_packages_maven_cache_entry) }
  ...
  context 'with loose foreign key on virtual_registries_packages_maven_cache_entries.upstream_id' do
    it_behaves_like 'update by a loose foreign key' do
      let_it_be(:parent, freeze: false) { create(:virtual_registries_packages_maven_upstream) }
      let_it_be(:model, freeze: false) { create(:virtual_registries_packages_maven_cache_entry, upstream: parent) }
