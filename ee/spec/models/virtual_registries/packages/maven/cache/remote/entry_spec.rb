...
RSpec.describe VirtualRegistries::Packages::Maven::Cache::Remote::Entry, :aggregate_failures, feature_category: :virtual_registry do
  ...
  it_behaves_like 'virtual registries remote entries models',
    ...
    inverted_cache_association_name: :cache_entries
  ...
  describe 'scopes' do
    let_it_be(:cache_entry1, freeze: false) { create(:virtual_registries_packages_maven_cache_remote_entry) }
    let_it_be(:cache_entry2, freeze: false) { create(:virtual_registries_packages_maven_cache_remote_entry) }
  ...
  describe '.next_pending_destruction' do
    ...
    let_it_be(:cache_entry, freeze: false) { create(:virtual_registries_packages_maven_cache_remote_entry) }
