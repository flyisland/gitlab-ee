...
RSpec.describe VirtualRegistries::Container::Cache::Remote::Entry, :aggregate_failures, feature_category: :virtual_registry do
  ...
  describe 'scopes' do
    let_it_be(:cache_entry1, freeze: false) { create(:virtual_registries_container_cache_remote_entry) }
    let_it_be(:cache_entry2, freeze: false) { create(:virtual_registries_container_cache_remote_entry) }
    let_it_be(:cache_entry3, freeze: false) { create(:virtual_registries_container_cache_remote_entry) }
  ...
  describe '.next_pending_destruction' do
    ...
    let_it_be(:cache_entry, freeze: false) { create(:virtual_registries_container_cache_remote_entry) }
    let_it_be(:pending_destruction_cache_entry, freeze: false) do
  ...
  describe '.search_by_relative_path' do
    let_it_be(:cache_entry, freeze: false) { create(:virtual_registries_container_cache_remote_entry) }
    let_it_be(:other_cache_entry, freeze: false) do
  ...
  describe '#generate_id' do
    let_it_be(:upstream, freeze: false) { create(:virtual_registries_container_upstream) }
    let_it_be(:cache_entry, freeze: false) { create(:virtual_registries_container_cache_remote_entry, upstream:) }
  ...
  context 'with loose foreign key on virtual_registries_container_cache_remote_entries.upstream_id' do
    it_behaves_like 'update by a loose foreign key' do
      let_it_be(:parent, freeze: false) { create(:virtual_registries_container_upstream) }
      let_it_be(:model, freeze: false) { create(:virtual_registries_container_cache_remote_entry, upstream: parent) }
