  ...
  describe 'when changing parent_id' do
    ...
    context 'when elastic indexing is enabled' do
      ...
      describe 'when transfering a project' do
        ...
        let_it_be(:user, freeze: false) { create(:user) }
        let_it_be(:member, freeze: false) { create(:project_member, :owner, project: project, user: user) }
        let_it_be(:group_member, freeze: false) { create(:group_member, :owner, group: group, user: user) }
