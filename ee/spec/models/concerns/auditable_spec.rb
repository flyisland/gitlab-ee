...
RSpec.describe Auditable, feature_category: :compliance_management do
  ...
  describe 'approval_project_rule' do
    it_behaves_like 'auditable concern' do
      let_it_be(:instance, freeze: false) { create(:approval_project_rule) }
    end
  end

  describe 'external_status_check' do
    it_behaves_like 'auditable concern' do
      let_it_be(:instance, freeze: false) { create(:external_status_check) }
    end
  end

  describe 'packages_package' do
    let_it_be(:instance, freeze: false) { create(:generic_package) }
  ...
  describe 'security_policy' do
    it_behaves_like 'auditable concern' do
      let_it_be(:instance, freeze: false) { create(:security_policy) }
    end
  end

  describe 'merge_request' do
    let_it_be(:instance, freeze: false) { create(:merge_request) }
