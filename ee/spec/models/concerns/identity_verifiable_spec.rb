...
RSpec.describe IdentityVerifiable, :saas, feature_category: :instance_resiliency do
  ...
  describe '#identity_verification_exempt?' do
    ...
    context 'when a user is a Developer on a subgroup but only a Guest at the root of a paid namespace' do
      ...
      context 'when the identity_verification_paid_subgroup_membership feature flag is disabled' do
        before do
          stub_feature_flags(
            identity_verification_paid_subgroup_membership: false,
            identity_verification_paid_membership: false
          )
        end
      ...
      context 'when the identity_verification_paid_subgroup_membership feature flag is enabled' do
        before do
          stub_feature_flags(
            identity_verification_paid_subgroup_membership: true,
            identity_verification_paid_membership: false
          )
        end
