...
RSpec.describe Namespace, feature_category: :groups_and_projects do
    ...
    describe '.with_ai_supported_plan', :saas do
      ...
      context 'with a credits-eligible feature' do
        ...
        context 'when filter_projects_by_duo_licensed_feature flag is disabled' do
          ...
          it 'does not include free_group (credits ignored, falls back to plan check)' do
            is_expected.not_to include(free_group)
          end
        end
      end
    end
  ...
  describe '#eligible_for_trial?' do
    ...
    with_them do
      before do
        ...
        allow(namespace).to receive_messages(has_parent?: has_parent, never_had_trial?: never_had_trial,
  ...
  describe '#remove_foundational_flow_consumers' do
    let_it_be(:namespace) { create(:group) }
    let_it_be(:flow) do
      create(:ai_catalog_item, :with_foundational_flow_reference, public: true, organization: namespace.organization)
    end
