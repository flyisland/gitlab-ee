...
RSpec.describe ::LfsObject, feature_category: :source_code_management do
  describe '.search' do
    let_it_be(:lfs_object1, freeze: false) { create(:lfs_object) }
    let_it_be(:lfs_object2, freeze: false) { create(:lfs_object) }
    let_it_be(:lfs_object3, freeze: false) { create(:lfs_object) }
