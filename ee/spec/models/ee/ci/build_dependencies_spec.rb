  ...
  context 'for cross_project dependencies' do
    ...
    context 'with cross_dependencies to a pipeline in another project' do
      ...
      context 'with permissions to other_project' do
        ...
        context 'when the other project belongs to a different organization' do
          let(:other_organization) { create(:organization) }

          before do
            other_project.namespace.update!(organization: other_organization)
            other_project.project_namespace.update!(organization: other_organization)
            other_project.update!(organization: other_organization)
          end
