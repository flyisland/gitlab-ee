...
RSpec.describe NamespaceStatistics, feature_category: :consumables_cost_management do
  include WikiHelpers
  ...
  describe '#update_storage_size' do
    let_it_be_with_reload(:statistics) { create(:namespace_statistics, namespace: group, dependency_proxy_size: 2, storage_size: 2) }
  ...
  describe '#update_dependency_proxy_size' do
    let_it_be(:statistics, freeze: false) { create(:namespace_statistics, namespace: group) }
