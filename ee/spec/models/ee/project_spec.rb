...
RSpec.describe Project, feature_category: :groups_and_projects do
  ...
  describe '#predefined_push_rule' do
    ...
    context 'when read_project_push_rules is enabled' do
      ...
      context 'when project has a project_push_rule' do
        let!(:project_push_rule) { create(:project_push_rule, project: project) }

        it 'returns the project_push_rule' do
          expect(project.predefined_push_rule).to eq(project_push_rule)
        end
      end
    end
    ...
    context 'when read_project_push_rules is disabled' do
      ...
      context 'when project has a project_push_rule and a push_rule' do
        let!(:project_push_rule) { create(:project_push_rule, project: project) }
        ...
        it 'returns push_rule, not project_push_rule' do
          expect(project.predefined_push_rule).to eq(push_rule)
        end
      end
    end
  end
  ...
  describe '#execute_flow_triggers' do
    ...
    describe 'with a flow trigger' do
      ...
      context 'when flow trigger has a foundational flow precondition' do
        ...
        let_it_be(:item_consumer) { create(:ai_catalog_item_consumer, :child_item_consumer, project: project, item: item) }
