...
RSpec.describe Project, feature_category: :groups_and_projects do
  ...
  describe 'associations' do
    ...
    describe '#dependency_management_service_account' do
      ...
      let_it_be(:dep_mgmt_service_account, freeze: false) do
      ...
      let!(:other_project_service_account) do
        create(:service_account,
    ...
    context 'when deleting security policy project' do
      ...
      let_it_be(:policy_configuration, freeze: false) { create(:security_orchestration_policy_configuration, security_policy_management_project: policy_management_project, project: project) }
  ...
  context 'scopes' do
    ...
    describe '.by_ids' do
      ...
      let_it_be(:project_3, freeze: false) { create(:project) }
    ...
    describe 'jira_subscription_exists?' do
      let_it_be(:project, freeze: false) { create(:project) }
      let_it_be(:jira_connect_subscription, freeze: false) { create(:jira_connect_subscription, namespace: project.namespace) }
    ...
    describe '.order_by_excess_repo_storage_size_desc' do
      let_it_be(:project_1, freeze: false) { create(:project_statistics, lfs_objects_size: 10, repository_size: 10).project }
      let_it_be(:project_2, freeze: false) { create(:project_statistics, lfs_objects_size: 5, repository_size: 55).project }
      let_it_be(:project_3, freeze: false) { create(:project, repository_size_limit: 30, statistics: create(:project_statistics, lfs_objects_size: 8, repository_size: 32)) }
    ...
    describe '.with_feature_available', :saas do
      ...
      let_it_be(:ultimate_group, freeze: false) { create(:group_with_plan, :private, plan: :ultimate_plan) }
      let_it_be(:ultimate_subgroup, freeze: false) { create(:group, :private, parent: ultimate_group) }
      let_it_be(:another_ultimate_group, freeze: false) { create(:group_with_plan, :private, plan: :ultimate_plan) }
      let_it_be(:another_ultimate_subgroup, freeze: false) { create(:group, :private, parent: another_ultimate_group) }
      let_it_be(:premium_group, freeze: false) { create(:group_with_plan, :private, plan: :premium_plan) }
      let_it_be(:premium_subgroup, freeze: false) { create(:group, :private, parent: premium_group) }
      let_it_be(:no_plan_group, freeze: false) { create(:group_with_plan, :public, plan: nil) }
      let_it_be(:no_plan_subgroup, freeze: false) { create(:group, :public, parent: no_plan_group) }
      let_it_be(:ultimate_project, freeze: false) { create(:project, :private, :archived, creator: user, namespace: ultimate_group) }
      let_it_be(:premium_project, freeze: false) { create(:project, :private, :archived, creator: user, namespace: premium_group) }
      let_it_be(:no_plan_public_project, freeze: false) { create(:project, :public, :archived, creator: user, namespace: no_plan_group) }
      let_it_be(:ultimate_subgroup_project, freeze: false) { create(:project, :private, :archived, creator: user, namespace: ultimate_subgroup) }
      let_it_be(:another_ultimate_subgroup_project, freeze: false) { create(:project, :private, :archived, creator: user, namespace: another_ultimate_subgroup) }
      let_it_be(:premium_subgroup_project, freeze: false) { create(:project, :private, :archived, creator: user, namespace: premium_subgroup) }
      let_it_be(:no_plan_private_project, freeze: false) { create(:project, :private, :archived, creator: user, namespace: no_plan_group) }
      let_it_be(:no_plan_subgroup_private_project, freeze: false) { create(:project, :private, :archived, creator: user, namespace: no_plan_subgroup) }
    ...
    context 'compliance framework scopes' do
      ...
      let_it_be(:project_with_framework_1, freeze: false) { create(:project, group: namespace) }
      let_it_be(:project_with_framework_2, freeze: false) { create(:project, group: namespace) }
      let_it_be(:project_without_framework, freeze: false) { create(:project, group: namespace) }
      let_it_be(:framework_1, freeze: false) { create(:compliance_framework, namespace: namespace, name: 'Test1') }
      let_it_be(:framework_2, freeze: false) { create(:compliance_framework, namespace: namespace, name: 'Test2') }
      let_it_be(:framework_3, freeze: false) { create(:compliance_framework, namespace: namespace, name: 'Test3') }
      let_it_be(:framework_settings_1, freeze: false) { create(:compliance_framework_project_setting, project: project_with_framework_1, compliance_management_framework: framework_1) }
      let_it_be(:framework_settings_2, freeze: false) { create(:compliance_framework_project_setting, project: project_with_framework_2, compliance_management_framework: framework_2) }
      ...
      describe '.compliance_framework_id_in' do
        ...
        context 'when a project has more than one frameworks and both are used as filters' do
          let_it_be(:framework_settings_3, freeze: false) { create(:compliance_framework_project_setting, project: project_with_framework_1, compliance_management_framework: framework_2) }
      ...
      describe '.compliance_framework_id_not_in' do
        ...
        context 'when a project has multiple compliance frameworks' do
          let_it_be(:framework_settings_1, freeze: false) { create(:compliance_framework_project_setting, project: project_with_framework_1, compliance_management_framework: framework_2) }
      ...
      describe '.any_compliance_framework' do
        ...
        let_it_be(:additional_framework_for_project_2, freeze: false) do
    ...
    describe '.preload_for_indexing' do
      let_it_be(:primary_project, freeze: false) { create(:project, :empty_repo, :mirror) }
    ...
    describe '.without_zoekt_repositories_for_index' do
      let_it_be(:not_indexed_project, freeze: false) { create(:project) }
      let_it_be(:zoekt_index_1, freeze: false) { create(:zoekt_index) }
      let_it_be(:zoekt_index_2, freeze: false) { create(:zoekt_index) }
      let_it_be(:zoekt_repository_1, freeze: false) { create(:zoekt_repository, zoekt_index: zoekt_index_1) }
      let_it_be(:indexed_project_1, freeze: false) { zoekt_repository_1.project }

      # Project indexed in a different index but not in index_1
      let_it_be(:zoekt_repository_2, freeze: false) { create(:zoekt_repository, zoekt_index: zoekt_index_2) }
      let_it_be(:indexed_project_2, freeze: false) { zoekt_repository_2.project }

      # Project indexed in both indices
      let_it_be(:zoekt_repository_3, freeze: false) do
      ...
      context 'with multiple projects' do
        let_it_be(:additional_projects, freeze: false) { create_list(:project, 3) }
    ...
    describe '.without_security_setting' do
      let_it_be(:project_with_security_setting, freeze: false) { create(:project) }
      let_it_be(:project_without_security_setting, freeze: false) { create(:project) }
  ...
  describe '#push_rule' do
    ...
    let_it_be(:project, freeze: false) { create(:project) }
    let_it_be(:push_rule, freeze: false) { create(:push_rule, project: project) }
  ...
  context 'merge requests related settings' do
    ...
    describe '#require_reauthentication_to_approve?' do
      ...
      let_it_be(:sub_group, freeze: false) { create(:group, parent: root_ancestor) }
  ...
  describe '#shared_runners_limit_namespace' do
    let_it_be(:root_ancestor, freeze: false) { create(:group) }
    let_it_be(:group, freeze: false) { create(:group, parent: root_ancestor) }
  ...
  describe '#latest_ingested_security_pipeline' do
    let_it_be_with_refind(:project) { create(:project) }
    let_it_be(:pipeline_1, freeze: false) { create(:ee_ci_pipeline, :with_dast_report, :success, project: project) }
    let_it_be(:pipeline_2, freeze: false) { create(:ee_ci_pipeline, project: project) }
    let_it_be(:pipeline_3, freeze: false) { create(:ee_ci_pipeline, :success, project: project) }
  ...
  describe "#latest_pipeline_with_reports_for_ref" do
    ...
    context "when pipeline ref is non-default branch" do
      ...
      let_it_be(:pipeline_1, freeze: false) { create(:ee_ci_pipeline, :with_sast_report, project: project, ref: merge_request.target_branch) }
      let_it_be(:pipeline_2, freeze: false) { create(:ee_ci_pipeline, :with_sast_report, project: project, ref: merge_request.target_branch) }
      let_it_be(:pipeline_3, freeze: false) { create(:ee_ci_pipeline, :with_dependency_scanning_report, project: project, ref: merge_request.target_branch) }
      let_it_be(:pipeline_4, freeze: false) { create(:ee_ci_pipeline, :with_sast_report, project: project) }
      ...
      context 'when reports are found' do
        ...
        context 'and one of the pipelines has not yet completed' do
          let_it_be(:pipeline_5, freeze: false) { create(:ee_ci_pipeline, :with_sast_report, project: project, ref: merge_request.target_branch, status: :running) }
  ...
  describe '#security_reports_up_to_date_for_ref?' do
    ...
    context 'when the target branch security reports are out of date' do
      let_it_be(:bad_pipeline, freeze: false) { create(:ee_ci_pipeline, :failed, project: project, ref: merge_request.target_branch) }
  ...
  describe '#after_import' do
    ...
    context 'elasticsearch indexing' do
      let_it_be(:import_state, freeze: false) { create(:import_state, project: project) }
    ...
    context 'foundational flows sync' do
      ...
      let_it_be(:user, freeze: false) { create(:user) }
      let_it_be(:project, freeze: false) { create(:project, group: group, creator: user) }
      let_it_be(:import_state, freeze: false) { create(:import_state, project: project) }
      ...
      context 'when project does not belong to a group' do
        let_it_be(:project, freeze: false) { create(:project, namespace: create(:user).namespace) }
  ...
  describe '#sync_foundational_flows_after_import' do
    ...
    context 'when project has no group' do
      let_it_be(:project, freeze: false) { create(:project, namespace: create(:user).namespace, creator: user) }
  ...
  describe '#knowledge_graph_indexing_enabled?', feature_category: :knowledge_graph do
    ...
    context 'when the root namespace has knowledge graph enabled' do
      ...
      it 'returns true' do
        expect(project.knowledge_graph_indexing_enabled?).to eq(true)
      end
    end

    context 'when the root namespace does not have knowledge graph enabled' do
      it 'returns false' do
        expect(project.knowledge_graph_indexing_enabled?).to eq(false)
      end
    end
  end
  ...
  describe '#add_import_job' do
    let_it_be(:user, freeze: false) { create(:user) }
    let_it_be(:mirroring_params, freeze: false) { { mirror: true, import_url: 'http://some_url.com', mirror_user_id: user.id } }
    ...
    context 'when mirror true on a jira imported project' do
      let_it_be(:project, freeze: false) { create(:project, :repository, import_type: 'jira', mirror: true, import_url: 'http://some_url.com', mirror_user_id: user.id) }
      let_it_be(:jira_import, freeze: false) { create(:jira_import_state, project: project) }
  ...
  describe '#repository_size_excess' do
    ...
    let_it_be(:statistics, freeze: false) { create(:project_statistics) }
    let_it_be(:project, freeze: false) { statistics.project }
  ...
  describe '#license_compliance' do
    ...
    context 'when pipeline is present' do
      let_it_be(:project, freeze: false) { create(:project) }
      let_it_be(:pipeline, freeze: false) { create(:ci_pipeline, project: project, ref: 'main') }
      ...
      context 'when pipeline is a merge request pipeline' do
        let_it_be(:merge_request, freeze: false) { create(:merge_request, target_branch: 'release', source_project: project) }
        let_it_be(:pipeline, freeze: false) { create(:ci_pipeline, project: project, merge_request_id: merge_request.id) }
      ...
      context 'when pipeline is a branch pipeline with an associated merge request' do
        ...
        context 'when multiple merge requests are associated' do
          let_it_be(:older_merge_request, freeze: false) do
  ...
  describe '#template_source?' do
    ...
    let_it_be(:project_template, freeze: false) { create(:project, group: subgroup) }
  ...
  describe '#all_available_runners' do
    ...
    let_it_be(:instance_runner, freeze: false) { create(:ci_runner, :instance) }
    let_it_be(:group_runner, freeze: false) { create(:ci_runner, :group, groups: [project.group]) }
    let_it_be(:project_runner, freeze: false) { create(:ci_runner, :project, projects: [project]) }
  ...
  describe '#affected_by_security_policy_management_project?' do
    ...
    let_it_be(:spp_project, freeze: false) { create(:project, :repository) }
    let_it_be(:other_spp_project, freeze: false) { create(:project, :repository) }
    ...
    context 'when security orchestration policy is configured for project' do
      let_it_be(:project, freeze: false) { create(:project) }
      let_it_be(:project_security_orchestration_policy_configuration, freeze: false) do
        create(:security_orchestration_policy_configuration, project: project,
    ...
    context 'when security orchestration policy is configured for a parent namespace' do
      ...
      let_it_be(:project, freeze: false) { create(:project, group: child_group) }

      let_it_be(:parent_group_security_orchestration_policy_configuration, freeze: false) do
  ...
  describe '#all_security_orchestration_policy_configurations' do
    ...
    context 'when security orchestration policy is configured for namespaces and project' do
      let_it_be(:parent_group, freeze: false) { create(:group) }
      let_it_be(:child_group, freeze: false) { create(:group, parent: parent_group) }
      let_it_be(:child_group_2, freeze: false) { create(:group, parent: child_group) }
      let_it_be_with_refind(:project) { create(:project, group: child_group_2) }

      let_it_be(:parent_security_orchestration_policy_configuration, freeze: false) { create(:security_orchestration_policy_configuration, :namespace, namespace: parent_group) }
      let_it_be(:child_security_orchestration_policy_configuration, freeze: false) { create(:security_orchestration_policy_configuration, :namespace, namespace: child_group) }
      let_it_be(:child_security_orchestration_policy_configuration_2, freeze: false) { create(:security_orchestration_policy_configuration, :namespace, namespace: child_group_2) }
  ...
  describe '#dormant?' do
    context 'when Gitlab.com', :saas do
      ...
      context 'when project belongs to free namespace' do
        let_it_be(:no_plan_group, freeze: false) { create(:group_with_plan, plan: nil) }
  ...
  describe '#epic_ids_referenced_by_issues' do
    ...
    let_it_be(:epic1, freeze: false) { create(:epic, group: group) }
    let_it_be(:epic2, freeze: false) { create(:epic, group: subgroup) }
    let_it_be(:unrelated_epic, freeze: false) { create(:epic, group: subgroup) }
    let_it_be(:epic_issue1, freeze: false) { create(:epic_issue, epic: epic1, issue: issue1) }
    let_it_be(:epic_issue2, freeze: false) { create(:epic_issue, epic: epic2, issue: issue2) }
  ...
  describe '#project_epics_enabled?' do
    let_it_be(:project_in_group, freeze: false) { create(:project, :in_group) }
    let_it_be(:group, freeze: false) { project_in_group.group }
  ...
  describe '#security_policy_bot' do
    ...
    context "when there is a security_policy_bot" do
      let_it_be(:security_policy_bot, freeze: false) { create(:user, :security_policy_bot) }
  ...
  describe '#github_external_pull_request_pipelines_available?' do
    let_it_be(:project, freeze: false) { create(:project, :mirror) }
  ...
  describe '#compliance_management_frameworks_names' do
    let_it_be(:project, freeze: false) { create(:project, :with_multiple_compliance_frameworks) }
  ...
  describe '#compliance_framework_ids' do
    ...
    let_it_be(:project, freeze: false) { create(:project) }
    let_it_be(:compliance_framework_1, freeze: false) { create(:compliance_framework_project_setting, project: project) }
    let_it_be(:compliance_framework_2, freeze: false) { create(:compliance_framework_project_setting, :sox, project: project) }
  ...
  describe '#pipeline_configuration_full_path' do
    let_it_be(:namespace, freeze: false) { create(:group) }
    let_it_be(:project, freeze: false) { create(:project, group: namespace) }
    let_it_be(:framework_1_with_pipeline, freeze: false) { create(:compliance_framework, namespace: namespace, name: 'With pipeline 1', pipeline_configuration_full_path: ".compliance-gitlab-ci.yml@test-project-1") }
    let_it_be(:framework_2_with_pipeline, freeze: false) { create(:compliance_framework, namespace: namespace, name: 'With pipeline 2', pipeline_configuration_full_path: ".compliance-gitlab-ci.yml@test-project-2") }
    let_it_be(:framework_1_without_pipeline, freeze: false) { create(:compliance_framework, namespace: namespace, name: 'Without pipeline 1') }
    let_it_be(:framework_2_without_pipeline, freeze: false) { create(:compliance_framework, namespace: namespace, name: 'Without pipeline 2') }

    context 'when the first associated framework has pipeline configuration' do
      let_it_be(:framework_settings_1, freeze: false) { create(:compliance_framework_project_setting, project: project, compliance_management_framework: framework_1_with_pipeline) }
      let_it_be(:framework_settings_2, freeze: false) { create(:compliance_framework_project_setting, project: project, compliance_management_framework: framework_2_with_pipeline) }
    ...
    context 'when no framework has pipeline configuration' do
      let_it_be(:framework_settings_1, freeze: false) { create(:compliance_framework_project_setting, project: project, compliance_management_framework: framework_1_without_pipeline) }
      let_it_be(:framework_settings_2, freeze: false) { create(:compliance_framework_project_setting, project: project, compliance_management_framework: framework_2_without_pipeline) }
    ...
    context 'when initial frameworks do not have pipeline configuration' do
      let_it_be(:framework_settings_1, freeze: false) { create(:compliance_framework_project_setting, project: project, compliance_management_framework: framework_1_without_pipeline) }
      let_it_be(:framework_settings_2, freeze: false) { create(:compliance_framework_project_setting, project: project, compliance_management_framework: framework_2_without_pipeline) }
      let_it_be(:framework_settings_3, freeze: false) { create(:compliance_framework_project_setting, project: project, compliance_management_framework: framework_2_with_pipeline) }
      let_it_be(:framework_settings_4, freeze: false) { create(:compliance_framework_project_setting, project: project, compliance_management_framework: framework_1_with_pipeline) }
  ...
  describe '#security_statistics' do
    ...
    context 'when there is already a `project_security_statistics` for the project' do
      let_it_be(:statistics, freeze: false) { create(:project_security_statistics, project: project) }
  ...
  describe 'Geo replication', feature_category: :geo_replication do
    ...
    describe 'replication/verification' do
      let_it_be(:group_1, freeze: false) { create(:group, organization: create(:organization)) }
      let_it_be(:group_2, freeze: false) { create(:group, organization: create(:organization)) }
      let_it_be(:nested_group_1, freeze: false) { create(:group, parent: group_1) }

      # Project for the root group
      let_it_be(:first_replicable_and_in_selective_sync, freeze: false) { create(:project, group: group_1) }
      # Project for a subgroup
      let_it_be(:second_replicable_and_in_selective_sync, freeze: false) { create(:project, group: nested_group_1) }
      # Project in a shard name that doesn't actually exist
      let_it_be(:last_replicable_and_not_in_selective_sync, freeze: false) { create(:project, :broken_storage, group: group_2) }
  ...
  describe '#auto_duo_code_review_settings_available?' do
    let_it_be(:namespace, freeze: false) { create(:group) }
    let_it_be(:project, freeze: false) { create(:project, group: namespace) }
    let_it_be(:duo_enterprise_add_on, freeze: false) { create(:gitlab_subscription_add_on, :duo_enterprise) }
    let_it_be(:duo_core_add_on, freeze: false) { create(:gitlab_subscription_add_on, :duo_core) }
    let_it_be(:self_hosted_dap_add_on, freeze: false) { create(:gitlab_subscription_add_on, :self_hosted_dap) }
    let_it_be(:code_review_foundational_flow, freeze: false) { create(:ai_catalog_item, :with_foundational_flow_reference) }
  ...
  describe '#container_scanning_for_registry_enabled' do
    context 'when security_setting exists' do
      context 'when container_scanning_for_registry_enabled is true' do
        let_it_be(:security_setting, freeze: false) { create(:project_security_setting, container_scanning_for_registry_enabled: true) }
      ...
      context 'when container_scanning_for_registry_enabled is false' do
        let_it_be(:security_setting, freeze: false) { create(:project_security_setting, container_scanning_for_registry_enabled: false) }
    ...
    context 'when security_setting does not exist' do
      let_it_be(:project, freeze: false) { create(:project, name: 'project-without-security-setting') }
  ...
  describe '#update_security_inventory_filters' do
    let_it_be(:project, freeze: false) { create(:project) }
    let_it_be(:inventory_filter, freeze: false) { create(:security_inventory_filters, project: project) }
  ...
  describe '.public_or_visible_to_user' do
    let_it_be(:user, freeze: false) { create(:user) }
    let_it_be(:role, freeze: false) { create(:admin_member_role, :read_admin_projects, user: user) }

    let_it_be(:private_authorized_project, freeze: false) { create(:project, :private, creator: user) }
    let_it_be(:private_unauthorized_project, freeze: false) { create(:project, :private) } # project the user is not a member of
  ...
  describe '#with_duo_features_enabled' do
    let_it_be(:p_on, freeze: false)  { create(:project, :with_duo_features_enabled) }
    let_it_be(:p_off, freeze: false) { create(:project, :with_duo_features_disabled) }
  ...
  describe '.enabled_flow_catalog_item_ids' do
    let_it_be(:namespace, freeze: false) { create(:group) }
    let_it_be(:project, freeze: false) { create(:project, group: namespace) }
    let_it_be(:catalog_item_1, freeze: false) { create(:ai_catalog_item, :with_foundational_flow_reference) }
    let_it_be(:catalog_item_2, freeze: false) { create(:ai_catalog_item, :with_foundational_flow_reference) }
    let_it_be(:catalog_item_3, freeze: false) { create(:ai_catalog_item, :with_foundational_flow_reference) }
  ...
  describe '#sync_enabled_foundational_flows!' do
    let_it_be(:project, freeze: false) { create(:project) }
    let_it_be(:flow1, freeze: false) { create(:ai_catalog_item, :with_foundational_flow_reference, public: true, organization: project.organization) }
    let_it_be(:flow2, freeze: false) { create(:ai_catalog_item, :with_foundational_flow_reference, public: true, organization: project.organization) }
  ...
  describe '#remove_foundational_flow_consumers' do
    let_it_be(:project, freeze: false) { create(:project) }
    let_it_be(:flow, freeze: false) { create(:ai_catalog_item, :with_foundational_flow_reference, public: true, organization: project.organization) }
    let_it_be(:consumer, freeze: false) { create(:ai_catalog_item_consumer, project: project, item: flow) }
  ...
  describe '#security_scan_profile_for' do
    ...
    context 'when security_scan_profiles is not available' do
      ...
      context 'when project has a secret_detection scan profile' do
        let_it_be(:secret_detection_profile, freeze: false) do
        ...
        let_it_be(:association, freeze: false) do
  ...
  describe '#execute_flow_triggers' do
    ...
    describe 'with a flow trigger' do
      let_it_be(:flow_triggers, freeze: false) do
      ...
      it 'initializes ::Ai::FlowTriggers::RunService with expected args' do
        ...
        flow_triggers.each do |flow_trigger|
          expect(::Ai::FlowTriggers::RunService).to receive(:new)
            .with(project: project, current_user: user, flow_trigger: flow_trigger, resource: nil)
      ...
      context 'when hook data contains a pipeline id' do
        ...
        let(:data) { { user: { id: user.id }, object_attributes: { id: pipeline.id } } }

        it 'passes the pipeline as resource to ::Ai::FlowTriggers::RunService' do
          run_service = instance_double(::Ai::FlowTriggers::RunService, execute: nil)
          flow_triggers.each do |flow_trigger|
            expect(::Ai::FlowTriggers::RunService).to receive(:new)
              .with(project: project, current_user: user, flow_trigger: flow_trigger, resource: pipeline)
              .and_return(run_service)
          end
        ...
        context 'when hook_scope is not pipeline_hooks' do
          let_it_be(:flow_triggers, freeze: false) do
            Array.new(2) { create(:ai_flow_trigger, project: project, event_types: [::Ai::FlowTrigger::EVENT_TYPES[:mention]]) }
          end

          let(:hook_scope) { :mention }
      ...
      context 'when flow trigger has a foundational flow precondition' do
        let_it_be(:project, freeze: false) { create(:project, :in_group) }
        let_it_be(:failed_pipeline, freeze: false) { create(:ci_pipeline, :failed, project: project) }
        let_it_be(:item, freeze: false) { create(:ai_catalog_flow, foundational_flow_reference: 'fix_pipeline/v1') }
        let_it_be(:item_consumer, freeze: false) { create(:ai_catalog_item_consumer, :child_item_consumer, project: project, item: item) }
        let_it_be(:precondition_trigger, freeze: false) do
        ...
        context 'when pipeline is in an intermediate state due to job retries' do
          let_it_be(:running_pipeline, freeze: false) { create(:ci_pipeline, :running, project: project) }
    ...
    describe 'with no matching flow trigger' do
      let_it_be(:flow_trigger, freeze: false) { create(:ai_flow_trigger, event_types: [::Ai::FlowTrigger::EVENT_TYPES[:mention]]) }
