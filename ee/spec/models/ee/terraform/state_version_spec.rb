...
RSpec.describe Terraform::StateVersion, feature_category: :infrastructure_as_code do
  ...
  describe '.search' do
    let_it_be(:state_version1, freeze: false) { create(:terraform_state_version) }
    let_it_be(:state_version2, freeze: false) { create(:terraform_state_version) }
    let_it_be(:state_version3, freeze: false) { create(:terraform_state_version) }
