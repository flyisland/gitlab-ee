  ...
  describe '#feature_available?' do
    ...
    context 'when features are disabled' do
      it 'returns false' do
        ...
        features.each do |feature|
          expect(group.feature_available?(feature.to_sym, user)).to be(false), "#{feature} failed"
        end
      end
    end
    ...
    context 'when features are enabled only for group members' do
      it 'returns false when user is not a group member' do
        ...
        features.each do |feature|
          expect(group.feature_available?(feature.to_sym, other_user)).to be(false), "#{feature} failed"
        end
      end
      ...
      it 'returns true when user is a group member' do
        ...
        features.each do |feature|
          expect(group.feature_available?(feature.to_sym, user)).to be(true)
        end
      end
      ...
      context 'when admin mode is enabled', :enable_admin_mode do
        it 'returns true if user is an admin' do
          ...
          features.each do |feature|
            expect(group.feature_available?(feature.to_sym, other_user)).to be(true)
          end
        end
      end
    ...
    context 'when feature is enabled for everyone' do
      it 'returns true' do
        expect(group.feature_available?(:wiki)).to be(true)
      end
    end
    ...
    context 'when feature has any other value' do
      it 'returns false' do
        ...
        expect(group.feature_available?(:wiki)).to be(false)
      end
    end
