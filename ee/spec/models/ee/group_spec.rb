...
RSpec.describe Group, feature_category: :groups_and_projects do
  ...
  describe 'scopes' do
    ...
    describe '.root_namespaces_without_knowledge_graph_enabled_namespace' do
      ...
      it 'returns groups without an enabled namespace' do
        expect(described_class.root_namespaces_without_knowledge_graph_enabled_namespace)
          .to include(group)
          .and exclude(indexed_group, subgroup)
      end
    end
  ...
  describe '#secure_settings_available?', feature_category: :dependency_firewall do
    ...
    before do
      allow(group).to receive(:dependency_firewall_setting_available?).and_return(false)
      allow(group).to receive(:secrets_manager_setting_available?).and_return(false)
    end
