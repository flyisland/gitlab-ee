...
RSpec.describe Group, feature_category: :groups_and_projects do
  ...
  describe 'associations' do
    ...
    it { is_expected.to have_many(:cd_applications).inverse_of(:group) }
    it { is_expected.to have_many(:cd_environments).inverse_of(:group) }
  ...
  describe '#built_in_project_templates_enabled_available?' do
    ...
    context 'on GitLab.com', :saas do
      ...
      context 'on a proper plan' do
        ...
        context 'when built_in_project_templates_enabled feature flag is disabled' do
          before do
