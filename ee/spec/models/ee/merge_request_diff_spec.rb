...
RSpec.describe MergeRequestDiff, feature_category: :code_review_workflow do
  ...
  describe '.search' do
    let_it_be(:merge_request_diff1, freeze: false) { create(:merge_request_diff) }
    let_it_be(:merge_request_diff2, freeze: false) { create(:merge_request_diff) }
    let_it_be(:merge_request_diff3, freeze: false) { create(:merge_request_diff) }
