...
RSpec.describe GitlabSubscriptions::AddOnPurchase, feature_category: :plan_provisioning do
  ...
  describe 'callbacks' do
    describe '#set_subscription_add_on_uid' do
      ...
      context 'when updating with a different add_on' do
        let(:original_add_on) { create(:gitlab_subscription_add_on, :duo_pro) }
        let(:new_add_on) { create(:gitlab_subscription_add_on, :duo_enterprise) }
        let!(:add_on_purchase) { create(:gitlab_subscription_add_on_purchase, add_on: original_add_on) }
      ...
      context 'when updating without changing add_on' do
        ...
        let!(:add_on_purchase) { create(:gitlab_subscription_add_on_purchase, add_on: add_on) }
  ...
  describe 'scopes' do
    ...
    describe '.for_duo_add_ons' do
      ...
      let!(:gitlab_credits_add_on) { create(:gitlab_subscription_add_on_purchase, :gitlab_credits) }
      let!(:product_analytics_add_on) { create(:gitlab_subscription_add_on_purchase, :product_analytics) }
    ...
    describe '.requiring_assigned_users_refresh' do
      ...
      let_it_be(:gitlab_credits_purchase_fresh) do
        create(
          :gitlab_subscription_add_on_purchase,
          add_on: gitlab_credits_add_on,
          last_assigned_users_refreshed_at: 1.hour.ago
        )
      end
      ...
      let_it_be(:gitlab_credits_add_on_purchase_refreshed_nil) do
        create(:gitlab_subscription_add_on_purchase, add_on: gitlab_credits_add_on)
      end
      ...
      let_it_be(:gitlab_credits_add_on_purchase_stale) do
        create(
          :gitlab_subscription_add_on_purchase,
          add_on: gitlab_credits_add_on,
          last_assigned_users_refreshed_at: 21.hours.ago
