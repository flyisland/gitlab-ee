  ...
  describe 'validations' do
    ...
    context 'for scan_finding report type' do
      ...
      it 'is invalid when name not unique within scan result policy, rule type and merge request' do
        is_expected.to validate_uniqueness_of(:name).scoped_to([:merge_request_id, :rule_type, :security_orchestration_policy_configuration_id, :orchestration_policy_idx, :approval_policy_action_idx])
      end
    end
