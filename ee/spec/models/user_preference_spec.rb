...
RSpec.describe UserPreference do
  ...
  describe '#knowledge_graph_governing_namespace_with_fallback', feature_category: :knowledge_graph do
    ...
    context 'with one eligible candidate' do
      let(:eligible_group) { create(:group).tap { |g| g.add_owner(user) } }
    ...
    context 'with multiple eligible candidates' do
      let(:group_a) { create(:group).tap { |g| g.add_owner(user) } }
      let(:group_b) { create(:group).tap { |g| g.add_owner(user) } }
  ...
  describe '#knowledge_graph_governing_namespace', feature_category: :knowledge_graph do
    let(:eligible_group) { create(:group).tap { |g| g.add_owner(user) } }
  ...
  describe '#validate_knowledge_graph_governing_namespace_id', feature_category: :knowledge_graph do
    let(:eligible_group) { create(:group).tap { |g| g.add_owner(user) } }
