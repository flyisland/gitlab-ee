...
RSpec.describe Epic, feature_category: :portfolio_management do
  ...
  describe 'validations' do
    ...
    describe 'maximum hierarchy depth' do
      let_it_be(:group) { create(:group) }
      let_it_be(:level_1, reload: true) { create(:epic, group: group) }
      let_it_be(:level_2, reload: true) { create(:epic, parent: level_1, group: group) }
      let_it_be(:level_3, reload: true) { create(:epic, parent: level_2, group: group) }
