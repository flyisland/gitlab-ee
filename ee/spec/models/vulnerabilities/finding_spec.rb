...
RSpec.describe Vulnerabilities::Finding, feature_category: :vulnerability_management do
  ...
  with_them do
    ...
    context 'database uniqueness' do
      let_it_be(:finding, freeze: false) { create(:vulnerabilities_finding) }
    ...
    describe '.report_type' do
      ...
      context 'when finding does not have security reports' do
        let_it_be(:finding, freeze: false) { create(:vulnerabilities_finding, report_type: :dependency_scanning) }
    ...
    describe '.by_location_image' do
      let_it_be(:vulnerability, freeze: false) { create(:vulnerability, report_type: 'cluster_image_scanning') }
      let_it_be(:finding, freeze: false) { create(:vulnerabilities_finding, :with_cluster_image_scanning_scanning_metadata, vulnerability: vulnerability) }
    ...
    describe '.by_location_cluster_agent' do
      ...
      let_it_be(:finding, freeze: false) { create(:vulnerabilities_finding, :with_cluster_image_scanning_scanning_metadata, agent_id: cluster_agent.id.to_s, vulnerability: vulnerability) }
      ...
      describe '#issue_feedback' do
        ...
        context 'when there is issue link present' do
          ...
          context 'when there is no feedback for the vulnerability' do
            let_it_be(:finding_no_feedback, freeze: false) { create(:vulnerabilities_finding, :dependency_scanning, project: project) }
            let_it_be(:vulnerability_no_feedback, freeze: false) { create(:vulnerability, findings: [finding_no_feedback]) }
    ...
    describe '#state' do
      ...
      let_it_be(:finding_with_issue, freeze: false) { create(:vulnerabilities_finding, :with_issue_feedback) }
    ...
    describe '#evidence' do
      ...
      context 'without finding_evidence' do
        ...
        context 'has no evidence summary when evidence is present, summary is not' do
          let_it_be(:finding, freeze: false) { create(:vulnerabilities_finding, raw_metadata: { evidence: {} }) }
  ...
  describe '#eligible_for_resolution_workflow?' do
    let_it_be(:project, freeze: false) { create(:project) }
    let_it_be(:user, freeze: false) { create(:user) }
    let_it_be(:vulnerability, freeze: false) { create(:vulnerability, project: project, author: user) }
    let_it_be(:finding, freeze: false) { create(:vulnerabilities_finding, project: project, vulnerability: vulnerability) }
