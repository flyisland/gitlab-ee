...
RSpec.describe Vulnerabilities::Read, type: :model, feature_category: :vulnerability_management do
  ...
  describe '.with_container_image' do
    let_it_be(:vulnerability, freeze: false) { create(:vulnerability, project: project, report_type: 'cluster_image_scanning') }
    let_it_be(:finding, freeze: false) { create(:vulnerabilities_finding, :with_cluster_image_scanning_scanning_metadata, project: project, vulnerability: vulnerability) }
  ...
  describe '.by_scanner' do
    ...
    let_it_be(:finding, freeze: false) { create(:vulnerabilities_finding, scanner: scanner) }
    let_it_be(:other_finding, freeze: false) { create(:vulnerabilities_finding, scanner: other_scanner) }
    let_it_be(:vulnerability, freeze: false) { create(:vulnerability, project: project, present_on_default_branch: true, findings: [finding]) }
    let_it_be(:vulnerability_for_another_scanner, freeze: false) { create(:vulnerability, project: project, present_on_default_branch: true, findings: [other_finding]) }
