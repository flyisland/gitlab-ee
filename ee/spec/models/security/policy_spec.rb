...
RSpec.describe Security::Policy, feature_category: :security_policy_management do
  ...
  describe '.preload_approval_policy_rules' do
    ...
    let!(:active_rule) { create(:approval_policy_rule, security_policy: policy, rule_index: 0) }
    let!(:deleted_rule) { create(:approval_policy_rule, security_policy: policy, rule_index: -1) }
  ...
  describe '#to_policy_hash' do
    ...
    context 'when policy is a dependency firewall policy' do
      ...
      let_it_be(:policy) { create(:security_policy, :dependency_firewall_policy) }
