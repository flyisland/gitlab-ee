...
RSpec.describe Onboarding::FreeRegistration, type: :undefined, feature_category: :onboarding do
  ...
  describe '.unification_enabled?', :saas_onboarding do
    ...
    context 'when free_registration_unification feature flag is enabled' do
      it { is_expected.to be(true) }
    end

    context 'when free_registration_unification feature flag is disabled' do
      before do
  ...
  describe '.trigger_account_created_iterable?' do
    ...
    it 'is false even when free_registration_unification is enabled' do
