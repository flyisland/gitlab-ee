...
RSpec.describe Geo::ContainerRepositoryRegistry, :geo, feature_category: :geo_replication do
  ...
  describe '.find_registry_differences' do
    ...
    let_it_be_with_reload(:synced_group) { create(:group) }
    let_it_be(:nested_group, freeze: true) { create(:group, parent: synced_group) }
    let_it_be(:project_synced_group, freeze: true) { create(:project, group: synced_group) }
    let_it_be(:project_nested_group, freeze: true) { create(:project, group: nested_group) }
    let_it_be(:project_broken_storage, freeze: true) { create(:project, :broken_storage) }
    let_it_be(:container_repository_1, freeze: true) { create(:container_repository, project: project_synced_group) }
    let_it_be(:container_repository_2, freeze: true) { create(:container_repository, project: project_nested_group) }
    let_it_be(:container_repository_3, freeze: true) { create(:container_repository) }
    let_it_be(:container_repository_4, freeze: true) { create(:container_repository) }
    let_it_be(:container_repository_5, freeze: true) { create(:container_repository, project: project_broken_storage) }
    let_it_be(:container_repository_6, freeze: true) { create(:container_repository, project: project_broken_storage) }
...
RSpec.describe Geo::ContainerRepositoryRegistry, :geo, type: :model, feature_category: :geo_replication do
  let_it_be(:registry, freeze: true) { build(:geo_container_repository_registry) }
