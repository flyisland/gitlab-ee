...
RSpec.describe Geo::LfsObjectRegistry, :geo, feature_category: :geo_replication do
  let_it_be(:registry, freeze: true) { build(:geo_lfs_object_registry) }
  ...
  describe 'scopes' do
    describe '.for_synced_lfs_objects' do
      let_it_be(:registry2, freeze: true) { create(:geo_lfs_object_registry, :synced) }
      let_it_be(:registry3, freeze: true) { create(:geo_lfs_object_registry, :failed) }
      let_it_be(:registry4, freeze: true) { create(:geo_lfs_object_registry, :synced) }
      let_it_be(:registry5, freeze: true) { create(:geo_lfs_object_registry) }
      let_it_be(:registry6, freeze: true) { create(:geo_lfs_object_registry, :started) }
