...
RSpec.describe ::Search::Zoekt::Node, feature_category: :global_search do
  ...
  describe 'scopes' do
    ...
    describe '.negative_unclaimed_storage_bytes' do
      let_it_be(:node_with_negative_storage, freeze: false) { create(:zoekt_node) }
      let_it_be(:node_with_positive_storage, freeze: false) { create(:zoekt_node) }
    ...
    describe '.with_positive_unclaimed_storage_bytes' do
      let_it_be(:node_with_positive_storage, freeze: false) { create(:zoekt_node, :enough_free_space) }
      let_it_be(:node_with_zero_storage) { create(:zoekt_node, total_bytes: 1000, used_bytes: 1000) }
      let_it_be(:node_with_negative_storage, freeze: false) { create(:zoekt_node, :enough_free_space) }
