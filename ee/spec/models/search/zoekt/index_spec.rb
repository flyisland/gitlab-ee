...
RSpec.describe Search::Zoekt::Index, :aggregate_failures, feature_category: :global_search do
  ...
  describe 'scopes' do
    ...
    let_it_be(:zoekt_index_2, freeze: false) do
    ...
    describe '.ordered_by_used_storage_updated_at' do
      let_it_be(:zoekt_index_3, freeze: false) { create(:zoekt_index) }
    ...
    describe '.should_be_marked_as_orphaned' do
      ...
      let_it_be(:idx_already_marked_as_orphaned, freeze: false) { create(:zoekt_index) }
