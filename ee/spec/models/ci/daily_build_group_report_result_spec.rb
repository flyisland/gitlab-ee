  ...
  describe 'scopes' do
    ...
    describe '.activity_per_group' do
      ...
      context 'when group has projects with several coverage' do
        let_it_be_with_refind(:project_2) { create(:project) }
        let_it_be(:group) { create(:group, projects: [project, project_2]) }
        let_it_be(:coverage_1) { create(:ci_daily_build_group_report_result, project: project) }
        let_it_be(:coverage_2) { create(:ci_daily_build_group_report_result, project: project_2, group_name: 'karma') }
