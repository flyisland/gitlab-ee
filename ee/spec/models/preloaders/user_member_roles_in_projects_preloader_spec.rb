...
RSpec.describe Preloaders::UserMemberRolesInProjectsPreloader, feature_category: :permissions do
  ...
  let_it_be(:group_member, freeze: false) { create(:group_member, :guest, user: user, source: group) }
  let_it_be(:sub_group_member, freeze: false) { create(:group_member, :guest, user: user, source: sub_group) }
