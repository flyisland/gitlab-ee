  ...
  describe '#active?' do
    ...
    context 'when user has a Duo Enterprise add-on' do
      ...
      context 'when duo_code_review_dap_internal_users is disabled' do
        ...
        context 'when duo_code_review_dap_routing_consent_enabled is disabled' do
          before do
            stub_feature_flags(duo_code_review_dap_routing_consent_enabled: false)
          end

          include_examples 'not active'
        end

        context 'when duo_code_review_dap_routing_consent_enabled is enabled' do
