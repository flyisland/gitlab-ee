...
RSpec.describe Ai::Catalog::BaseDefinition, feature_category: :workflow_catalog do
  ...
  let_it_be(:item, freeze: false) { create(:ai_catalog_item, :agent, project: project) }
  let_it_be(:item_version_1, freeze: false) { create(:ai_catalog_item_version, item: item, version: '1.0.0') }
