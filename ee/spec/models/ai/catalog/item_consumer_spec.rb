...
RSpec.describe Ai::Catalog::ItemConsumer, feature_category: :workflow_catalog do
  ...
  describe 'validations' do
    ...
    describe '#validate_item_privacy_allowed' do
      ...
      context 'when item is internal' do
        let_it_be(:sibling_project) { create(:project, group: group) }
        let_it_be(:outside_project) { create(:project) }
        let_it_be(:item) { create(:ai_catalog_agent, :internal, project: project) }
        ...
        context 'when consumer group is outside the TLG' do
          subject(:item_consumer) { build(:ai_catalog_item_consumer, group: create(:group), item: item) }
        ...
        context 'when consumer is the same project as the item' do
          subject(:item_consumer) { build(:ai_catalog_item_consumer, project: project, item: item) }
    ...
    describe '#validate_service_account' do
      ...
      let_it_be_with_reload(:item) { create(:ai_catalog_flow, project: project, public: true) }
    ...
    describe '#validate_parent_item_consumer' do
      ...
      let_it_be_with_reload(:item) { create(:ai_catalog_item, :flow, public: true) }
      ...
      let_it_be(:other_item) { create(:ai_catalog_item, :flow, public: true) }
