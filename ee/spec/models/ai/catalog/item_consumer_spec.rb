...
RSpec.describe Ai::Catalog::ItemConsumer, feature_category: :workflow_catalog do
  ...
  describe 'validations' do
    ...
    describe '#validate_item_allowed_by_namespace_restriction' do
      ...
      context 'when restriction is enabled on the top-level group' do
        ...
        context 'when item is owned outside the top-level group hierarchy' do
          let(:item) { create(:ai_catalog_flow, :public) }
    ...
    describe 'item and item_consumer organization checks' do
      ...
      let_it_be(:item, freeze: false) { create(:ai_catalog_item, organization: default_organization) }
    ...
    describe '#validate_service_account' do
      ...
      let_it_be(:item, freeze: false) { create(:ai_catalog_flow, project: project, public: true) }
    ...
    describe '#validate_parent_item_consumer' do
      ...
      let_it_be(:item, freeze: false) { create(:ai_catalog_item, :flow, public: true) }
  ...
  describe '#pinned_version' do
    let_it_be(:project) { create(:project) }
    let_it_be(:item, freeze: false) { create(:ai_catalog_flow, project: project) }
    ...
    context 'when pinned_version_prefix is set' do
      let_it_be(:version, freeze: false) { create(:ai_catalog_flow_version, item: item, version: '2.5.0') }
  ...
  describe 'scopes' do
    ...
    describe '.with_synthesized_foundational_agent_consumers' do
      ...
      let_it_be(:item, freeze: false) do
        create(:ai_catalog_item, organization_id: nil, project_id: project.id, public: true)
      end
