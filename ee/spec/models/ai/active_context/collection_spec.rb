  ...
  describe 'metadata' do
    ...
    describe 'embedding model properties' do
      ...
      with_them do
        ...
        it 'is invalid with model_type=self_hosted' do
          collection.metadata = {
        ...
        it 'is valid with supported dimensions' do
          [nil, 768].each do |dimensions|
            collection.metadata = {
        ...
        it 'is invalid with unsupported dimensions' do
          [-1, 0, 1000].each do |dimensions|
            collection.metadata = {
              embedding_model => { model_ref: 'model_1', field: 'field_1', dimensions: dimensions }
            }
            expect(collection).not_to be_valid
