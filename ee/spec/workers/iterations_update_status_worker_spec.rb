...
RSpec.describe IterationsUpdateStatusWorker, feature_category: :team_planning do
  let_it_be_with_reload(:closed_iteration1) { create(:iteration, :skip_future_date_validation, start_date: 20.days.ago, due_date: 11.days.ago) }
  let_it_be_with_reload(:current_iteration1) { create(:iteration, :skip_future_date_validation, start_date: 10.days.ago, due_date: 3.days.ago) }
