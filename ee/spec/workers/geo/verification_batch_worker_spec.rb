...
RSpec.describe Geo::VerificationBatchWorker, :geo, feature_category: :geo_replication do
  ...
  describe '#perform' do
    it 'calls verify_batch' do
      ...
      allow(::Gitlab::Geo).to receive(:verification_concurrency_limit).and_return(1)
  ...
  describe '#max_running_jobs' do
    it 'returns verification_concurrency_limit' do
      allow(::Gitlab::Geo).to receive(:verification_concurrency_limit).and_return(123)
