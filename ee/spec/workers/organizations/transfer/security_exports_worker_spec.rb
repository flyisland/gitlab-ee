...
RSpec.describe Organizations::Transfer::SecurityExportsWorker, feature_category: :vulnerability_management do
  ...
  describe '#perform' do
    ...
    it 'delegates to Organizations::Transfer::SecurityExportsService' do
      expect_next_instance_of(
        Organizations::Transfer::SecurityExportsService,
        group: group,
    ...
    shared_examples 'logs and does not call the service' do
      it 'logs and does not call the service' do
        ...
        expect(Organizations::Transfer::SecurityExportsService).not_to receive(:new)
