...
RSpec.describe Security::OrchestrationPolicyRuleScheduleWorker, feature_category: :security_policy_management do
  describe '#perform' do
    ...
    let_it_be(:security_orchestration_policy_configuration, freeze: false) { create(:security_orchestration_policy_configuration, project: project) }
    let_it_be(:schedule, freeze: false) { create(:security_orchestration_policy_rule_schedule, security_orchestration_policy_configuration: security_orchestration_policy_configuration) }
    ...
    context 'when schedule exists' do
      ...
      context 'when policy has a security_policy_bot user' do
        ...
        let_it_be(:security_orchestration_policy_configuration, freeze: false) { create(:security_orchestration_policy_configuration) }
        let_it_be(:schedule, freeze: false) { create(:security_orchestration_policy_rule_schedule, security_orchestration_policy_configuration: security_orchestration_policy_configuration) }
