...
RSpec.describe Namespaces::RemoveDormantMembersWorker, :saas, feature_category: :seat_cost_management do
    ...
    context 'with Groups requiring dormant member review', :freeze_time do
      ...
      context 'with dormant members', :enable_admin_mode do
        ...
        context 'with dormant enterprise users' do
          let_it_be(:dormant_enterprise_user, freeze: false) { create(:enterprise_user, enterprise_group: group) }
          let_it_be(:other_group_enterprise_user, freeze: false) { create(:enterprise_user) }
          let_it_be(:dormant_regular_user, freeze: false) { create(:user) }
          ...
          it_behaves_like 'an idempotent worker' do
            ...
            include_examples 'audit event logging' do
              let_it_be(:admin, freeze: false) do
  ...
  describe '#remaining_work_count', :freeze_time do
    let_it_be(:namespaces_requiring_dormant_member_removal, freeze: false) do
