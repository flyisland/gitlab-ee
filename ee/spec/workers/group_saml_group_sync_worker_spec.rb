        ...
        context 'with BSO (Block Seat Overages) enabled for default membership' do
          ...
          context 'without available seats' do
            ...
            it 'tracks minimal access provisioning' do
              ...
              expect(worker).to receive(:track_minimal_access_provisioning).with(top_level_group, user.id)
          ...
          context 'with available seats' do
            ...
            it 'does not track minimal access provisioning' do
              ...
              expect(worker).not_to receive(:track_minimal_access_provisioning).with(top_level_group, user.id)
