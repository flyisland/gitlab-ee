...
RSpec.describe Ai::ActiveContext::TaskWorker, feature_category: :global_search do
  let_it_be(:connection, freeze: false) { create(:ai_active_context_connection, active: true) }
  let(:worker) { described_class.new }
  let(:logger) { instance_double(::Logger, info: nil) }
  let_it_be(:task_double_name, freeze: false) { 'Ai::ActiveContext::TaskDouble' }
  let_it_be(:task_double_class, freeze: false) do
    Class.new do
  ...
  describe '#perform' do
    ...
    context 'when task dependency is completed' do
      let_it_be(:parent_task, freeze: false) do
