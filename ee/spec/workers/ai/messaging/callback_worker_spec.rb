...
RSpec.describe Ai::Messaging::CallbackWorker, feature_category: :duo_agent_platform do
  ...
  before do
    ...
    stub_const("#{described_class}::ADAPTER_REGISTRY", { 'test_adapter' => test_adapter_class }.freeze)
  ...
  describe 'worker configuration' do
    ...
    context 'when subscribing to WorkloadFinishedEvent' do
    ...
    context 'when subscribing to WorkflowStartedEvent' do
      it_behaves_like 'subscribes to event' do
