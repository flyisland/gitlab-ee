      ...
      context 'with BSO (Block Seat Overages) enabled' do
        ...
        context 'without available seats' do
          ...
          it 'audits minimal access role adjustment' do
            ...
            group_audit_event = AuditEvent.find_by(target_id: user1.id, entity_id: group.id)
            another_group_audit_event = AuditEvent.find_by(target_id: user1.id, entity_id: another_group.id)
