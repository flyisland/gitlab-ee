    ...
    describe 'for users' do
      ...
      describe 'for a group' do
        ...
        context 'when the group has a subgroup with a member' do
          ...
          let_it_be(:subgroup_member, freeze: false) { create(:group_member, group: subgroup, user: user) }
        ...
        context 'when the group has a parent with a member' do
          ...
          let_it_be(:parent_group_member, freeze: false) { create(:group_member, group: parent_group, user: user) }
