...
RSpec.describe Projects::Security::DastProfilesHelper, feature_category: :dynamic_application_security_testing do
  ...
  describe "#dast_scanner_profile_form_data" do
    subject(:scanner_profile_form_data) { helper.dast_scanner_profile_form_data(project) }
    ...
    it 'returns proper data' do
      expect(scanner_profile_form_data).to eq(
        {
          project_full_path: "foo/bar",
  ...
  describe "#edit_dast_scanner_profile_form_data" do
    subject(:edit_scanner_profile_form_data) { helper.edit_dast_scanner_profile_form_data(project, scanner_profile) }
    ...
    it 'returns proper data' do
      expect(edit_scanner_profile_form_data).to eq(
        {
          project_full_path: "foo/bar",
          on_demand_scan_form_path: "/#{project.full_path}/-/on_demand_scans/new",
          dast_configuration_path: "/#{project.full_path}/-/security/configuration/dast",
  ...
  describe "#dast_site_profile_form_data" do
    subject(:site_profile_form_data) { helper.dast_site_profile_form_data(project) }
    ...
    it 'returns proper data' do
      expect(site_profile_form_data).to eq(
        {
          project_full_path: "foo/bar",
          on_demand_scan_form_path: "/#{project.full_path}/-/on_demand_scans/new",
          dast_configuration_path: "/#{project.full_path}/-/security/configuration/dast",
  ...
  describe "#edit_dast_site_profile_form_data" do
    subject(:edit_site_profile_form_data) { helper.edit_dast_site_profile_form_data(project, site_profile) }
    ...
    it 'returns proper data' do
      expect(edit_site_profile_form_data).to eq(
        {
          project_full_path: "foo/bar",
          on_demand_scan_form_path: "/#{project.full_path}/-/on_demand_scans/new",
          dast_configuration_path: "/#{project.full_path}/-/security/configuration/dast",
