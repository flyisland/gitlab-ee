...
describe('Split View', () => {
  ...
  const createWrapper = ({ propsData = {}, provide = {}, glFeatures = {} } = {}) => {
    wrapper = mountExtended(App, {
      ...
      stubs: {
        SettingPopover: true,
        // Unrelated to this MR: GlExperimentBadge passes css-classes as a String to GlPopover
        // which expects an Array, causing console.error that fails jest-integration.
        // See: https://gitlab.com/gitlab-org/gitlab/-/pipelines/2387959689
        GlExperimentBadge: true,
      },
    });
  };
  ...
  beforeEach(() => {
    jest.spyOn(urlUtils, 'getParameterByName').mockReturnValue(APPROVAL_POLICY_TYPE);
  });
