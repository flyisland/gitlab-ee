  ...
  describe '#data' do
    ...
    describe 'trial and billing attributes' do
      ...
      before do
        ...
        allow(helpers_double).to receive(:new_subscriptions_path) do |namespace_id:|
          "/-/subscriptions/new?namespace_id=#{namespace_id}"
        end
      end
        ...
        context 'when not on trial' do
          ...
          it 'returns internal subscriptions path scoped to the namespace' do
            expect(result[:tier_upgrade_path])
              .to eq("/-/subscriptions/new?namespace_id=#{root_group.id}")
          end
        end
