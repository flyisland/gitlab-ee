...
RSpec.shared_examples 'authorizable for protected environments' do |factory_name:|
  ...
  let_it_be(:protected_environment, freeze: false) { create(:protected_environment, project: project) }
  ...
  describe '#check_access' do
    ...
    describe 'group access' do
      ...
      context 'when there is an inherited member of a group' do
        ...
        let_it_be(:child_group, freeze: false) { create(:group, parent: parent_group, projects: [project]) }
  ...
  describe '#humanize' do
    let_it_be(:protected_environment, freeze: false) { create(:protected_environment) }
