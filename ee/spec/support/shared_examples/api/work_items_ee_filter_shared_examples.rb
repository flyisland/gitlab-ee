...
RSpec.shared_examples 'work item listing EE filters' do
  describe 'EE-specific filters' do
    describe 'custom_field filter' do
      ...
      let_it_be(:matching_option) { create(:custom_field_select_option, custom_field: custom_field) }
      let_it_be(:other_option) { create(:custom_field_select_option, custom_field: custom_field) }
    ...
    describe 'status filter' do
      let_it_be(:to_do_status) { ::WorkItems::Statuses::SystemDefined::Status.find_by(id: 1) }
      let_it_be(:in_progress_status) { ::WorkItems::Statuses::SystemDefined::Status.find_by(id: 2) }
    ...
    describe 'verification_status_widget filter' do
      let_it_be(:requirement_work_item) { create(:requirement, project: project) }
