...
RSpec.shared_examples "protected branches > access control > EE" do
  ...
  let_it_be(:no_one, freeze: false) { ProtectedRef::AccessLevel.humanize(::Gitlab::Access::NO_ACCESS) }
  let_it_be(:roles, freeze: false) { ProtectedRef::AccessLevel.human_access_levels.except(::Gitlab::Access::NO_ACCESS) }
  let_it_be(:edit_form, freeze: false) { '.js-protected-branch-edit-form' }
