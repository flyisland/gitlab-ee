...
RSpec.shared_examples 'issue boards sidebar EE' do
  context 'epics' do
    ...
    context 'when epic feature available' do
      ...
      let_it_be_with_reload(:epic_issue) { create(:epic_issue, epic: epic1, issue: issue) }
    ...
    context 'iterations' do
      context 'when iterations feature available' do
        ...
        let_it_be(:iteration, freeze: false) { create(:iteration, iterations_cadence: cadence, start_date: 1.day.from_now, due_date: 2.days.from_now, title: 'Iteration 1') }
        let_it_be(:iteration2, freeze: false) { create(:iteration, iterations_cadence: cadence, start_date: 2.days.ago, due_date: 1.day.ago, title: 'Iteration 2', state: 'closed', skip_future_date_validation: true) }
