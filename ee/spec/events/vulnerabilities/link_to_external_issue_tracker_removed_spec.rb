...
require_relative '../../../../ee/app/events/vulnerabilities/link_to_external_issue_tracker_removed'
require_relative '../../../../spec/support/shared_examples/events/event_with_schema_shared_examples'

RSpec.describe Vulnerabilities::LinkToExternalIssueTrackerRemoved, feature_category: :vulnerability_management do
