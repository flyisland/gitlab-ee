...
require_relative '../../../../../ee/app/events/search/zoekt/repo_marked_as_to_delete_event'
require_relative '../../../../../spec/support/shared_examples/events/event_with_schema_shared_examples'

RSpec.describe Search::Zoekt::RepoMarkedAsToDeleteEvent, feature_category: :global_search do
