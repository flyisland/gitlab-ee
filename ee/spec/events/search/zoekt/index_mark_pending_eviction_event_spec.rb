...
require_relative '../../../../../ee/app/events/search/zoekt/index_mark_pending_eviction_event'
require_relative '../../../../../spec/support/shared_examples/events/event_with_schema_shared_examples'

RSpec.describe Search::Zoekt::IndexMarkPendingEvictionEvent, feature_category: :global_search do
