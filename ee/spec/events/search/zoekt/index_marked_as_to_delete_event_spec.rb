...
require_relative '../../../../../ee/app/events/search/zoekt/index_marked_as_to_delete_event'
require_relative '../../../../../spec/support/shared_examples/events/event_with_schema_shared_examples'

RSpec.describe Search::Zoekt::IndexMarkedAsToDeleteEvent, feature_category: :global_search do
