...
require_relative '../../../../../ee/app/events/search/zoekt/force_update_overprovisioned_index_event'
require_relative '../../../../../spec/support/shared_examples/events/event_with_schema_shared_examples'

RSpec.describe Search::Zoekt::ForceUpdateOverprovisionedIndexEvent, feature_category: :global_search do
