...
require_relative '../../../../../ee/app/events/search/zoekt/update_index_used_storage_bytes_event'
require_relative '../../../../../spec/support/shared_examples/events/event_with_schema_shared_examples'

RSpec.describe Search::Zoekt::UpdateIndexUsedStorageBytesEvent, feature_category: :global_search do
