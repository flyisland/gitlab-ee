...
require_relative '../../../../ee/app/events/merge_requests/violations_updated_event'
require_relative '../../../../spec/support/shared_examples/events/event_with_schema_shared_examples'

RSpec.describe MergeRequests::ViolationsUpdatedEvent, feature_category: :code_review_workflow do
