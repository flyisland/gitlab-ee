...
require_relative '../../../../../ee/app/events/ai/duo_workflows/workflow_finished_event'
require_relative '../../../../../spec/support/shared_examples/events/event_with_schema_shared_examples'

RSpec.describe Ai::DuoWorkflows::WorkflowFinishedEvent, feature_category: :duo_agent_platform do
