...
require_relative '../../../../../../ee/app/events/ai/active_context/code/mark_repository_as_pending_deletion_event'
require_relative '../../../../../../spec/support/shared_examples/events/cloud_event_with_schema_shared_examples'

RSpec.describe Ai::ActiveContext::Code::MarkRepositoryAsPendingDeletionEvent, feature_category: :duo_chat do
  describe '.build' do
    it 'builds a valid cloud event', :aggregate_failures do
      ...
      expect(event.event_type).to eq(:mark_repository_as_pending_deletion)
