...
RSpec.describe Repositories::ProtectedBranchesChangesAuditor, :request_store, feature_category: :source_code_management do
  let_it_be(:author, freeze: false) { create(:user, :with_sign_ins) }
  let_it_be(:user, freeze: false) { create(:user, :with_sign_ins) }
  let_it_be(:group, freeze: false) { create(:group) }
  let_it_be(:destination, freeze: false) { create(:audit_events_group_external_streaming_destination, group: group) }
  let_it_be(:entity, freeze: false) { create(:project, creator: author, group: group) }
