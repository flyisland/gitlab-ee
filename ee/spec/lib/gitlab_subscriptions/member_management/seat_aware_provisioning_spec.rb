...
RSpec.describe GitlabSubscriptions::MemberManagement::SeatAwareProvisioning, feature_category: :seat_cost_management do
  ...
  describe '#audit_minimal_access_role_adjustment' do
    ...
    subject(:audit_event) { instance.audit_minimal_access_role_adjustment(group, invitee, desired_access) }
    ...
    context 'when bso_minimal_access_fallback feature flag is enabled' do
      ...
      it 'audits event with extra parameters' do
        instance.audit_minimal_access_role_adjustment(group, invitee, desired_access, { scim_group_uid: 'test-uid' })
  ...
  describe '#track_minimal_access_provisioning', :clean_gitlab_redis_shared_state, :freeze_time do
    ...
    subject(:track_event) { instance.track_minimal_access_provisioning(root_namespace, user_identifier) }
