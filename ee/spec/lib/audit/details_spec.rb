    ...
    context 'project' do
      ...
      context 'add project member' do
        ...
        context 'with expiry date' do
          ...
          it 'includes expiry date in the humanized output' do
            string = described_class.humanize(member_access_action)

            expect(string).to eq('Added user access as Developer with expiry: 2026-03-20')
          end
        end
        ...
        context 'without expiry date' do
          ...
          it 'does not include expiry information' do
            string = described_class.humanize(member_access_action)
