...
RSpec.describe Search::RakeTask::Zoekt, :silence_stdout, feature_category: :global_search do
  ...
  describe '.index' do
    ...
    context 'when indexing fails' do
      ...
      it 'aborts with error message' do
        expect(described_class).to receive(:abort).with('Failed to enable Zoekt indexing')
  ...
  describe '.disable' do
    ...
    context 'when disabling fails' do
      ...
      it 'aborts with error message' do
        expect(described_class).to receive(:abort).with('Failed to disable Zoekt')
  ...
  describe '.pause_indexing' do
    ...
    context 'when pausing fails' do
      ...
      it 'aborts with error message' do
        expect(described_class).to receive(:abort).with('Failed to pause Zoekt indexing')
  ...
  describe '.resume_indexing' do
    ...
    context 'when resuming fails' do
      ...
      it 'aborts with error message' do
        expect(described_class).to receive(:abort).with('Failed to resume Zoekt indexing')
