...
RSpec.describe Sidebars::Groups::SuperSidebarMenus::DuoAgentsMenu, feature_category: :duo_agent_platform do
  ...
  describe '#configure_menu_items' do
    ...
    where(:read_flow_permission, :read_mcp_server_permission, :duo_workflow_permission,
      :configure_result, :expected_items) do
      true  | false | true  | true  | [:ai_agents, :ai_flows]
      true  | true  | true  | true  | [:ai_agents, :ai_flows, :ai_catalog_mcp_servers]
      false | true  | true  | true  | [:ai_agents, :ai_catalog_mcp_servers]
      false | false | true  | true  | [:ai_agents]
