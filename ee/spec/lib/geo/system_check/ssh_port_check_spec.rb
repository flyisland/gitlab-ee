...
RSpec.describe Geo::SystemCheck::SshPortCheck, feature_category: :geo_replication do
  ...
  # primary_node uses with_reload instead because the before block intentionally
  # mutates clone_url_prefix. See https://gitlab.com/gitlab-org/gitlab/-/issues/590041
