    ...
    describe 'Work Items menu', feature_category: :team_planning do
      ...
      context 'with root group' do
        ...
        context 'when work_item_configurable_types FF is disabled' do
          ...
          it { expect(work_items_menu).to be_present }
        end
      end
      ...
      context 'with subgroup' do
        ...
        context 'when work_item_configurable_types FF is disabled' do
          ...
          it { expect(work_items_menu).not_to be_present }
        end

        context 'when work_item_configurable_types FF is enabled for root ancestor' do
          before do
            stub_licensed_features(configurable_work_item_types: true)
        ...
        context 'when work_item_configurable_types FF is enabled for subgroup only' do
          before do
            stub_licensed_features(configurable_work_item_types: true)
            stub_feature_flags(work_item_configurable_types: subgroup)
          end
