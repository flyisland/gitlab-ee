...
RSpec.describe EE::Gitlab::Auth::Ldap::Sync::Groups do
  ...
  describe '#update_permissions' do
    before do
      ...
      allow(EE::Gitlab::Auth::Ldap::Sync::AuditorUsers).to receive(:execute)
    ...
    context 'when group_base is not present' do
      ...
      it 'does not call EE::Gitlab::Auth::Ldap::Sync::AuditorUsers#execute' do
        expect(EE::Gitlab::Auth::Ldap::Sync::AuditorUsers).not_to receive(:execute)
      end
    ...
    context 'when group_base is present' do
      context 'and admin_group, audit_group and external_groups are not present' do
        before do
      ...
      context 'and admin_group is present' do
        ...
        it 'calls EE::Gitlab::Auth::Ldap::Sync::AdminUsers#execute' do
      ...
      context 'and audit_group is present' do
        before do
          stub_ldap_config(
            group_base: 'dc=example,dc=com',
            audit_group: 'my-audit-group'
          )
        end
        ...
        it 'calls EE::Gitlab::Auth::Ldap::Sync::AuditorUsers#execute' do
          expect(EE::Gitlab::Auth::Ldap::Sync::AuditorUsers).to receive(:execute).once
        end
