...
RSpec.describe Gitlab::ImportExport::Project::TreeRestorer, :clean_gitlab_redis_shared_state, feature_category: :importers do
  ...
  describe 'epics' do
    ...
    context 'with group' do
      ...
      context 'with pre-existing epic' do
        let_it_be(:epic, freeze: false) { create(:epic, title: 'An epic', group: project.group) }
  ...
  describe 'push_rules' do
    let_it_be(:project, freeze: false) { create(:project, name: 'project', path: 'project') }
  ...
  describe 'protected branches' do
    let_it_be(:project, freeze: false) { create(:project, :in_group, name: 'project', path: 'project') }
    let(:user) { create(:user) }
  ...
  describe 'boards' do
    let_it_be(:project, freeze: false) { create(:project, :builds_enabled, :issues_disabled, name: 'project', path: 'project') }
