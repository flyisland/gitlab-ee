...
RSpec.describe CodeSuggestions::ModelDetails::CodeCompletion, feature_category: :code_suggestions do
  ...
  before do
    stub_feature_flags(use_vertex_codestral_code_completion: false)
  ...
  shared_examples 'selects the correct model' do
    context 'on GitLab self-managed' do
      ...
      context 'when use_vertex_codestral_code_completion is enabled' do
        ...
        it 'returns the vertex/codestral model' do
          expect(actual_result).to eq(expected_vertex_codestral_result)
        end
      end
    end
    ...
    context 'on GitLab saas' do
      ...
      context 'when use_vertex_codestral_code_completion is enabled for the user' do
        before do
          stub_feature_flags(use_vertex_codestral_code_completion: user)
        end
  ...
  describe '#current_model' do
    it_behaves_like 'selects the correct model' do
      ...
      let(:expected_vertex_codestral_result) do
        {
