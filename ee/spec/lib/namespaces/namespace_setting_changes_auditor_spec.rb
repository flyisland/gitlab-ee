  ...
  describe '#execute' do
    ...
    it 'audits all the columns except the ones denylisted' do
      columns_not_to_audit = %w[created_at updated_at namespace_id repository_read_only last_dormant_member_review_at
        ...
        pipeline_variables_default_role extended_grat_expiry_webhooks_execute
        ...
        web_based_commit_signing_enabled built_in_project_templates_enabled lock_built_in_project_templates_enabled
        allow_enterprise_bypass_placeholder_confirmation enterprise_bypass_expires_at allow_personal_snippets
        lock_auto_duo_code_review_enabled lock_duo_remote_flows_enabled lock_duo_foundational_flows_enabled
