...
RSpec.describe Gitlab::Geo::GitSSHProxy, :geo, feature_category: :geo_replication do
  ...
  let_it_be(:primary_node, freeze: true) { create(:geo_node, :primary, url: 'http://localhost:3001') }
  let_it_be(:secondary_node, freeze: true) { create(:geo_node, url: 'http://localhost:3002') }
