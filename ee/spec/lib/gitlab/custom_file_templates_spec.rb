  ...
  describe '#enabled?' do
    ...
    with_them do
      ...
      before do
        ...
        set_file_template_project_id(group, group_template_project.id) if namespace_enabled
      end
  ...
  describe '#all' do
    ...
    with_them do
      ...
      before do
        ...
        set_file_template_project_id(group, group_template_project.id)
      end
      ...
      context 'licensed' do
        ...
        context 'in a subgroup' do
          ...
          before do
            set_file_template_project_id(subgroup, subgroup_template_project.id)
          end
        ...
        context 'in a subgroup' do
          ...
          context 'with templates missing for a nested group' do
            context 'when subgroup template config points to a project that has no templates' do
              before do
                set_file_template_project_id(subgroup, subproject.id)
              end
            ...
            context 'when subgroup template config is not setup' do
              before do
                set_file_template_project_id(subgroup, nil)
              end
