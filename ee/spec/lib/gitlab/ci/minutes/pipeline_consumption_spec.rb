...
RSpec.describe Gitlab::Ci::Minutes::PipelineConsumption, feature_category: :hosted_runners do
  ...
  let_it_be_with_reload(:build_2) do
    create(:ci_build, :success, runner: runner_2, pipeline: pipeline, project: project)
  end

  subject(:amount) { described_class.new(pipeline).amount }
