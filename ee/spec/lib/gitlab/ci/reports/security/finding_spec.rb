...
RSpec.describe Gitlab::Ci::Reports::Security::Finding, feature_category: :vulnerability_management do
  ...
  describe '#initialize' do
    ...
    let_it_be(:primary_identifier, freeze: false) { build(:ci_reports_security_identifier) }
    let_it_be(:other_identifier, freeze: false) { build(:ci_reports_security_identifier) }
    let_it_be(:link, freeze: false) { build(:ci_reports_security_link) }
    let_it_be(:scanner, freeze: false) { build(:ci_reports_security_scanner) }
    let_it_be(:location, freeze: false) { build(:ci_reports_security_locations_sast) }
    let_it_be(:evidence, freeze: false) { build(:ci_reports_security_evidence) }
    let_it_be(:remediation, freeze: false) { build(:ci_reports_security_remediation) }
