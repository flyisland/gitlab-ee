...
RSpec.describe Gitlab::Ci::Reports::CoverageFuzzing::Report, feature_category: :dynamic_application_security_testing do
  ...
  describe '#add_crash' do
    ...
    subject(:add_crash) { report.add_crash(crash) }

    it 'stores given crash params in the map', :aggregate_failures do
      add_crash
