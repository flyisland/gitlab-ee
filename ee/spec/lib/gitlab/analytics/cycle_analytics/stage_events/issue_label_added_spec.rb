...
RSpec.describe Gitlab::Analytics::CycleAnalytics::StageEvents::IssueLabelAdded, feature_category: :value_stream_management do
  ...
  it_behaves_like 'LEFT JOIN-able value stream analytics event' do
    ...
    let_it_be(:record_with_data, freeze: false) { create(:issue, project: project) }
