...
RSpec.describe Gitlab::Insights::Reducers::CountPerPeriodReducer, feature_category: :value_stream_management do
  ...
  subject(:result) { reduce(issuable_relation, period: query[:group_by]) }
  ...
  context 'with open issues' do
    ...
    it 'avoids N + 1 queries' do
      control_queries = ActiveRecord::QueryRecorder.new { result }
