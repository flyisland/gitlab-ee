...
RSpec.describe Gitlab::Graphql::Aggregations::Epics::LazyEpicAggregate, feature_category: :portfolio_management do
  ...
  describe '#epic_aggregate' do
    ...
    subject(:health_status_aggregate) { described_class.new(query_ctx, epic_id, HEALTH_STATUS_SUM) }

    before do
      health_status_aggregate.instance_variable_set(:@lazy_state, fake_state)
    end
    ...
    context 'if the record has already been loaded' do
      ...
      it 'does not make the query again' do
        ...
        health_status_aggregate.epic_aggregate
      end
    end
    ...
    context 'if the record has not been loaded' do
      ...
      it 'clears the pending IDs' do
        ...
        lazy_state = health_status_aggregate.instance_variable_get(:@lazy_state)
      ...
      context 'if a block is provided' do
        ...
        subject(:health_status_aggregate) do
        ...
        it 'calls the block' do
          expect(health_status_aggregate.epic_aggregate).to eq result
        end
      end
