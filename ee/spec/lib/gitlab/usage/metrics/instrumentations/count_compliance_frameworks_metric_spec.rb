...
RSpec.describe Gitlab::Usage::Metrics::Instrumentations::CountComplianceFrameworksMetric, feature_category: :compliance_management do
  ...
  let_it_be(:framework, freeze: false) { create(:compliance_framework, namespace: namespace) }

  let_it_be(:namespace2, freeze: false) { create(:group) }
  let_it_be(:framework2, freeze: false) { create(:compliance_framework, namespace: namespace2) }
