...
RSpec.describe Gitlab::Usage::Metrics::Instrumentations::AdvancedSearch::BuildTypeMetric, feature_category: :global_search do
  let(:mock_es_helper) { instance_double(Search::Elastic::Helper, server_info: { build_type: 'docker' }) }
