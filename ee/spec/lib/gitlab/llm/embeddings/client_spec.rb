...
RSpec.describe Gitlab::Llm::Embeddings::Client, feature_category: :code_suggestions do
  ...
  describe '#code_embeddings' do
    ...
    it 'builds headers with the correct unit_primitive and feature_name' do
    ...
    context 'when user is nil' do
      ...
      it 'successfully posts to the AIGW code_embeddings/index endpoint' do
        result
      ...
      it 'passes nil user and organization_id to headers' do
        expect(Gitlab::AiGateway).to receive(:headers).with(
          user: nil,
          unit_primitive_name: 'generate_embeddings_codebase',
          ai_feature_name: :embeddings_code,
