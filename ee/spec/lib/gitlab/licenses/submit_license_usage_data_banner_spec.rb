...
RSpec.describe Gitlab::Licenses::SubmitLicenseUsageDataBanner, feature_category: :plan_provisioning do
  ...
  describe '#reset' do
    ...
    shared_examples 'skips resetting the submit license usage data' do
      it 'does not reset the submit license usage data' do
        ...
        expect(Gitlab::CurrentSettings.reload.license_usage_data_exported).to be(true)
    ...
    shared_examples 'resets the submit license usage data' do
      it 'resets the submit license usage data' do
        ...
        expect(Gitlab::CurrentSettings.reload.license_usage_data_exported).to be(false)
  ...
  describe '#display?' do
    ...
    let_it_be_with_refind(:user) { create(:admin) }
