...
RSpec.describe Gitlab::Database::Type::CvssVector, feature_category: :vulnerability_management do
  ...
  describe '#serialize' do
    ...
    it 'serializes strings as-is' do
      ...
      expect(type.serialize('CVSS:4.0/AV:N/AC:L/AT:N/PR:N/UI:N/VC:N/VI:N/VA:N/SC:N/SI:N/SA:N')).to eq(
  ...
  describe '#cast' do
    ...
    it 'casts strings to CvssSuite::Cvss' do
      ...
      expect(type.cast('CVSS:4.0/AV:N/AC:L/AT:N/PR:N/UI:N/VC:N/VI:N/VA:N/SC:N/SI:N/SA:N')).to be_a(::CvssSuite::Cvss40)
