...
RSpec.describe Security::SecretDetection::PartnerTokens::Gcp::ServiceAccount, feature_category: :secret_detection do
  ...
  describe '#verify_token' do
    it 'returns unknown without calling any vendor endpoint' do
      ...
      result = client.verify_token('{"type": "service_account", "private_key": "-----BEGIN PRIVATE KEY-----"}')
