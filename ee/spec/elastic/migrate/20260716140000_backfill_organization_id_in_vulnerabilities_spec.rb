...
require 'spec_helper'
require File.expand_path('ee/elastic/migrate/20260716140000_backfill_organization_id_in_vulnerabilities.rb')

RSpec.describe BackfillOrganizationIdInVulnerabilities, feature_category: :vulnerability_management do
  let(:version) { 20260716140000 }
