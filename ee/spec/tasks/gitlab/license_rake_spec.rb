...
RSpec.describe 'gitlab:license namespace rake tasks', :silence_stdout, feature_category: :subscription_management do
  ...
  describe 'info' do
    subject(:run_info_task) { run_rake_task 'gitlab:license:info' }
    ...
    it 'displays information', :with_license do
      expect { run_info_task }.to output(
        include(
    ...
    context 'when license not found' do
      it 'aborts' do
        ...
        expect { run_info_task }.to raise_error(SystemExit, 'No license has been applied.')
      end
    end
  end
  ...
  describe 'load' do
    ...
    subject(:run_load_task) { run_rake_task 'gitlab:license:load', [mode] }

    it 'works when no license to be installed' do
      expect { run_load_task }.not_to raise_error
    end
    ...
    context 'when GITLAB_ACTIVATION_CODE env variable is set' do
      ...
      context 'when ActivateService is unsuccessful' do
        ...
        it 'raises error' do
          ...
          expect { run_load_task }.to raise_error(RuntimeError, 'Activation unsuccessful')
    ...
    context 'when GITLAB_LICENSE_FILE env variable is set' do
      ...
      it 'fails when the file does not exist' do
        ...
        expect { run_load_task }.to raise_error(RuntimeError, "License File Missing")
      end
      ...
      context 'when the file does exist' do
        ...
        context 'but does not contain a valid license' do
          ...
          it 'fails to add the license' do
            ...
            expect { run_load_task }.to raise_error(RuntimeError, "License Invalid")
          end
        end
    ...
    context 'running in mode verbose' do
      ...
      context 'when default valid license file does not exist' do
        it 'outputs a the help message' do
          ...
          expect { run_load_task }
            .to output(/environment variable to seed the License file of the given path/).to_stdout
        end
      end
    end
  end
