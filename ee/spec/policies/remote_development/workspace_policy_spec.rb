...
RSpec.describe RemoteDevelopment::WorkspacePolicy, feature_category: :workspaces do
  ...
  let_it_be(:agent_project, refind: true) { create(:project, namespace: group, creator: agent_project_creator) }
  ...
  let_it_be(:workspace_project, refind: true) { create(:project, namespace: group, creator: workspace_project_creator) }
