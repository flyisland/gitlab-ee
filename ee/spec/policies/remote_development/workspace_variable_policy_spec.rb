...
RSpec.describe RemoteDevelopment::WorkspaceVariablePolicy, feature_category: :workspaces do
  ...
  let_it_be_with_refind(:agent_project) { create(:project, creator: agent_project_creator) }
  ...
  let_it_be_with_refind(:workspace_project) { create(:project, creator: workspace_project_creator) }
  ...
  let_it_be_with_refind(:workspace_variable) do
