...
RSpec.describe Ai::DuoWorkflows::WorkflowPolicy, feature_category: :duo_agent_platform do
  ...
  describe "read_duo_workflow and update_duo_workflow for project-level agentic chat" do
    let_it_be(:workflow, freeze: false) { create(:duo_workflows_workflow, :agentic_chat, project: project) }
  ...
  describe "read_duo_workflow and update_duo_workflow for namespace-level agentic chat" do
    let_it_be(:workflow, freeze: false) { create(:duo_workflows_workflow, :agentic_chat, namespace: group) }
  ...
  describe ':read_duo_workflow for compliance reviewers' do
    ...
    context 'when user does not have read_compliance_dashboard' do
    ...
    context 'when compliance dashboard is not licensed' do
      before do
        stub_licensed_features(
          group_level_compliance_dashboard: false,
          project_level_compliance_dashboard: false
        )
      end
