...
RSpec.describe Ai::DuoWorkflows::WorkflowNotePolicy, feature_category: :duo_agent_platform do
  ...
  let_it_be(:link) { create(:duo_workflows_workflow_note, workflow: workflow) }
