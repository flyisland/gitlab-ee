...
RSpec.describe Ai::DuoWorkflows::WorkflowMergeRequestPolicy, feature_category: :duo_agent_platform do
  ...
  let_it_be(:link) { create(:duo_workflows_workflow_merge_request, workflow: workflow) }
