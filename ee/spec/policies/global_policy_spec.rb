...
RSpec.describe GlobalPolicy, :aggregate_failures, feature_category: :shared do
  ...
  describe 'read_admin_knowledge_graph_settings' do
    ...
    with_them do
      ...
      if params[:allowed]
        it { is_expected.to be_allowed(:read_admin_knowledge_graph_settings) }
      else
  ...
  describe 'update_knowledge_graph_setting' do
    ...
    with_them do
      ...
      if params[:allowed]
        it { is_expected.to be_allowed(:update_knowledge_graph_setting) }
      else
        it { is_expected.to be_disallowed(:update_knowledge_graph_setting) }
      end
    end
