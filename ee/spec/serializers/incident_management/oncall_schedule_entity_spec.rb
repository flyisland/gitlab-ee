...
RSpec.describe IncidentManagement::OncallScheduleEntity, feature_category: :on_call_schedule_management do
  let(:schedule) { build_stubbed(:incident_management_oncall_schedule) }
