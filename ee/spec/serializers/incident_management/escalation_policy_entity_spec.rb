...
RSpec.describe IncidentManagement::EscalationPolicyEntity, feature_category: :incident_management do
  let(:policy) { build_stubbed(:incident_management_escalation_policy) }
