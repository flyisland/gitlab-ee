...
RSpec.describe "search/results/_issuable", :with_current_organization, feature_category: :global_search do
  let_it_be(:namespace, freeze: false) { build_stubbed(:namespace) }
  let_it_be(:project, freeze: false) { build_stubbed(:project, namespace: namespace, path: "foo/bar") }
  let_it_be(:author, freeze: false) { build_stubbed(:user) }
  let_it_be(:label, freeze: false) { build_stubbed(:label, project: project, title: 'test label') }
  let_it_be(:scoped_label, freeze: false) { build_stubbed(:label, project: project, title: 'foo::bar') }
