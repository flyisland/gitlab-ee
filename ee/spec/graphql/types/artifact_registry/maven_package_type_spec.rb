...
RSpec.describe GitlabSchema.types['ArtifactRegistryMavenPackage'], feature_category: :artifact_registry do
  using RSpec::Parameterized::TableSyntax

  subject { described_class }

  specify { expect(described_class.graphql_name).to eq('ArtifactRegistryMavenPackage') }

  it 'exposes the identifier, the Maven coordinates, the pull timestamp, and the versions connection' do
    is_expected.to have_graphql_fields(:id, :group_id, :artifact_id, :last_downloaded_at, :versions)
  end
