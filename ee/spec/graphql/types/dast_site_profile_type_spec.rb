...
RSpec.describe GitlabSchema.types['DastSiteProfile'], feature_category: :dynamic_application_security_testing do
  ...
  let_it_be_with_reload(:object) { create(:dast_site_profile, project: project) }
  ...
  describe 'scan_file_path field' do
    ...
    let_it_be_with_reload(:object) { create(:dast_site_profile, project: project, target_type: target_type, scan_file_path: scan_file_path) }
