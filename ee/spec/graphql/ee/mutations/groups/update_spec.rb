      ...
      shared_examples 'updating the group settings' do
        it 'updates the settings' do
          expect { mutation }
            ...
            .and change { group.reload.namespace_settings.tool_approval_for_session_enabled }.to(false)
            .and change { group.reload.namespace_settings.lock_tool_approval_for_session_enabled }.to(true)
        end
