...
RSpec.describe 'graphql queries', feature_category: :api do
  complexity_overrides = {
    ...
    'app/assets/javascripts/boards/graphql/lists_issues.query.graphql' => 560,
    ...
    'app/assets/javascripts/work_items/list/graphql/get_work_items_full.query.graphql' => 335,
    'ee/app/assets/javascripts/work_items/list/graphql/get_work_items_full.query.graphql' => 335,
    'app/assets/javascripts/work_items/graphql/work_item_by_id.query.graphql' => 280,
    'app/assets/javascripts/work_items/graphql/work_item_by_iid.query.graphql' => 280,
    'app/assets/javascripts/work_items/graphql/add_linked_items.mutation.graphql' => 280,
    'app/assets/javascripts/work_items/graphql/create_work_item.mutation.graphql' => 280,
    'app/assets/javascripts/work_items/graphql/update_work_item.mutation.graphql' => 280,
    'app/assets/javascripts/work_items/graphql/work_item_convert.mutation.graphql' => 280,
    'app/assets/javascripts/work_items/graphql/work_item_updated.subscription.graphql' => 280,

    # Code review: https://gitlab.com/gitlab-org/gitlab/-/issues/584293
    'app/assets/javascripts/ci/merge_requests/graphql/queries/get_merge_request_pipelines.query.graphql' => 705,
    ...
    'ee/app/assets/javascripts/compliance_dashboard/components/frameworks_report/wizard/graphql/' \
    ...
    'ee/app/assets/javascripts/security_dashboard/graphql/queries/group_vulnerabilities.query.graphql' => 310,
    'ee/app/assets/javascripts/security_dashboard/graphql/queries/instance_vulnerabilities.query.graphql' => 300,
    'ee/app/assets/javascripts/security_dashboard/graphql/queries/project_vulnerabilities.query.graphql' => 340,
  ...
  # See https://gitlab.com/gitlab-org/gitlab/-/issues/587972
  describe 'work item detail query complexity with workItem.features field enabled' do
    %w[
      ...
      describe query_path do
        ...
        it 'does not exceed authenticated max complexity with features enabled' do
          complexity = query_complexity(definition.text, { "useWorkItemFeatures" => true })
