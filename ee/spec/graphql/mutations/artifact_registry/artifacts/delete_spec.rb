...
RSpec.describe Mutations::ArtifactRegistry::Artifacts::Delete, feature_category: :artifact_registry do
  include GraphqlHelpers

  subject(:mutation) { described_class }

  it { is_expected.to have_graphql_name('ArtifactRegistryArtifactDelete') }
