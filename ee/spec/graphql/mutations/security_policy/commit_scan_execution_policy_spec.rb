...
RSpec.describe Mutations::SecurityPolicy::CommitScanExecutionPolicy, feature_category: :security_policy_management do
  ...
  describe '#resolve' do
    ...
    let_it_be(:project) { create(:project, :small_repo, namespace: current_user.namespace) }
    let_it_be(:namespace) { create(:group) }
    let_it_be(:project_policy_management_project) { create(:project, :small_repo, namespace: current_user.namespace) }
    let_it_be(:namespace_policy_management_project) { create(:project, :small_repo, namespace: namespace) }
