...
RSpec.describe Mutations::Dast::Profiles::Update, :dynamic_analysis,
  ...
  let_it_be_with_reload(:dast_profile) { create(:dast_profile, project: project, tags: old_tags) }
    ...
    context 'when the feature is licensed' do
      ...
      context 'when the user can update a DAST profile' do
        ...
        context 'when run_after_update=true' do
          ...
          it_behaves_like 'it bypasses branch protection for on-demand DAST scans' do
