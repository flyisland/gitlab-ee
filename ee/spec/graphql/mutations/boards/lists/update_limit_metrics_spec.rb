...
RSpec.describe Mutations::Boards::Lists::UpdateLimitMetrics, feature_category: :planning_views do
  ...
  subject(:mutation_response) { mutation.resolve(list_id: list.to_global_id, **list_update_params) }
  ...
  describe '#resolve' do
    context 'with admin rights' do
      ...
      it 'returns the correct response' do
        expect(mutation_response.keys).to match_array([:list, :errors])
      end
    end
