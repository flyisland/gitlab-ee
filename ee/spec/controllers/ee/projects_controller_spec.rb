...
RSpec.describe ProjectsController, feature_category: :groups_and_projects do
  ...
  describe 'PUT #update', feature_category: :groups_and_projects do
    ...
    context 'when the user is a security manager without update_duo_settings' do
      ...
      context 'with only the duo_sast_vr_workflow_enabled attribute' do
        let(:params) { { project_setting_attributes: { duo_sast_vr_workflow_enabled: true } } }
      ...
      context 'with other project setting attributes besides duo_sast_vr_workflow_enabled' do
        let(:params) { { project_setting_attributes: { duo_sast_vr_workflow_enabled: true, cve_id_request_enabled: true } } }

        it 'updates only duo_sast_vr_workflow_enabled and silently drops the rest', :aggregate_failures do
          request
      ...
      context 'with non-setting project attributes' do
        let(:params) { { description: 'hacked', project_setting_attributes: { duo_sast_vr_workflow_enabled: true } } }
