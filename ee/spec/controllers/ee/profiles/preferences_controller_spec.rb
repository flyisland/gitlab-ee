  ...
  describe 'PATCH update' do
    ...
    context 'when updating knowledge_graph_governing_namespace_id' do
      ...
      context 'when SaaS', :saas do
        let(:credits_add_on) { create(:gitlab_subscription_add_on, :gitlab_credits) }

        before do
          stub_saas_features(gitlab_com_subscriptions: true)
          create(:gitlab_subscription_add_on_purchase, namespace: namespace, add_on: credits_add_on)
        end
