      ...
      describe 'redirection' do
        context 'when onboarding is enabled' do
          ...
          context 'when joining_project is "true"' do
            ...
            it 'tracks trial_first_registration experiment assignment' do
              expect_next_instance_of(TrialFirstRegistrationExperiment) do |experiment|
                expect(experiment).to receive(:track).with(:assignment, namespace: user.namespace)
              end
