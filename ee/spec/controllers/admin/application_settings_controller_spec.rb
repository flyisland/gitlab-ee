...
RSpec.describe Admin::ApplicationSettingsController, feature_category: :settings do
  ...
  describe '#search', feature_category: :global_search do
    ...
    describe 'semantic search settings' do
      describe 'semantic search unavailable scenarios' do
        ...
        with_them do
          before do
            ...
            allow(::Ai::ActiveContext::Embeddings::ModelSelector).to receive_messages(
              use_gitlab_selected_model?: gitlab_selects_model,
              user_can_select_model?: user_selects_model
            )
          end
