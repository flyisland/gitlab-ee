  ...
  <div class="gl-flex gl-flex-1 gl-flex-col">
    ...
    <div class="gl-border gl-rounded-b-xl gl-border-t-0 gl-p-6">
      <h3 class="gl-mt-0 gl-text-lg">
        {{ s__('JH|BillingPlans|Everything from Premium, plus:') }}
      </h3>
      ...
      >
        <li>
          ...
          <span>{{ s__('JH|BillingPlans|Application Security Testing') }}</span>
        </li>

        <li>
          <gl-icon name="check" variant="info" class="gl-mr-2" />
          <span>{{ s__('JH|BillingPlans|Software Supply Chain Security') }}</span>
        </li>

        <li>
          <gl-icon name="check" variant="info" class="gl-mr-2" />
          <span>{{ s__('JH|BillingPlans|Vulnerability Management') }}</span>
        </li>
      </ul>
