...
export default {
  ...
  computed: {
    assignee() {
      // Ligaai issues have at most 1 assignee
  ...
  i18n: {
    ...
    avatarSubLabel: s__('JH|LigaaiIntegration|LigaAI user'),
  },
};
</script>
...
<template>
  <div>
    ...
    <issue-due-date :due-date="issue.due_date" />
