...
export const ERROR_FETCHING_DATA_HEADER = s__('JH|Checkout|Could not get the data properly');
export const ERROR_FETCHING_DATA_DESCRIPTION = s__(
  'JH|Checkout|Please try and refresh the page. If the problem persists please contact support.',
);
