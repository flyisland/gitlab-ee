...
# Override spec ee/spec/views/shared/billings/_trial_status.html.haml_spec.rb
RSpec.describe 'shared/billings/_trial_status.html.haml', :saas do
  ...
  before do
    ...
    create(:gitlab_subscription, namespace: group,
      hosted_plan: plan, trial_starts_on: Time.current, trial_ends_on: trial_ends_on, trial: trial)
  end
  ...
  context 'when trial active' do
    ...
    context 'with a ultimate trial' do
      ...
      it 'displays expiry date and Ultimate' do
        ...
        expect(rendered).to have_content("Your Ultimate trial will expire after #{trial_ends_on}. \
You can retain access to the Ultimate features by upgrading below.")
    ...
    context 'with a premium trial' do
      ...
      it 'displays expiry date and Premium' do
        ...
        expect(rendered).to have_content("Your Premium trial will expire after #{trial_ends_on}. \
...
You can retain access to the Premium features by upgrading below.")
  ...
  context 'when trial expired' do
    ...
    it 'displays the date is expired' do
      ...
      expect(rendered).to have_content("Your trial expired on #{trial_ends_on}")
    end
  end
  ...
  context 'when eligible for trial' do
    ...
    it 'offers a trial' do
      ...
      expect(rendered).to have_content("start a free 30-day trial of Ultimate")
    end
  end
end
