...
RSpec.describe Projects::Analytics::PerformanceAnalyticsController do
  ...
  describe 'GET #index' do
    subject do
      get project_analytics_performance_analytics_path(project)
      response
    end
  ...
  context "for api" do
    ...
    shared_examples 'api endpoint' do
      it 'succeeds' do
        expect(Analytics::PerformanceAnalytics::ProjectLevel).to receive(:new).with(
          project, options: hash_including(options)
        ).and_call_original
    ...
    describe 'GET "summary"' do
      subject { get summary_project_analytics_performance_analytics_path(project, format: :json, params: params) }

      it_behaves_like 'api endpoint'
    end

    describe 'GET "leaderboard"' do
      subject { get leaderboard_project_analytics_performance_analytics_path(project, format: :json, params: params) }
    ...
    describe 'GET "report"' do
      context "with json format" do
        subject { get report_project_analytics_performance_analytics_path(project, format: :json, params: params) }

        it_behaves_like 'api endpoint'
      end

      context "with csv format" do
        subject { get report_project_analytics_performance_analytics_path(project, format: :csv, params: params) }
    ...
    describe 'GET "report_summary' do
      context "with json format" do
        subject do
          get report_summary_project_analytics_performance_analytics_path(project, format: :json, params: params)
        end
