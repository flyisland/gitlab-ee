  ...
  describe 'class attributes' do
    ...
    context 'when using multiple databases' do
      ...
      where(:getter, :setter, :default, :values, :kwargs, :expected) do
        ...
        :get_data_consistency_per_database      | :data_consistency | { main: :always, jh: :always, sec: :always, ci: :always } | [:sticky] | { overrides: { ci: :delayed } } | { ci: :delayed, jh: :sticky, main: :sticky, sec: :sticky }
        :get_data_consistency_per_database      | :data_consistency | { main: :always, jh: :always, sec: :always, ci: :always } | [:sticky] | {} | { ci: :sticky, jh: :sticky, main: :sticky, sec: :sticky }
      end
      # rubocop: enable Layout/LineLength
    ...
    context 'when using a single database with ci connection' do
      ...
      # rubocop: disable Layout/LineLength -- using table synxax
      where(:getter, :setter, :default, :values, :kwargs, :expected) do
        :get_data_consistency_per_database      | :data_consistency | { main: :always, jh: :always, ci: :always } | [:sticky] | { overrides: { ci: :delayed } } | { main: :sticky, jh: :always, ci: :sticky }
        :get_data_consistency_per_database      | :data_consistency | { main: :always, jh: :always, ci: :always } | [:sticky] | {} | { main: :sticky, jh: :always, ci: :sticky }
        :get_least_restrictive_data_consistency | :data_consistency | :always | [:always] | { overrides: { ci: :delayed, jh: :sticky, main: :sticky } } | :always
        :get_least_restrictive_data_consistency | :data_consistency | :always | [:always] | {} | :always
      end
      # rubocop: enable Layout/LineLength
  ...
  describe '.data_consistency' do
    ...
    context 'when overrides are provided in a single database setup with ci connection' do
      ...
      it 'returns correct feature flag value' do
        ...
        expect(worker.get_data_consistency_per_database).to eq({ ci: :always, jh: :always, main: :always })
      end
      ...
      context 'when feature_flag is provided' do
        ...
        context 'when feature_flag is disable' do
          ...
          it 'returns correct feature flag value' do
            ...
            expect(worker.get_data_consistency_per_database).to eq({ main: :always, jh: :always, ci: :always })
            expect(worker.get_least_restrictive_data_consistency).to eq(:always)
          end
        end
    ...
    context 'when overrides are provided in a multi database setup' do
      ...
      it 'returns correct feature flag value' do
        ...
        expect(worker.get_data_consistency_per_database).to eq({ ci: :delayed, jh: :always, sec: :always,
main: :always })
      end
      ...
      context 'when feature_flag is provided' do
        ...
        context 'when feature_flag is disable' do
          ...
          it 'returns correct feature flag value' do
            ...
            expect(worker.get_data_consistency_per_database).to eq({ main: :always, jh: :always, sec: :always,
ci: :always })
            expect(worker.get_least_restrictive_data_consistency).to eq(:always)
          end
        end
