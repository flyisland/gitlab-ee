...
# Guards jh/config/initializers/grape_validators.rb. That initializer loads every
...
RSpec.describe 'jh/config/initializers/grape_validators.rb', feature_category: :api do
  it 'registers every custom validator defined under jh/lib/api/validations/validators',
    :aggregate_failures do
    validator_dir = Rails.root.join('jh/lib/api/validations/validators')
