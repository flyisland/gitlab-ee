...
RSpec.describe Gitlab::GiteeImport::WikiFormatter do
  let(:project) do
    create(:project,
      namespace: create(:namespace, path: 'gitlabhq'),
      import_url: 'https://gitee.com/asdf/test.git')
  end
  ...
  describe '#import_url' do
    it 'returns URL of the wiki repository' do
      expect(wiki.import_url).to eq 'https://gitee.com/asdf/test.wiki.git'
    end
  end
end
